 ...
 */
public sealed interface GPScrollElasticSearchConfig<P extends Page, D extends Document, R extends Object, E extends Exception, C extends GPElasticSearchCheck<R, Set<D>, E>> permits ScrollElasticSearchConfig {
