 ...
 */
@Immutable
class ScrollElasticSearchConfig<P extends GPPageableElasticSearchDAO.Page, D extends Document, R extends Object, E extends Exception, C extends GPElasticSearchCheck<R, List<D>, E>> implements GPScrollElasticSearchConfig<P, D, R, E, C> {
