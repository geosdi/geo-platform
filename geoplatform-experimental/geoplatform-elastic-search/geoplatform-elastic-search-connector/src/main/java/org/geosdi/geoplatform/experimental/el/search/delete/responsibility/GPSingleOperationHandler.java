...
import static org.geosdi.geoplatform.experimental.el.search.delete.responsibility.GPElasticSearchOperationHandler.GPElasticSearchDeleteHandlerType.NOT_PARALLEL_OPERATION_TYPE;
...
class GPSingleOperationHandler extends GPAbstractOperationHandler<ElasticSearchDAO> {
     ...
     */
    @Override
    public <Result extends IOperationByPageResult, Page extends OperationByPage> Result operation(Page page, ElasticSearchDAO searchDAO) throws Exception {
    ...
    public <TYPE extends IGPElasticSearchDeleteHandlerType> TYPE getOperationType() {
        return (TYPE) NOT_PARALLEL_OPERATION_TYPE;
    }
}
