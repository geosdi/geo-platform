 ...
 */
public class GPElasticSearchDeleteTask extends AbstractSearchOperationTask {

    public GPElasticSearchDeleteTask(ElasticSearchDAO theSearchDAO, OperationByPage thePage,
                                     int taskNumber) {
