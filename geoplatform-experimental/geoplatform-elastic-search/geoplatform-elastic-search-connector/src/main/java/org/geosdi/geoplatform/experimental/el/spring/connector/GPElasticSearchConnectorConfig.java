...
class GPElasticSearchConnectorConfig {
    ...
    /**
     * @param gpBaseElasticSearchProperties
     * @return {@link Client}
     * @throws Exception
     */
    @Bean(name = "elastichSearchClient", destroyMethod = "close")
    public static Client gpElasticSearchConnector(@Qualifier(value = "gpBaseElasticSearchProperties") GPElasticSearchProperties gpBaseElasticSearchProperties) throws Exception {
        ...
        return new PreBuiltTransportClient(builder()
                ...
                .addTransportAddress(new TransportAddress(getByName(gpBaseElasticSearchProperties.getHost()), gpBaseElasticSearchProperties.getPort()));
    }
}