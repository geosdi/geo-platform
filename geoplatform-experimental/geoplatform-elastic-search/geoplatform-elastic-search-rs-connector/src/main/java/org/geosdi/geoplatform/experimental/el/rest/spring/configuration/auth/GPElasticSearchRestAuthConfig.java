...
class GPElasticSearchRestAuthConfig {
     ...
     */
    @Bean
    public GPElasticSearchRSAuthConfiguration elasticSearchRestAuthConfiguration(
            @Value("elasticSearchRestConfigurator{gp.elasticsearch.rest.username:@null}") String theUserName,
