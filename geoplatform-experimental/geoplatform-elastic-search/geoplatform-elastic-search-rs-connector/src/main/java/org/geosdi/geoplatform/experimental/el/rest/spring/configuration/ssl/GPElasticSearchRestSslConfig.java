...
class GPElasticSearchRestSslConfig {
     ...
     */
    @Bean
    public GPElasticSearchRSSslConfiguration elasticSearchRSSslConfiguration(
            @Value(value = "elasticSearchRestConfigurator{gp.elasticsearch.rest.key_store:@null}") String theKeyStorePath,
