...
public class Address {
    ...
    private String id;
    @NotNull
    @Min(value = 4, message = "The Field Name must contains almost 4 characters.")
    private String name;
    @GeoSpatialIndexed(name = "location", type = GEO_2D)
    ...
    public String toString() {
        return "Address{ " + "id = " + id + ", name = " + name + ", location = " + location + '}';
    }
