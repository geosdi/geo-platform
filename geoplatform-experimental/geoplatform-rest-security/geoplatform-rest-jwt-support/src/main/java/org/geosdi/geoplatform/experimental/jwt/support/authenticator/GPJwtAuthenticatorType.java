 ...
 */
package org.geosdi.geoplatform.experimental.jwt.support.authenticator;
 ...
 */
public enum GPJwtAuthenticatorType implements GPAuthenticatorType {
     ...
     */
    GPJwtAuthenticatorType(@Nonnull(when = NEVER) String theAuthenticatorType) {
