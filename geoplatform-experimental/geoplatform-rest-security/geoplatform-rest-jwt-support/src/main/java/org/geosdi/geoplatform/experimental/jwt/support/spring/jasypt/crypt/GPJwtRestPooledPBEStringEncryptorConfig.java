 ...
 */
@Configuration
class GPJwtRestPooledPBEStringEncryptorConfig {

    /**
     * @param jwtRestPBEConfig
     * @return {@link PooledPBEStringEncryptor}
     */
    @Bean
    public PooledPBEStringEncryptor jwtRestPooledPBEStringEncryptor(@Qualifier(value = "jwtRestPBEConfig") PBEConfig jwtRestPBEConfig) {
        return new BasePooledPBEStringEncryptorDecorator() {
            {
                super.setPbeConfig(jwtRestPBEConfig);
            }
