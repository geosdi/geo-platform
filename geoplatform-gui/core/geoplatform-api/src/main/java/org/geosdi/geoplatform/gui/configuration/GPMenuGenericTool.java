 ...
 */
public abstract class GPMenuGenericTool<M extends GeoPlatformMenuCreator> extends GenericTool {
     ...
     * @param menu
     */
    public void buildTool(M menuCreator, final Menu menu) {
        if (secure) {
     ...
     * @param menu
     */
    protected final void checkSecurity(M menuCreator, Menu menu) {
        Boolean permission = GPAccountLogged.getInstance().hasComponentPermission(this.getId());
        if (permission != null) {
     ...
     * @param menu
     */
    protected final void byPassSecurity(M menuCreator, Menu menu) {
        this.create(menuCreator, menu);
    }
     ...
     * @param menu
     */
    protected abstract void create(M menuCreator, final Menu menu);
}