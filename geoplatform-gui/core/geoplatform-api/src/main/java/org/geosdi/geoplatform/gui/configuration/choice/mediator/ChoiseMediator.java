 ...
 */
public interface ChoiseMediator<K extends ChoiseColleagueKey, V extends ChoiseColleague> {

    void registerChoiseColleague(V choiseColleague);

    V getChoiseColleague(K key);

    boolean isChoiseColleagueRegistered(K key);

    List<V> getChoiseColleagues();

    <W extends Widget> W getGroupChoiseWidget();

    void displayChoiseWidget(K key);
