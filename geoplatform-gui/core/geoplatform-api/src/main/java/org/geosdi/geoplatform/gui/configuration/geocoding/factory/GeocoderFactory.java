 ...
 */
package org.geosdi.geoplatform.gui.configuration.geocoding.factory;
...
public interface GeocoderFactory {
    ...
    IGPGeocoderPluginManager getPluginManager();

    IGPGeocoderPluginManager getPluginManager(GeocoderPluginType type);
}
