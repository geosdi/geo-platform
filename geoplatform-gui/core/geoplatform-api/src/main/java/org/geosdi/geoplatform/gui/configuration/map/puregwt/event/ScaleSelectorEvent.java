 ...
 *
 */
public class ScaleSelectorEvent extends GwtEvent<GPMapToolsHandler> {
    
    private GPScaleBean value;
    ...
    protected void dispatch(GPMapToolsHandler handler) {
        handler.onScaleSelectionChange(value);
    }

    /**
     * @param value the value to set
     */
    public void setValue(GPScaleBean value) {
        this.value = value;
    }
}
