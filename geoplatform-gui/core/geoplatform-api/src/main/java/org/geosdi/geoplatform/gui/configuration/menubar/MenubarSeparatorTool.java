 ...
 */
public class MenubarSeparatorTool extends MenuBarClientTool {

    private static final long serialVersionUID = -7958142618458229160L;
    //
    public static final String MENU_BAR_SEPARATOR = "MenuBarSeparator";

    public MenubarSeparatorTool() {
        this.id = MENU_BAR_SEPARATOR;
        this.enabled = true;
    }
