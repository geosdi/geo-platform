 ...
 */
public interface IGPClientProject extends GPProjectProperties {

    /**
     * @return {@link String}
     */
    String getDefaultProjectLabel();
    ...
    /**
     * @return {@link IGPUserSimpleDetail}
     */
    IGPUserSimpleDetail getOwner();

    /**
     * @return {@link List<GPFolderClientInfo>}
     */
    List<GPFolderClientInfo> getRootFolders();

    /**
     * @return {@link String}
     */
    String getSharedLabel();
     ...
     * @param shared
     */
    void setProjectShared(boolean shared);
