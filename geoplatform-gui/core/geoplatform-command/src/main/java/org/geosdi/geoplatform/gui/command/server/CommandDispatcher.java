...
/**
 * <p>
 * Class responsible for dispatching requests to the various command
 * </p>
 *
...
public interface CommandDispatcher extends ApplicationContextAware {
     ...
     * @return 
     */
    <Request extends GPCommandRequest, Response extends GPCommandResponse> Response execute(Request request, HttpServletRequest httpServletRequest);
