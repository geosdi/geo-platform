...
public class GPSecureButton extends Button {
    ...
    public GPSecureButton(String text, AbstractImagePrototype icon, GeoPlatformSecureAction<ButtonEvent> listener) {
        super(text, icon, listener);
        this.initializeSecureAction(listener);
    }

    public GPSecureButton(String text, GeoPlatformSecureAction<ButtonEvent> listener) {
        super(text, listener);
        this.initializeSecureAction(listener);
    }

    private void initializeSecureAction(GeoPlatformSecureAction<ButtonEvent> listener) {
        listener.addActionEnableHandler(new ActionEnableHandler() {
            @Override
