 ...
 */
public class MenuActionCheckedEvent extends GwtEvent<MenuActionChangeCheckHandler> {

    private boolean checked;
    
    public MenuActionCheckedEvent(boolean checked) {
