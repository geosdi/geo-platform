...
public interface MenuActionBinder extends MenuActionHandler {
     ...
     * @param menu
     */
    void bindMenuBaseAction(MenuAction action, GPMenuItem tool, final Menu menu);
     ...
     * @param menu
     */
    void bindMenuCheckAction(MenuCheckAction action, GPCheckMenuItem tool, final Menu menu);
