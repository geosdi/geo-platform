 ...
 */
public class AdvancedMemberOptionManager
        extends GenericMemberOptionManager<GeoPlatformOptionsMember> {

    @Override
    public GPMemberOptionType getType() {
        return GPMemberOptionType.ADVANCED_PROPERTIES;
    }
}
