 ...
 */
public class GPMenuActionHandlerManager {

    private static GPMenuActionHandlerManager instance = new GPMenuActionHandlerManager();
    //
    private GPEventBus eventBus;

    private GPMenuActionHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    /**
     * @return {@link GPMenuActionHandlerManager}
     */
    public static GPMenuActionHandlerManager getInstance() {
        return instance;
    }
