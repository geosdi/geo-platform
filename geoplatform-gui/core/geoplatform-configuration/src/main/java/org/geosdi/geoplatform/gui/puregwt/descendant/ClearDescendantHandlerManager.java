 ...
 */
package org.geosdi.geoplatform.gui.puregwt.descendant;
 ...
 */
public class ClearDescendantHandlerManager {

    private static ClearDescendantHandlerManager instance = new ClearDescendantHandlerManager();
    private GPEventBus eventBus;

    private ClearDescendantHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    public static ClearDescendantHandlerManager getInstance() {
        return instance;
    }
    ...
    public static <T extends EventHandler> HandlerRegistration addHandlerToSource(Type<T> type, Object source,
            T handler) {
