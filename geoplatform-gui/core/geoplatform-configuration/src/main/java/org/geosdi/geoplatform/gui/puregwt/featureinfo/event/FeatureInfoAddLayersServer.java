 ...
 */
public class FeatureInfoAddLayersServer extends GwtEvent<GPFeatureInfoHandler> {
    ...
    protected void dispatch(GPFeatureInfoHandler handler) {
        handler.addLayersServer(this.urlServers);
    }

    /**
     * @return the urlServers
     */
    public String getUrlServers() {
        return this.urlServers;
    }

    /**
     * @param urlServers the urlServers to set
     */
    public void setUrlServers(String urlServers) {
        this.urlServers = urlServers;
    }
