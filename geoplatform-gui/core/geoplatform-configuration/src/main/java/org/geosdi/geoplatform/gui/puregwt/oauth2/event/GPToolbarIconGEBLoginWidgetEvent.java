 ...
 */
public class GPToolbarIconGEBLoginWidgetEvent extends GwtEvent<IGPToolbarIconWidgetHandler> {

    private String tooltip;

    public GPToolbarIconGEBLoginWidgetEvent(String tooltip) {
