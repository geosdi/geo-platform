 ...
 */
package org.geosdi.geoplatform.gui.puregwt.session;
...
public class TimeoutHandlerManager {
    ...
    private static TimeoutHandlerManager instance = new TimeoutHandlerManager();

    private TimeoutHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    public static TimeoutHandlerManager getInstance() {
        return instance;
    }
