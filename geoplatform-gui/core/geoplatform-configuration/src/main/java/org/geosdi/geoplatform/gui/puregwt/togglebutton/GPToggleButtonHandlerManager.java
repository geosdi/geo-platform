 ...
 */
package org.geosdi.geoplatform.gui.puregwt.togglebutton;
 ...
 */
public class GPToggleButtonHandlerManager {

    public enum GPToggleButtonKeySource {

        GET_FEATURE_INFO;
    }

    private GPEventBus eventBus;
    private static GPToggleButtonHandlerManager INSTANCE = new GPToggleButtonHandlerManager();

    private GPToggleButtonHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    public static GPToggleButtonHandlerManager getInstance() {
        return INSTANCE;
    }
