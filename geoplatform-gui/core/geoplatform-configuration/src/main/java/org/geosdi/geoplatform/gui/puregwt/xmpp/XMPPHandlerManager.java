...
public class XMPPHandlerManager {
    ...
    private static XMPPHandlerManager instance = new XMPPHandlerManager();
    ...
    public static void fireEvent(AbstractXMPPEvent event) {
        getInstance().eventBus.fireEvent(event);
    }

    public static void fireEventFromSource(AbstractXMPPEvent event, Object source) {
