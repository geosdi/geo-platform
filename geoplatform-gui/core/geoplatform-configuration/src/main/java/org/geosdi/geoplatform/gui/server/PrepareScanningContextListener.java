...
public class PrepareScanningContextListener implements ServletContextListener {
    ...
    /**
     * Name of servlet context parameter with a space, comma or semi-comma
     * separated list of classes to preload.
     */
        ...
        if (param != null) {
            ...
            for (String className : preloadClasses) {
                try {
                    ...
                    System.out.println("could not preload class");
                    // ignore
                }
            }
        }
        System.out.println("******************* Context initialized  correctly");
    }
