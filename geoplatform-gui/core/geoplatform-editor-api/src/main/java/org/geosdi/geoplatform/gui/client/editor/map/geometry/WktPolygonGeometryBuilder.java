 ...
 */
public class WktPolygonGeometryBuilder extends EditorWktGeometryBuilder {

    public WktPolygonGeometryBuilder(GeometryTypeBinder theGeometryBinder) {
    ...
    protected final String buildWktMultiGeometry(VectorFeature feature) {
        Polygon polygon = Polygon.narrowToPolygon(
