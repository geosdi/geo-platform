...
public class UserRemoteImpl extends RemoteServiceServlet implements UserRemote {
    ...
    @Override
    public long insertUser(GPUser user) throws GeoPlatformException {
        return userService.insertUser(user, super.getThreadLocalRequest());
    }

    @Override
    public long updateUser(GPUser user) throws GeoPlatformException {
        return userService.updateUser(user, super.getThreadLocalRequest());
    }

    @Override
    public boolean deleteUser(RequestById request) throws GeoPlatformException {
        return userService.deleteUser(request, super.getThreadLocalRequest());
    }
    ...
    public List<UserDTO> searchUsers(PaginatedSearchRequest request) {
        return userService.searchUsers(request, super.getThreadLocalRequest());
    }
}
