...
public class SaveAddedLayersAndTreeModificationsCommand implements
    ...
    @Override
    public SaveAddedLayersAndTreeModificationsResponse execute(
            SaveAddedLayersAndTreeModificationsRequest request,
        ...
        try {
            ...
            idSavedLayers = (ArrayList<Long>) this.geoPlatformServiceClient.saveAddedLayersAndTreeModifications(
                    new WSAddLayersAndTreeModificationsRequest(projectId,
                            parentFolderId, layersList, map)).getElements();
