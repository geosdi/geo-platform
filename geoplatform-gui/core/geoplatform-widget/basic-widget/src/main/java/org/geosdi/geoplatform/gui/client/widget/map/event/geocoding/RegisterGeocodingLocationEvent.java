 ...
 */
public class RegisterGeocodingLocationEvent<T extends GeocodingEventHandler> extends GwtEvent<T> {

    protected IGeoPlatformLocation bean;
    protected GPCoordinateReferenceSystem crs;
    protected GPGeoCoderProvider provider;
    protected boolean isSetCenter;

    public RegisterGeocodingLocationEvent() {
    }
    ...
    public void setEventProperties(IGeoPlatformLocation theBean,
            GPCoordinateReferenceSystem theCRS,
            GPGeoCoderProvider theProvider, boolean isSetCenter) {
        this.bean = theBean;
        this.crs = theCRS;
