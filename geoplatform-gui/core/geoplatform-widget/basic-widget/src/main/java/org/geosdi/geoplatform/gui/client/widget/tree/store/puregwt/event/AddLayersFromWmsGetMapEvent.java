 ...
 */
public class AddLayersFromWmsGetMapEvent extends GwtEvent<GPTreeStoreEventHandler> {
    
    private List<GPBeanTreeModel> layers;

    /**
     * @param theLayers the layers to set
     */
    public void setLayers(List<GPBeanTreeModel> theLayers) {
    ...
    protected void dispatch(GPTreeStoreEventHandler handler) {
        handler.addLayersFromWmsGetMap(layers);
    }
