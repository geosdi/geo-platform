 ...
 *
 * Test output schema 'original', that include 'GMD'.
 *
 * @todo DEL class
 *
 * @author Vincenzo Monteverde <vincenzo.monteverde@geosdi.org>
 */
public class ShowFullMetadataActionOriginal extends MenuBaseAction {

    private RecordsContainer rc;

    @Inject
    public ShowFullMetadataActionOriginal(RecordsContainer rc) {
        super("Read Full Metadata (Original)", CatalogFinderWidgetResources.ICONS.metadata());
...
//        str.append("ElementSetName").append("=").append("full").append("&");
        str.append("OutputSchema").append("=").append("original").append("&");
