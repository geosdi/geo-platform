 ...
 *
 */
public class SimpleGeocoderPluginManagerImpl
        extends AbstractSimpleGeocoderPluginManager {
    
    private GeocodingGridWidget widget;

    @Override
    public IGPGeocoderPlugin getDefaultPlugin() {
        return this.widget;
    }
