...
import static org.geosdi.geoplatform.gui.shared.GPTrustedLevel.HIGH;
...
public class CloneProjectMenuAction extends MenuBaseSecureAction {
     ...
     * @param treePanel
     */
    public CloneProjectMenuAction(TreePanel treePanel) {
        super(HIGH, LayerModuleConstants.INSTANCE.ShareCloneProjectMenuAction_titleText(), AbstractImagePrototype.create(BasicWidgetResources.ICONS.edit()));
    ...
    public void componentSelected(MenuEvent e) {
        ...
        if (!MementoModuleInjector.MainInjector.getInstance().getMementoSave().isEmpty()) {
            GeoPlatformMessage.confirmMessage(MementoPersistenceConstants.INSTANCE.MementoSaveCacheManager_unsavedOperationsText(),
