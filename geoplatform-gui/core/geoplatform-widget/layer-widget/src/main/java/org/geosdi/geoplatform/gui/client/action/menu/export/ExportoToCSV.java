 ...
 */
public class ExportoToCSV extends MenuBaseAction {
    ...
    public ExportoToCSV(TreePanel treePanel) {
        super("ExportToCSV", AbstractImagePrototype.create(LayerResources.ICONS.exportToCSV()));
    ...
    public void componentSelected(MenuEvent ce) {
        ...
        if (item instanceof RasterTreeNode) {
            ...
            String gmlUrl = dataSource + "?service=WFS&version=1.0.0&request=GetFeature&typeName=" + ((RasterTreeNode) item)
                    .getName() + "&maxFeatures=50&outputFormat=csv";
