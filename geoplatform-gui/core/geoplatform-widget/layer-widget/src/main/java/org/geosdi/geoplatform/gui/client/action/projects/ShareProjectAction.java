 ...
 *
 */
public class ShareProjectAction extends GeoPlatformSecureAction<ButtonEvent> {
    ...
    public void componentSelected(ButtonEvent ce) {
        GPClientProject clientProject = widget.getSelectionModel().getSelectedItem();
        widget.shareProject(clientProject);
    }
}
