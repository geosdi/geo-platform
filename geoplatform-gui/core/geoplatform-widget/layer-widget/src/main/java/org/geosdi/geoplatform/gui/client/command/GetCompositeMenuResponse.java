 ...
 */
public class GetCompositeMenuResponse implements GPCommandResponse<GPMenuCompositeStore> {
    ...
    @Override
    public GPMenuCompositeStore getResult() {
        return this.menuCompositeStore;
    }
