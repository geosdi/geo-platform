 ...
 */
public class CheckWmsGetMapUrlRequest implements GPCommandRequest {

    private static final long serialVersionUID = 6749099299920835117L;
    //
    private String urlEncoding;

    public CheckWmsGetMapUrlRequest() {
    }
    ...
    public String getCommandName() {
        return "command.getmap.CheckWmsGetMapUrlCommand";
    }
