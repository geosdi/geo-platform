 ...
 */
public class LoadDefaultProjectResponse implements
    ...
    public LoadDefaultProjectResponse() {
    }

    public LoadDefaultProjectResponse(GPClientProject result) {
        this.result = result;
    }

    @Override
    public GPClientProject getResult() {
        return result;
    }
