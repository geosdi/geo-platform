 ...
 */
public class LoadProjectResponse implements
        GPCommandResponse<ArrayList<GPFolderClientInfo>> {

    private static final long serialVersionUID = -6688757707789890908L;
    private ArrayList<GPFolderClientInfo> result;

    public LoadProjectResponse() {
    }
    
    public LoadProjectResponse(ArrayList<GPFolderClientInfo> result) {
        this.result = result;
    }

    @Override
    public ArrayList<GPFolderClientInfo> getResult() {
        return result;
    }
