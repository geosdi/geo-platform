 ...
 */
public class ShareProjectRequest implements GPCommandRequest {
    ...
    /**
     * @param idSharedProject the idSharedProject to set
     */
    ...
    public String getCommandName() {
        return "command.share.ShareProjectCommand";
    }
