...
public interface LayerModuleInjector extends Ginjector {
    ...
    class MainInjector {
        ...
        private static final LayerModuleInjector instance = GWT.create(LayerModuleInjector.class);
     ...
     */
    LoadMenuProjects getLoadMenuProject();

    /**
     * @return {@link LayerManagementWidget}
     */
    LayerManagementWidget getLayerManagementWidget();

    /**
     * @return {@link LayerTreePanel}
     */
    LayerTreePanel getLayerTreePanel();

    /**
     * @return {@link ShareProjectMenuAction}
     */
    ShareProjectMenuAction getShareProjectMenuAction();

    /**
     * @return {@link PasteLayerAction}
     */
    PasteLayerAction getPasteLayerAction();
