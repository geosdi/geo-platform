...
public class LayerTreeGinProviderConfigurator extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(GPLayerTreeDecorator.class).toProvider(
                GPLayerTreeDecoratorProvider.class).in(Singleton.class);
        
        bind(GPRootTreeNode.class).toProvider(GPRootTreeNodeProvider.class).in(
                Singleton.class);
        
        bind(GPTreePanelDropTarget.class).toProvider(DropTargetProvider.class).in(
                Singleton.class);
        
        bind(GPTreeHandlerManager.class).toProvider(
                GPTreeHandlerManagerProvider.class).in(Singleton.class);
