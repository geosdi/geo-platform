 ...
 */
public class FeatureTypeHandlerProvider implements Provider<FeatureTypeHandler> {

    private FeatureWidget featureWidget;

    @Inject
    public FeatureTypeHandlerProvider(FeatureWidget theFeatureWidget) {
        this.featureWidget = theFeatureWidget;
    }

    @Override
    public FeatureTypeHandler get() {
        return new FeatureTypeHandler(this.featureWidget);
    }
}
