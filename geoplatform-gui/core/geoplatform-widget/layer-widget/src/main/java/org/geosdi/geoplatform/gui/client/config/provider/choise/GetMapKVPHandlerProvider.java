 ...
 */
public class GetMapKVPHandlerProvider implements
        Provider<GetMapKvpHandler> {

    private final GetMapChoiseMediator choiseMediator;

    @Inject
    public GetMapKVPHandlerProvider(GetMapChoiseMediator theChoiseMediator) {
        this.choiseMediator = theChoiseMediator;
    }

    @Override
    public GetMapKvpHandler get() {
        return new GetMapKvpHandler(choiseMediator);
    }
