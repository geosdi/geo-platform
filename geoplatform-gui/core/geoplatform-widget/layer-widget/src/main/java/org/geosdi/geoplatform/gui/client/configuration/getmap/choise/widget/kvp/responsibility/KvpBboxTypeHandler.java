 ...
 */
public class KvpBboxTypeHandler extends KvpUrlTypeHandler {
    
    public KvpBboxTypeHandler() {
        super.setSuccessor(new KvpWidthTypeHandler());
    }
    ...
    protected Boolean canCheckKvpUrl(String url) {
        return (!GPRegEx.RE_BBOX.test(url)) ? notifyMessage()
                : Boolean.FALSE;
    }
    ...
    protected String getNotificationMessage() {
        return LayerModuleMessages.INSTANCE.
                LoadWmsGetMapFromUrlWidget_suggestionCheckGetMapBBOXMessage(
                        GetMap.BBOX.toString());
    }
