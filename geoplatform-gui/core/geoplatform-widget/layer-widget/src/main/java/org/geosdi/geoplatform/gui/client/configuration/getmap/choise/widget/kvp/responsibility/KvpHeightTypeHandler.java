 ...
 */
public class KvpHeightTypeHandler extends KvpUrlTypeHandler {
    
    public KvpHeightTypeHandler() {
        super.setSuccessor(new KvpFormatTypeHandler());
    }
    ...
    protected Boolean canCheckKvpUrl(String url) {
        return (!GPRegEx.RE_HEIGHT.test(url)) ? notifyMessage()
                : Boolean.FALSE;
    }
    ...
    protected String getNotificationMessage() {
        return LayerModuleMessages.INSTANCE.
                LoadWmsGetMapFromUrlWidget_suggestionCheckGetMapHeightMessage(
                        GetMap.HEIGHT.toString());
    }
