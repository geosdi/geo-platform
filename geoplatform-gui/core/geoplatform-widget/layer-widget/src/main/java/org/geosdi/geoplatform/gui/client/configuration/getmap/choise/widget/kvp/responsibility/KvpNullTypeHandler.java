 ...
 */
public class KvpNullTypeHandler extends KvpUrlTypeHandler {

    public KvpNullTypeHandler() {
        super.setSuccessor(new KvpHostTypeHandler());
    }
    ...
    protected Boolean canCheckKvpUrl(String url) {
        return (url == null) ? notifyMessage() : Boolean.FALSE;
    }
