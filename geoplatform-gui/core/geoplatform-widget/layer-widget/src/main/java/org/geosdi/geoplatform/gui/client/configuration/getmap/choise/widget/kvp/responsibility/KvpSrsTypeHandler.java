 ...
 */
public class KvpSrsTypeHandler extends KvpUrlTypeHandler {
    
    public KvpSrsTypeHandler() {
        super.setSuccessor(new KvpBboxTypeHandler());
    }
    ...
    protected Boolean canCheckKvpUrl(String url) {
        return (!GPRegEx.RE_SRS.test(url)) ? notifyMessage()
                : Boolean.FALSE;
    }
    ...
    protected String getNotificationMessage() {
        return LayerModuleMessages.INSTANCE.
                LoadWmsGetMapFromUrlWidget_suggestionCheckGetMapSRSMessage(
                        GetMap.SLD.toString());
    }
