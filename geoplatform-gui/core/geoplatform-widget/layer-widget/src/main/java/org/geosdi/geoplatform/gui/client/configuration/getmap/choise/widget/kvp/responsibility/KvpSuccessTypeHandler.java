 ...
 */
public class KvpSuccessTypeHandler extends KvpUrlTypeHandler {

    @Override
    public Boolean checkKvpUrl(String url) {
        return canCheckKvpUrl(url);
    }
    ...
    protected String getNotificationMessage() {
        return LayerModuleConstants.INSTANCE.LoadWmsGetMapFromUrlWidget_suggestionURLOKText();
    }
