 ...
 */
public class KvpWidthTypeHandler extends KvpUrlTypeHandler {
    
    public KvpWidthTypeHandler() {
        super.setSuccessor(new KvpHeightTypeHandler());
    }
    ...
    protected Boolean canCheckKvpUrl(String url) {
        return (!GPRegEx.RE_WIDTH.test(url)) ? notifyMessage()
                : Boolean.FALSE;
    }
    ...
    protected String getNotificationMessage() {
        return LayerModuleMessages.INSTANCE.
                LoadWmsGetMapFromUrlWidget_suggestionCheckGetMapWidthMessage(
                        GetMap.WIDTH.toString());
    }
