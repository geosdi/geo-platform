...
public class MementoSaveCacheUtility {
    ...
    private static boolean verifyCondition(GPBeanTreeModel element, IMemento<ISave> memento) {
        ...
        if (element instanceof FolderTreeNode) {
            condition = verifyFolderCondition((FolderTreeNode) element, memento);
    ...
    private static boolean verifyFolderCondition(FolderTreeNode folder, IMemento<ISave> memento) {
        boolean condition = false;
