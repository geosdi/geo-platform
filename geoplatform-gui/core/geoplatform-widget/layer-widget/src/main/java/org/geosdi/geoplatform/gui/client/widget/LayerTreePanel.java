...
public class LayerTreePanel extends GeoPlatformContentPanel {
    ...
    public LayerTreePanel(LayerTreeWidget theLayerTree,
            LayerTreeToolbar theTreeToolbar) {
        super(true);
    ...
    public void addComponent() {
        super.add(this.layerTree.getTree());
        super.setTopComponent(this.treeToolbar.getToolBar());
    }
    ...
    public void setPanelProperties() {
        ...
        super.addScrollListener(new ScrollListener() {
            ...
            public void widgetScrolled(ComponentEvent ce) {
                if (posV > 9 && LayerTreePanel.super.getVScrollPosition() == 0) {
                    LayerTreePanel.super.setVScrollPosition(posV);
                }
                posV = LayerTreePanel.super.getVScrollPosition();
            }
        });
    }
