 ...
 */
public class ProjectNameFieldBinding extends GPFieldBinding {

    public ProjectNameFieldBinding(Field field, String property) {
        super(field, property);
    }

    @Override
    public void setModelProperty(Object val) {
        ((GPClientProject) model).setName(val.toString());
    }
