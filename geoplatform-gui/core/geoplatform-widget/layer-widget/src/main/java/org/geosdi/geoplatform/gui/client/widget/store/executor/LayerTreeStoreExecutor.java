...
public abstract class LayerTreeStoreExecutor extends BaseTreeStoreExecutor {
    ...
    @Override
    protected void addRasterLayers(List<? extends GPLayerBean> layers,
        ...
        for (GPLayerBean layer : layers) {
            ...
            if (duplicatedLayer) {
                ...
                duplicatedMementoList.add(
                        this.manageDuplicateRasterForSave(rasterDuplicated, aliasForCopiedLayer));
    ...
    protected AbstractMementoOriginalProperties manageDuplicateRasterForSave(RasterTreeNode raster,
            String alias) {
