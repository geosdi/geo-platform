 ...
 */
package org.geosdi.geoplatform.gui.client.widget.store.executor.publisher;
 ...
 */
public class PublisherExecutor extends LayerTreeStoreExecutor implements
        IPublisherExecutor {

    public PublisherExecutor(GPTreePanel<GPBeanTreeModel> thetree) {
        super(thetree);
    }
    ...
    public void addRasterLayersFromPublisher(List<? extends GPLayerBean> layers) {
        super.addRasterLayers(layers,
                GPTreeStoreOperations.LAYERS_FROM_PUBLISHER);
    }
