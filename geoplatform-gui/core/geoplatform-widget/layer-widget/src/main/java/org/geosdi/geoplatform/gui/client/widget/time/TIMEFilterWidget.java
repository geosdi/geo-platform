 ...
 */
public class TIMEFilterWidget extends GeoPlatformWindow {
    ...
    public TIMEFilterWidget(boolean lazy, GPTreePanel<GPBeanTreeModel> treePanel) {
        super(lazy);
        ...
        Button apply = new Button("Apply",
                new SelectionListener<ButtonEvent>() {
                    ...
                    public void componentSelected(ButtonEvent ce) {
                        ...
                        layerSelected.setTimeFilter(filterTextArea.getValue());
    ...
    public void show() {
        ...
        if (timeFilter != null) {
            this.filterTextArea.setValue(timeFilter);
        }
    }
