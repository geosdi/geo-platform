 ...
 */
package org.geosdi.geoplatform.gui.client.widget.tree.menu.activator;
 ...
 */
@Singleton
public class GPTreeMenuActivator implements TreeMenuActivator {

    @Inject
    private SelectionChainManager selectionManager;
    @Inject
    private LayerTreeBasicMenu treeBasicMenu;
    private final GPTreePanel<GPBeanTreeModel> tree;
     ...
     */
    @Inject
    public GPTreeMenuActivator(GinTreePanel ginTreePanel, GPEventBus theBus) {
     ...
     */
    @Override
    public HandlerRegistration addTreeMenuActivatorHandler() {
        return this.bus.addHandler(TreeMenuActivator.TYPE, this);
    }
