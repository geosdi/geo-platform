 ...
 */
@Singleton
public class GPTreeMenuStrategyManager implements TreeMenuStrategyManager {

    private AbstractTreeMenuStrategy menuStrategy;

    /**
     * @param menuStrategy the menuStrategy to set
     */
    @Override
    public void setMenuStrategy(AbstractTreeMenuStrategy menuStrategy) {
    ...
    public Menu getMenu(StoreCompositeKey key) {
        return menuStrategy.getMenu(key);
    }
}