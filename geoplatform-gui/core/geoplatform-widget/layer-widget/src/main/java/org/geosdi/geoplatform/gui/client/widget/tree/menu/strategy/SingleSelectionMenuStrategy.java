 ...
 */
@Singleton
public class SingleSelectionMenuStrategy extends AbstractTreeMenuStrategy {
     ...
     */
    @Inject
    public SingleSelectionMenuStrategy(GinTreePanel ginTreePanel) {
    ...
    public Menu getMenu(StoreCompositeKey key) {
        List<? extends GPMenuGenericTool> tools = this.storeRepository.getMenuCompositeStore().getTools(key);
        return ((tools != null) && (tools.size() > 0)) ? super.buildMenu(key, tools) : null;
    }
}