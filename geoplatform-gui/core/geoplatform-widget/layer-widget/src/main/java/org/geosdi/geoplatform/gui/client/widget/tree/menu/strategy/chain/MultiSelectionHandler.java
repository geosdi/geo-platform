 ...
 */
@Singleton
public class MultiSelectionHandler extends SelectionChainHandler {
    ...
    /**
     * @param theCompositeKeyBuilder
     */
    @Inject
    public MultiSelectionHandler(@MultiSelection SelectionCompositeKeyBuilder theCompositeKeyBuilder) {
    ...
    public Menu buildMenu(TreeMenuStrategyManager strategyManager, List<GPBeanTreeModel> selections) {
        return (selections.size() > 1) ? bindStrategy(strategyManager, selections)
