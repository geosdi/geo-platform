...
public abstract class SelectionChainHandler {
    ...
    public abstract Menu buildMenu(TreeMenuStrategyManager strategyManager,
            List<GPBeanTreeModel> selections);

    protected Menu forwardBuildMenu(TreeMenuStrategyManager strategyManager,
            List<GPBeanTreeModel> selections) {
        return (successor != null) ? successor.buildMenu(strategyManager,
                selections) : null;
    }
