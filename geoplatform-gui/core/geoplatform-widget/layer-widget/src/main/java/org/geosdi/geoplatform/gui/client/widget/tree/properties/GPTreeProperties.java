...
public class GPTreeProperties implements TreeProperties {
    ...
    @Inject
    public GPTreeProperties(GPTreeExpandListener theTreeExpandListener,
            GPTreeDndManager theTreeDndManager,
            GPTreeCheckChange theTreeCheckChange,
            GPTreeBasicProperties theTreeBasicProperties,
