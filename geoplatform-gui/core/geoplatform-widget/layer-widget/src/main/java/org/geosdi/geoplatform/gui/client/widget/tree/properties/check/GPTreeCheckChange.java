 ...
 */
package org.geosdi.geoplatform.gui.client.widget.tree.properties.check;

import com.extjs.gxt.ui.client.event.Events;
import org.geosdi.geoplatform.gui.client.model.visitor.VisitorDisplayHide;
import org.geosdi.geoplatform.gui.client.widget.GPCheckListener;
 ...
 */
@Singleton
public class GPTreeCheckChange implements TreeCheckChange {

    private final VisitorDisplayHide visitorDisplay;
    private final GPTreePanel tree;

    @Inject
    public GPTreeCheckChange(GinVisitorDisplayHide theVisitorDisplay, GinTreePanel theTree) {
    ...
    public void enableCheckChange() {
        tree.addListener(Events.CheckChange, new GPCheckListener(visitorDisplay));
    }
}
