 ...
 */
@Singleton
public class GPTreeDropSupport implements TreeDropSupport {

    private final GPTreePanelDropTarget dropTarget;
    private final GPDNDListener gpDNDListener;
    private final GPTreeStore store;
    private final GPTreePanel tree;

    @Inject
    public GPTreeDropSupport(GPTreePanelDropTarget theDropTarget,
            GinGPDNDListener theGpDNDListener, GinTreeStore theStore,
            GinTreePanel theTree) {
        this.dropTarget = theDropTarget;
