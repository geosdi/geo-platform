 ...
 */
package org.geosdi.geoplatform.gui.client.widget.tree.visitor;
 ...
 */
@Singleton
public class GinVisitorDisplayHide implements GinVisitorDisplayHideBuilder {

    private final GinTreePanel tree;
    private VisitorDisplayHide visitorDisplay;

    @Inject
    public GinVisitorDisplayHide(GinTreePanel theTree) {
        this.tree = theTree;
    }
