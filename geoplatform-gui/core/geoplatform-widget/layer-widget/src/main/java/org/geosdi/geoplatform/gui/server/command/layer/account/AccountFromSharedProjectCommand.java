 ...
 */
package org.geosdi.geoplatform.gui.server.command.layer.account;
 ...
 */
@Lazy
@Component(value = "command.layer.account.AccountFromSharedProjectCommand")
class AccountFromSharedProjectCommand extends GPLayerCommand<AccountFromSharedProjectCommandRequest, AccountFromSharedProjectCommandResponse> {
