 ...
 */
package org.geosdi.geoplatform.gui.server.command.layer.defaultproject;
 ...
 */
@Lazy
@Component(value = "command.layer.defaultproject.DefaultProjectCommand")
class DefaultProjectCommand extends GPLayerCommand<DefaultProjectCommandRequest, DefaultProjectCommandResponse> {
