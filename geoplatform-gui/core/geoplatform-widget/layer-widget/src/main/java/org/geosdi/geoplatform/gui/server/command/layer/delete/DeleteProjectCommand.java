 ...
 */
package org.geosdi.geoplatform.gui.server.command.layer.delete;
 ...
 */
@Lazy
@Component(value = "command.layer.delete.DeleteProjectCommand")
class DeleteProjectCommand extends GPLayerCommand<DeleteProjectCommandRequest, DeleteProjectCommandResponse> {
