...
public interface MapRemote extends RemoteService {
    ...
    @Deprecated
    void saveBaseLayer(String baseLayer) throws GeoPlatformException;

    @Deprecated
    void replaceViewportList(List<GPClientViewport> viewportList) throws
            GeoPlatformException;

    @Deprecated
    List<GPClientViewport> loadViewportElements() throws GeoPlatformException;
}
