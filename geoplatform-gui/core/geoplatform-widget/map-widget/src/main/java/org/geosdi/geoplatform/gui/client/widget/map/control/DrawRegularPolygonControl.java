 ...
 */
public class DrawRegularPolygonControl extends DrawGenericFeatureControl {

    public DrawRegularPolygonControl(Vector vector) {
        super(vector, true);
    }
    ...
    public void createControl() {
        if (!initialized) {
            ...
            RegularPolygonHandlerOptions regularOptions = new RegularPolygonHandlerOptions();
            regularOptions.setSides(40);
            this.control = new DrawFeature(this.vector, new RegularPolygonHandler(),
                    drawPolygonFeatureOptions);
            ((RegularPolygonHandler) control.getHandler()).setOptions(regularOptions);
            initialized = true;
        }
    }
