...
public class BasicLoginRequest implements GPCommandRequest {
    ...
    public BasicLoginRequest(String userName, String password, Long projectID) {
    ...
    public String toString() {
        return "BasicLoginRequest{" + "userName=" + userName
                + ", password=" + password + ", projectID=" + projectID + '}';
    }
