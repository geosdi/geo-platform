 ...
 */
public class BasicLoginResponse implements GPCommandResponse<IGPAccountDetail> {

    private static final long serialVersionUID = 2382685807962844944L;
    //
    ...
    public BasicLoginResponse(IGPAccountDetail accountDetail) {
