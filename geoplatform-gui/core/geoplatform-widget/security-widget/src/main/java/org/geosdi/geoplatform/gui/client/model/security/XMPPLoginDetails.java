 ...
 */
public class XMPPLoginDetails implements Serializable {
    ...
    public String toString() {
        return "XMPPLoginDetails{" + "username=" + username + ", password=" + password + ", hostXmppServer=" + hostXmppServer + '}';
    }
}
