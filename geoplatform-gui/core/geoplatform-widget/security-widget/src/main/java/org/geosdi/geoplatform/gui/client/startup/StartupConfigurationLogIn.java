...
public class StartupConfigurationLogIn implements IStartupConfigurationStrategy {
    ...
    public void initGeoPlatformConfiguration() {
        ...
        ILoginHandler ssoLoginHandler = new SSOLoginHandler();
        injector.getSecurityLoginChainOfResponsibility().setLoginHandler(ssoLoginHandler);
        injector.getLoginAccessManager().doLogin(GeoPlatformEvents.INIT_GEO_PLATFORM, "SSO login in corso...");
