...
public class UpdateAddServerResponse implements
    ...
    //
    private GPServerBeanModel serverSaved;

    public UpdateAddServerResponse() {
    }

    public UpdateAddServerResponse(GPServerBeanModel serverSaved) {
        this.serverSaved = serverSaved;
    }

    @Override
    public GPServerBeanModel getResult() {
        return this.serverSaved;
    }

    @Override
    public String toString() {
        return getClass().getName() + " {" + "result = " + serverSaved + '}';
    }
