...
public class UpdateAddServerCommand implements GPCommand<UpdateAddServerRequest, UpdateAddServerResponse> {

    private static final Logger logger = LoggerFactory.getLogger(UpdateAddServerCommand.class);
    //
    @Autowired
