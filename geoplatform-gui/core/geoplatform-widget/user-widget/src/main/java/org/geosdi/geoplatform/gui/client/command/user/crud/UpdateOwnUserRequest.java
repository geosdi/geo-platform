 ...
 */
public class UpdateOwnUserRequest implements GPCommandRequest {

    private static final long serialVersionUID = 1406383437693352170L;
    //
    private IGPUserManageDetail userDetail;
     ...
     */
    public IGPUserManageDetail getUserDetail() {
        return userDetail;
    }
     ...
     * @param userDetail
     */
    public void setUserDetail(IGPUserManageDetail userDetail) {
     ...
     * @return {@link String}
     */
    public String getCurrentPlainPassword() {
        return currentPlainPassword;
    }

    /**
     * @param currentPlainPassword
     */
    public void setCurrentPlainPassword(String currentPlainPassword) {
    ...
    public String getCommandName() {
        return "command.user.crud.UpdateOwnUserCommand";
    }
}
