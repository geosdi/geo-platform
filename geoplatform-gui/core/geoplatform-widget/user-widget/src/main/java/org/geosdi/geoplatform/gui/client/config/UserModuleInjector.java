...
import org.geosdi.geoplatform.gui.client.widget.UserPropertiesTabWidget;
 ...
 */
@GinModules(value = {UserModuleGinConfigurator.class})
public interface UserModuleInjector extends Ginjector {

    public static class MainInjector {

        private static UserModuleInjector INSTANCE = GWT.create(UserModuleInjector.class);

        private MainInjector() {
        }

        public static UserModuleInjector getInstance() {
            return INSTANCE;
        }
    }
