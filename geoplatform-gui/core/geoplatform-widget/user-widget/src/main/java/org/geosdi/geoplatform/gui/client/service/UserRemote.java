...
public interface UserRemote extends RemoteService {
    ...
    public static class Util {
        ...
        private static final UserRemoteAsync instance = (UserRemoteAsync) GWT.create(
                UserRemote.class);
     ...
     * @throws GeoPlatformException
     */
    Long insertUser(IGPUserManageDetail userDetail, String organization) throws
     ...
     * @throws GeoPlatformException
     */
    Long updateUserTreeOptions(IGPTreeOptions userTreeOptions) throws
            GeoPlatformException;
     ...
     * @throws GeoPlatformException
     */
    boolean updateRolePermission(String role, String organization,
     ...
     * @throws GeoPlatformException
     */
    boolean saveRole(String role, String organization) throws
            GeoPlatformException;
}
