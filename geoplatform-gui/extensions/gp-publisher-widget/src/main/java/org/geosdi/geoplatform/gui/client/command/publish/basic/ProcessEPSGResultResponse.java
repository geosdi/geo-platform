 ...
 */
public class ProcessEPSGResultResponse implements GPCommandResponse<String> {

    private static final long serialVersionUID = -1841493337709990903L;
    //
    private String result;

    public ProcessEPSGResultResponse() {
    }

    public ProcessEPSGResultResponse(String result) {
        this.result = result;
    }
