 ...
 */
public class ProcessEPSGCommandRequest implements GPCommandRequest {

    private static final long serialVersionUID = -7553109302984230751L;
    //
    private List<EPSGLayerData> previewLayerList;
    private String workspace;

    public ProcessEPSGCommandRequest() {
    }

    /**
     * @return {@link List<EPSGLayerData> }
     */
    ...
    public String getCommandName() {
        return "command.publish.process.ProcessEPSGCommand";
    }
}