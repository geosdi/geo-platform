...
public interface PublisherWidgetConstants extends Constants {
    ...
    @DefaultStringValue("Reload Cluster")
    String GPPublisherWidget_toggleButtonClusterReloadText();
    ...
    @DefaultStringValue("Cluster Reload Result")
    String GPPublisherWidget_htmlWindowHeadingText();
