...
public class PreviewLayerList implements Serializable {
    ...
    /**
     * @return the previewLayers
     */
    public List<PreviewLayer> getPreviewLayers() {
        return previewLayers;
    }

    /**
     * @param previewLayers the previewLayers to set
     */
    public void setPreviewLayers(List<PreviewLayer> previewLayers) {
