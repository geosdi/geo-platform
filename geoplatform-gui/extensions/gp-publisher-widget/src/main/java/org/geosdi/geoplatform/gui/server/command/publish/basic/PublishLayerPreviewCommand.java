...
public class PublishLayerPreviewCommand implements GPCommand<PublishLayerPreviewRequest, PublishLayerPreviewResponse> {

    private static final Logger logger = LoggerFactory.getLogger(PublishLayerPreviewCommand.class);
    //
    @Autowired
    private IPublisherService publisherService;

    @Override
    public PublishLayerPreviewResponse execute(PublishLayerPreviewRequest request,
            HttpServletRequest httpServletRequest) {
        logger.debug("#####################Executing {} Command", this.getClass().getSimpleName());
        String result = this.publisherService.publishLayerPreview(httpServletRequest, request.getLayerList(), request.getWorkspace());
