...
public class GPPublisherUploader implements IPublisherUploader {
    ...
    public InfoPreviewStore analyzeZIPEPSG(String sessionID, String userName, File file, String workspace) throws ResourceNotFoundFault {
        return (casPublisherService != null) ? casPublisherService.analyzeZIPEPSG(sessionID, userName, file, workspace) :
                geoPlatformPublishClient.analyzeZIPEPSG(sessionID, userName, file, workspace);
    }

    @Override
    public InfoPreview analyzeTIFInPreview(String sessionID, File file, boolean overwrite, String workspace) throws ResourceNotFoundFault {
