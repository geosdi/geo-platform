 ...
 */
public class DescribeFeatureTypeResponse implements
        GPCommandResponse<LayerSchemaDTO> {

    private static final long serialVersionUID = -8892241374973965061L;
    //
    ...
    public DescribeFeatureTypeResponse(LayerSchemaDTO theLayerSchemaDTO) {
        this.layerSchemaDTO = theLayerSchemaDTO;
    }

    @Override
    public LayerSchemaDTO getResult() {
