 ...
 */
public class GeocodingFieldsetProvider implements Provider<FieldSet> {

    private WFSTWidgetConstants wfstWidgetConstants;

    @Inject
    public GeocodingFieldsetProvider(WFSTWidgetConstants wfstWidgetConstants) {
    ...
    public FieldSet get() {
        ...
        searchFieldSet.setHeadingHtml(
                this.wfstWidgetConstants.searchLabel());
