 ...
 */
public class GeocodingHandlerManager {

    private SimpleEventBus eventBus;
    private static GeocodingHandlerManager INSTANCE;

    private GeocodingHandlerManager() {
        this.eventBus = new SimpleEventBus();
    }

    public static GeocodingHandlerManager get() {
        if (INSTANCE == null) {
            INSTANCE = new GeocodingHandlerManager();
        }
        return INSTANCE;
    }
