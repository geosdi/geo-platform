 ...
 */
public class ResetGeocodingWidgetEvent extends GwtEvent<IGeocodingWidgetHandler> {


    @Override
    public Type<IGeocodingWidgetHandler> getAssociatedType() {
        return IGeocodingWidgetHandler.TYPE;
    }

    @Override
    protected void dispatch(IGeocodingWidgetHandler handler) {
        handler.reset();
    }
}
