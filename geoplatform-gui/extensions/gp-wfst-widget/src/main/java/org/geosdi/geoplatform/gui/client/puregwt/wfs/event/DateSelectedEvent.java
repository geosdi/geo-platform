 ...
 */
public class DateSelectedEvent extends GwtEvent<IDateSelectedHandler> {
    ...
    @Override
    public Type<IDateSelectedHandler> getAssociatedType() {
        return IDateSelectedHandler.TYPE;
    }

    @Override
    protected void dispatch(IDateSelectedHandler handler) {
