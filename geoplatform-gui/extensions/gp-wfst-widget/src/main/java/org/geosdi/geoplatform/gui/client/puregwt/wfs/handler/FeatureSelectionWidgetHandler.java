...
public interface FeatureSelectionWidgetHandler extends EventHandler {
    ...
    final EnableQueryButtonEvent ENABLE_QUERY_BUTTON_EVENT = new EnableQueryButtonEvent(Boolean.TRUE);
    final EnableQueryButtonEvent DISABLE_QUERY_BUTTON_EVENT = new EnableQueryButtonEvent(Boolean.FALSE);
