 ...
 */
public class FeatureAttributesLayoutHandler extends AbstractLayoutHandler {

    private GPEventBus bus;
    private DecreaseHeightEvent event = new DecreaseHeightEvent();

    @Inject
    public FeatureAttributesLayoutHandler(GPEventBus theBus) {
        this.bus = theBus;
    }
    ...
    public boolean canManageLayout(String idPanel) {
        return idPanel.equalsIgnoreCase(FeatureAttributesWidget.ID);
    }
