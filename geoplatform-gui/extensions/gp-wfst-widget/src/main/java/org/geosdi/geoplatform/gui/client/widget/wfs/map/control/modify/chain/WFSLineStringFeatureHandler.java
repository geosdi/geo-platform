...
import org.geosdi.geoplatform.gui.client.editor.map.chain.LineStringEditorHandler;
 ...
 */
public class WFSLineStringFeatureHandler extends LineStringEditorHandler {

    public WFSLineStringFeatureHandler(
            ModifyEditorFeature theModifyEditorControl) {
        super(theModifyEditorControl);

        super.setSuperiorEditorHandler(new WFSLinearRingFeatureHandler(
    ...
    protected void manageUpdatedFeature(VectorFeature vf) {
        ...
        System.out.println("WFSLineStringFeatureHandler manageUpdatedFeature@@@"
