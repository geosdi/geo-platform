 ...
 */
public class FeatureUnSelectListener extends AbstractFeatureListener implements FeatureUnselectedListener {

    public static final EnableToggleStateEvent disableToggleState = new EnableToggleStateEvent(Boolean.FALSE);
    //
    private final IFeatureIdBinder fidBinder;

    public FeatureUnSelectListener(Vector theVectorLayer, GPEventBus bus, IFeatureIdBinder theFidBinder) {
