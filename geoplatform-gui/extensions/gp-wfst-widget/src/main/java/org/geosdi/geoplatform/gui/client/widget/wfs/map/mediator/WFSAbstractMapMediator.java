...
public abstract class WFSAbstractMapMediator implements WFSMapMediator {
    ...
    protected final Map<WFSColleagueKey, WFSMapControlColleague> wfsColleagueRegistry = Maps.newEnumMap(WFSColleagueKey.class);
    ...
    /**
     * @param controlKey
     * @return {@link WFSMapControlColleague}
     */
    @Override
    public final WFSMapControlColleague getWFSColleague(WFSColleagueKey controlKey) {
        return isWFSColleagueRegistered(controlKey) ? this.wfsColleagueRegistry.get(controlKey) : null;
    }
