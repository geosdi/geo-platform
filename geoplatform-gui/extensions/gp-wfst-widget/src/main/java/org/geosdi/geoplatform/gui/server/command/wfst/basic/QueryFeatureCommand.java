...
public class QueryFeatureCommand implements
        GPCommand<QueryFeatureRequest, QueryFeatureResponse> {

    private static final Logger logger = LoggerFactory.getLogger(
            QueryFeatureCommand.class);

    @Override
    public QueryFeatureResponse execute(QueryFeatureRequest request,
