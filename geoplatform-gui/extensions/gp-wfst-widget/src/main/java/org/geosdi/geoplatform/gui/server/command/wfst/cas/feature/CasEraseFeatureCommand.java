...
public class CasEraseFeatureCommand implements
    ...
    @Override
    public EraseFeatureResponse execute(CasEraseFeatureRequest request,
        ...
        try {
            String url = WFSCasUtility.appendProxyTicketToURL(
                    request.getServerUrl(),
                    casAssertion);

            boolean result = this.gpCasTransactionService.transactionDelete(
                    url, request.getTypeName(), request.getFid());
