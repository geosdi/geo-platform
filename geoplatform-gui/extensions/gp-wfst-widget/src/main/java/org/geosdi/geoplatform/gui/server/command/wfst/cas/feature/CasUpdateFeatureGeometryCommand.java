...
import org.geosdi.geoplatform.gui.client.command.wfst.cas.feature.CasUpdateFeatureGeometryRequest;
...
public class CasUpdateFeatureGeometryCommand implements
    ...
    private static final Logger logger = LoggerFactory.getLogger(
            CasUpdateFeatureGeometryCommand.class);
    //
    @Autowired
    ...
    public UpdateFeatureGeometryResponse execute(CasUpdateFeatureGeometryRequest request,
        ...
        try {
            ...
            boolean result = this.gpCasTransactionService.transactionUpdate(url, request.getTypeName(),
                    request.getFid(), Arrays.asList(request.buildGeometryAttribute()), EMPTY_MAP);
