...
public class WFSLayerService implements IWFSLayerService {
    ...
    @Override
    public LayerSchemaDTO describeFeatureType(String serverUrl, String typeName) throws GeoPlatformException {
    ...
    public boolean transactionUpdate(String serverURL, String typeName, String fid,
            List<? extends AttributeDTO> attributes) throws GeoPlatformException {
    ...
    @Override
    public boolean transactionDelete(String serverURL, String typeName, String fid) throws GeoPlatformException {
