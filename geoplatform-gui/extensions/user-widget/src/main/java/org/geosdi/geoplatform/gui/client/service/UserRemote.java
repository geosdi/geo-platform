...
public interface UserRemote extends RemoteService {
     ...
     */
    long insertUser(GPUser user) throws GeoPlatformException;
     ...
     * @throws GeoPlatformException 
     */
    long updateUser(GPUser user) throws GeoPlatformException;
     ...
     * @throws GeoPlatformException 
     */
    boolean deleteUser(RequestById request) throws GeoPlatformException;
     ...
     * @return 
     */
    List<UserDTO> searchUsers(PaginatedSearchRequest request);
}
