 ...
 */
package org.geosdi.geoplatform.gui.googleanalytics.api;
 ...
 */
public interface GoogleAnalyticsSupport {
    ...
    void trackEventWithTracker(String trackerName, String category,
            String action);
    ...
    void trackEventWithTracker(String trackerName, String category,
            String action, String optLabel, int optValue);
