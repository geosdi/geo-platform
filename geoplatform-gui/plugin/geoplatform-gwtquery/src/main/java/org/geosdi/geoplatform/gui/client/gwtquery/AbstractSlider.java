 ...
 */
public abstract class AbstractSlider implements IGWTQueryElement, IGPSubClassesInitialization{
    
    private final String sourceSuffix;

    public AbstractSlider(String sourceSuffix) {
        this.sourceSuffix = sourceSuffix;
    }

    @Override
    public String getGWTQueryElementHtml() {
