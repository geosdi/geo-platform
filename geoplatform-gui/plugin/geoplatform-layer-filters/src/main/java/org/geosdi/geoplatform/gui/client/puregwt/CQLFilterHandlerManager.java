 ...
 */
public class CQLFilterHandlerManager {

    private static CQLFilterHandlerManager instance = new CQLFilterHandlerManager();
    //
    private GPEventBus eventBus;

    private CQLFilterHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    private static CQLFilterHandlerManager getInstance() {
        return instance;
    }
