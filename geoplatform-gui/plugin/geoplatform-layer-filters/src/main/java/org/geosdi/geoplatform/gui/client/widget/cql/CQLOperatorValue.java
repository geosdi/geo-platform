 ...
 */
public class CQLOperatorValue extends GeoPlatformBeanModel {

    private final static List<CQLOperatorValue> operatorList = Lists.newArrayList();
    private static final long serialVersionUID = 1472177209905774862L;

    public enum LimitConditionEnum {

        OPERATOR;
    }

    static {
        operatorList.add(new CQLOperatorValue().setOperatorValue(CQLOperatorEnum.EQUAL));
        operatorList.add(new CQLOperatorValue().setOperatorValue(CQLOperatorEnum.NOT_EQUAL));
        operatorList.add(new CQLOperatorValue().setOperatorValue(CQLOperatorEnum.LESS));
        operatorList.add(new CQLOperatorValue().setOperatorValue(CQLOperatorEnum.GREATER));
    ...
    public CQLOperatorValue setOperatorValue(CQLOperatorEnum operatorValue) {
        super.set(LimitConditionEnum.OPERATOR.toString(), operatorValue);
        return this;
    }

    public static List<CQLOperatorValue> getOperatorList() {
        return operatorList;
    }
}
