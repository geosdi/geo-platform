 ...
 */
public class CQLStringOperator implements ICQLBasicOperator {

    private String operator;

    public CQLStringOperator(String operator) {
        this.operator = operator;
    }

    @Override
    public String generateExpression(String featureAttribute, String conditionValue) {
        StringBuilder builder = new StringBuilder(featureAttribute);
        builder.append(" ");
