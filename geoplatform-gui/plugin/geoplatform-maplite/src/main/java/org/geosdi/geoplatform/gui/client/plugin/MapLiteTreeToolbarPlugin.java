...
import org.geosdi.geoplatform.gui.client.action.ExportMapLiteProjectAction;
 ...
 */
public class MapLiteTreeToolbarPlugin extends TreeToolbarPluginButton {

    @Override
    public String getId() {
        return "EXPORT_MAPLITE_PROJECT";
    }
    ...
    protected ToolbarLayerTreeAction getTreeAction(TreePanel treePanel) {
        return new ExportMapLiteProjectAction(treePanel);
    }
}
