 ...
 */
public class WidgetPropertiesHandlerManager {

    private GPEventBus eventBus;
    private static WidgetPropertiesHandlerManager instance = new WidgetPropertiesHandlerManager();

    private WidgetPropertiesHandlerManager() {
        this.eventBus = new GPEventBusImpl();
    }

    private static WidgetPropertiesHandlerManager getInstance() {
        return instance;
    }
