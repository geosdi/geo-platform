 ...
 */
public class WindowShowEvent extends GwtEvent<IWidgetHandler> {
    

    @Override
    public Type<IWidgetHandler> getAssociatedType() {
        return IWidgetHandler.TYPE;
    }

    @Override
    protected void dispatch(IWidgetHandler handler) {
        handler.afterShow();
    }
