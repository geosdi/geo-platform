 ...
 */
public interface AclEntryDAO extends BaseCriteriaJpaDAO<AclEntry, Long> {
     ...
     * @throws GPDAOException
     */
    List<AclEntry> findBySid(Long sidId) throws GPDAOException;
     ...
     * @throws GPDAOException
     */
    List<AclEntry> findByObjectIdentity(Long objectIdentityId) throws GPDAOException;
}
