 ...
 */
public interface AclObjectIdentityDAO extends BaseCriteriaJpaDAO<AclObjectIdentity, Long> {
     ...
     * @throws GPDAOException
     */
    AclObjectIdentity findByObjectId(Long objectIdClass, Long objectIdIdentity) throws GPDAOException;
}
