 ...
 */
public interface GuiComponentDAO extends BaseCriteriaJpaDAO<GuiComponent, Long> {
     ...
     * @throws GPDAOException
     */
    GuiComponent findByComponentId(String componentId) throws GPDAOException;

    /**
     * @return {@link List<GuiComponent>}
     * @throws GPDAOException
     */
    List<String> findAllGuiComponentIDs() throws GPDAOException;
}
