 ...
 */
public interface GPMessageDAO {

    List<GPMessage> findAll();

    GPMessage find(Long id);

    GPMessage[] find(Long[] ids);

    void persist(GPMessage... messages);

    GPMessage save(GPMessage message);

    GPMessage merge(GPMessage message);

    GPMessage[] merge(GPMessage... message);

    boolean remove(GPMessage message);

    boolean removeById(Long id);

    List<GPMessage> search(ISearch search);

    int count(ISearch search);

    List<GPMessage> findAllMessagesByRecipient(Long recipientID);
