...
public interface GPProjectDAO {
    ...
    List<GPProject> findAll();

    GPProject find(Long id);

    void persist(GPProject... projects);

    GPProject merge(GPProject project);

    GPProject[] merge(GPProject... projects);

    boolean remove(GPProject project);

    boolean removeById(Long id);

    List<GPProject> search(ISearch search);
