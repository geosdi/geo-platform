 ...
 */
public interface GPViewportDAO extends BaseCriteriaJpaDAO<GPViewport, Long> {
     ...
     * @throws GPDAOException
     */
    List<GPViewport> findByAccountProjectID(Long accountProjectID) throws GPDAOException;
}
