 ...
 */
public interface GSResourceDAO extends BaseCriteriaJpaDAO<GSResource, Long> {
     ...
     * @throws GPDAOException
     */
    GSResource findByLayerNameAndGsUser(String layerName, String gsUser) throws GPDAOException;
     ...
     * @throws GPDAOException
     */
    GSResource findByWorkspaceAndGsUser(String workspace, String gsUser) throws GPDAOException;
}
