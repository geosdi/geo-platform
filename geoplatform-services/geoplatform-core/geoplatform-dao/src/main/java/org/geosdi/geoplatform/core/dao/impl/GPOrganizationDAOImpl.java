...
class GPOrganizationDAOImpl extends GPAbstractJpaDAO<GPOrganization, Long> implements GPOrganizationDAO {
     ...
     */
    @Override
    public GPOrganization save(GPOrganization organization) throws GPDAOException {
    ...
    public GPOrganization findByName(String name) throws GPDAOException {
        checkArgument((name != null) && !(name.isEmpty()), "The Parameter name must not be null or an empty string.");
        try {
