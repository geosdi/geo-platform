...
public class CSWResourceNotFoundFault extends Exception {
    ...
    public CSWResourceNotFoundFault(String msg) {
        super(msg);
    }

    public CSWResourceNotFoundFault(String msg, Long id) {
        super(msg);
        this.id = id;
    }

    public CSWResourceNotFoundFault(String message, Throwable cause) {
        super(message, cause);
    }
