...
public interface CSWDelegate {
    ...
    List<ServerCSWDTO> getAllCSWServers(String organizationName)
    ...
    String getRecordById(Long serverID, String identifier) throws Exception;
