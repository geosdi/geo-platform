...
public class GPWFSRequestValidatorTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GPWFSRequestValidatorTest.class);
    //
    private static GPI18NValidator<GPI18NRequestValidator, String> wfsRequestValidator;
     ...
     */
    public static GPWFSSearchFeaturesRequest createWFSGetFeatureRequest() {
