...
public class FeatureReaderNetworkTest {
    ...
    public void readRestrictedAllNet() throws Exception {
        List<LayerSchemaDTO> schemas = featureReaderXSD.read(new URL(
                ...
                + "&typeName=sf:restricted").openStream());
        ...
        logger.info("\n\n HERE THE SCHEMA FOR : sf:restricted ################ "
                + layerSchema);
    }
    ...
    public void readTigerRoadsAllNet() throws Exception {
        ...
        logger.info("\n\n HERE THE SCHEMA FOR : tiger:tiger_roads "
                + "################ " + layerSchema);
    }
    ...
    public void readStatesAllNet() throws Exception {
        List<LayerSchemaDTO> schemas = featureReaderXSD.read(new URL(
                ...
                + "&version=1.1.0"
                + "&request=DescribeFeatureType"
                + "&typeName=topp:states").openStream());
        ...
        logger.info("\n\n HERE THE SCHEMA FOR : topp:states ################ "
                + layerSchema);
    }
