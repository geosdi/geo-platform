 ...
 * workspace, the second firstly in the preview workspace and then into the data
 * datastore of the preview2 workspace In order to execute this test you should
 * provide two shapefiles. The first should be in one ZIP compressed file while
 * the second should be provided provifing its shp, prj, shx and dbf
 * uncrompressed files. You should also modify the paths to access them.
 */
