 ...
 */
public class SendTrackingMessageJob implements Job {

    public static final String SEND_TRACKING_MESSAGE_JOB = "sendTrackingMessageJob";
    public static final String MESSAGE = "message";
    public static final String GP_TRACKING_SERVICE = "gpTrackingService";
