...
public class TrackingScheduler implements InitializingBean {

    public final static String TRACKING_GROUP = "trackingGroup";
     ...
     */
    public JobDetail getSendMessageJobDetail() {
        return sendMessageJobDetail;
    }
}
