 ...
 */
package org.geosdi.geoplatform.core.delegate.api.acl;
 ...
 */
public interface AclDelegate extends GPACLResource {

    @Override
    WSGetRoleResponse getAllRoles(String organization) throws
            ResourceNotFoundFault;

    List<String> getAllGuiComponentIDs();

    GuiComponentsPermissionMapData getApplicationPermission(String appID)
    ...
    GuiComponentsPermissionMapData getRolePermission(String role,
            String organization) throws ResourceNotFoundFault;
    ...
    @Override
    Boolean saveRole(WSSaveRoleRequest saveRoleReq) throws
