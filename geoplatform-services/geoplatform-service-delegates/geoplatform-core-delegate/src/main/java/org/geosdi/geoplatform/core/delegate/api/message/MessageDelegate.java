 ...
 */
public interface MessageDelegate extends GPMessageResource {

    @Override
    Long insertMessage(GPMessage message) throws ResourceNotFoundFault,
            IllegalParameterFault;

    @Override
    Boolean insertMultiMessage(MessageDTO message) throws ResourceNotFoundFault;

    @Override
    Boolean deleteMessage(Long messageID) throws ResourceNotFoundFault;
    ...
    @Override
    Boolean markMessageAsRead(Long messageID) throws ResourceNotFoundFault;
