...
public class GPAclDelegate implements AclDelegate {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GPAclDelegate.class);
    //
    @Autowired
    ...
    @Override
    public Boolean updateRolePermission(WSPutRolePermissionRequest putRolePermissionReq)
            throws ResourceNotFoundFault {
