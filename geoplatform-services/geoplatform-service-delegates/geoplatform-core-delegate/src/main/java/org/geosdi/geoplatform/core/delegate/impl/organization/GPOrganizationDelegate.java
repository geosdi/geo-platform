 ...
 */
package org.geosdi.geoplatform.core.delegate.impl.organization;
 ...
 */
@Component(value = "gpOrganizationDelegate")
public class GPOrganizationDelegate implements OrganizationDelegate {
    ...
    public Boolean deleteOrganization(Long organizationID) throws
        ...
        if (organization == null) {
            throw new ResourceNotFoundFault("Organization not found",
                    organizationID);
        }
