...
public class EmailTask {
    ...
    private VelocityEngine schedulerVelocityEngine;
    //
    ...
    /**
     * @param schedulerVelocityEngine the schedulerVelocityEngine to set
     */
    public void setSchedulerVelocityEngine(VelocityEngine schedulerVelocityEngine) {
        this.schedulerVelocityEngine = schedulerVelocityEngine;
    }
    ...
    public void sendEmailRegistration(GPUser user) throws EmailException {
