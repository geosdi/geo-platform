...
public class MarkMessageReadByDateRequest implements Serializable {

    private static final long serialVersionUID = -3972462588390645561L;
    //
    ...
    public String toString() {
        return getClass().getSimpleName() + " {" + "recipientID = "
                + recipientID + ", toDate = " + toDate + '}';
    }
