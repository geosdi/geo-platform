...
public class AccountProjectPropertiesDTO {
    ...
    public AccountProjectPropertiesDTO(Long theAccountID, Long theProjectID,
            String theProjectName, Integer theProjectVersion,
            boolean isDefaultProject, boolean isShared) {
