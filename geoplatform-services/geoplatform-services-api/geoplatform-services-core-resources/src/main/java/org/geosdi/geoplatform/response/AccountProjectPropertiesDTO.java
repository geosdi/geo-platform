...
public class AccountProjectPropertiesDTO {
     ...
     * @param isShared
     */
    public AccountProjectPropertiesDTO(Long theAccountID, Long theProjectID, String theProjectName, Integer theProjectVersion, boolean isDefaultProject, boolean isShared) {
