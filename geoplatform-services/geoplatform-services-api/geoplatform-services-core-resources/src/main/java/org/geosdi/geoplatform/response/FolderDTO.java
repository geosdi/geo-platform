...
public class FolderDTO extends AbstractElementDTO {
    ...
    public FolderDTO(GPFolder folder) {
        super(folder.getId(), folder.getName(), folder.getPosition(), folder.isShared(), folder.isChecked());
     ...
     */
    public static GPFolder convertToGPFolder(GPProject project, GPFolder parent, FolderDTO folderDTO) {
