...
public class ShortAccountDTOContainer implements Serializable {
    ...
    private List<ShortAccountDTO> accounts;
    ...
    public List<ShortAccountDTO> getAccounts() {
        return accounts = ((this.accounts != null) ? this.accounts
                : Lists.<ShortAccountDTO>newArrayList());
    }

    /**
     * @param accounts the accounts to set
     */
    public void setAccounts(List<ShortAccountDTO> accounts) {
        this.accounts = accounts;
    }

    @Override
    public String toString() {
        return getClass().getName() + " { " + "accounts = "
                + getAccounts() + '}';
    }
