...
public class GPWebServiceMapData {
    ...
    private Map<Long, Integer> descendantsMap = new HashMap<Long, Integer>();

    public GPWebServiceMapData() {
    }

    /**
     * Comment this because REST Support doesn't work. To investigate how
     * resolve the problem
...
//    @XmlJavaTypeAdapter(LongIntegerMapAdapter.class)
    ...
    public void setDescendantsMap(Map<Long, Integer> d) {
        this.descendantsMap = d;
    }

    @Override
    public String toString() {
        return getClass().getSimpleName() + " {" + "descendantsMap = "
                + descendantsMap + '}';
    }
