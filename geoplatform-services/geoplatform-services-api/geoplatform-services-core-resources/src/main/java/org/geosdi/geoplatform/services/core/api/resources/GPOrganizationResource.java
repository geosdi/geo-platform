 ...
 */
public interface GPOrganizationResource {
     ...
     *
     * @throws Exception if Organization is not valid
     * @deprecated only for test purpose
     */
    @Deprecated
    Long insertOrganization(GPOrganization organization) throws Exception;
