 ...
 */
public interface GPViewportResource {

    // <editor-fold defaultstate="collapsed" desc="Viewport">
    // ==========================================================================
    // === Viewport
    // ==========================================================================
    GPViewport getDefaultViewport(Long accountProjectID) throws Exception;
    ...
    Long updateViewport(GPViewport viewport) throws Exception;

    GPViewport getViewportById(Long idViewport) throws Exception;

    Boolean deleteViewport(Long viewportID) throws Exception;

    void saveOrUpdateViewportList(ManageViewportRequest request) throws
            Exception;

    void replaceViewportList(ManageViewportRequest request) throws Exception;
    // </editor-fold>
}
