 ...
 */
public class AccountStrategyFinderTest extends TestCase {

    @Test
    public void testAccountStrategyFinder() {
        Set<AccountDTOStrategy> strategies = AccountStrategyFinder.getAllStrategies(
                null);
