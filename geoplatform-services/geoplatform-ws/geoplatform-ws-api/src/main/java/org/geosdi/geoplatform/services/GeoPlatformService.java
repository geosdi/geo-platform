...
public interface GeoPlatformService {
	...
	@Put
	@HttpResource(location = "/permissions/GPAccessInfo")
	Long insertGPAccessInfo(@WebParam(name = "GPAccessInfo") GPAccessInfo gpAccessInfo);

	@Get
	@HttpResource(location = "/permissions/access/{gsUser}/{layerName}")
	@WebResult(name = "GPAccessInfo")
	GPAccessInfo getGPAccessInfoByLayerNameAndGsUser(@WebParam(name = "layerName") String layerName, @WebParam(name = "gsUser") String gsUser);
