...
public class GPGetFeatureService extends AbstractFeatureService implements GetFeaureService {
    ...
    @Override
    public FeatureDTO getFeature(LayerSchemaDTO layerSchema, String fid) throws Exception {
        assert (fid != null);
    ...
    @Override
    public FeatureCollectionDTO getFeature(LayerSchemaDTO layerSchema, BBox bBox) throws Exception {
        assert (bBox != null);
    ...
    @Override
    public FeatureCollectionDTO getFeature(LayerSchemaDTO layerSchema, int maxFeatures) throws Exception {
    ...
    private WFSGetFeatureRequest createRequest(LayerSchemaDTO layerSchema) throws Exception {
