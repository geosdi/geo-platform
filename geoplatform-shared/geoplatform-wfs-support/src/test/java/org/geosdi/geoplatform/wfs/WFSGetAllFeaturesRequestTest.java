...
public class WFSGetAllFeaturesRequestTest {
    ...
    public void getAllFeaturesTest() throws Exception {
        ...
        request.setTypeName(Arrays.asList(simulation));
        ...
        logger.info("\n\t@@@@@@@@@@@@@@@@@@RESPONSE_AS_STRING : {}",
                getFeatureRequest.getResponseAsString());
        ...
        if (!featureCollection.isFeaturesLoaded()) {
            featureCollection.setErrorMessage(getFeatureRequest
                    .getResponseAsString());
        }

        logger.info("\n\t@@@@@@@@@@@@@@@@@@@@@@@@@@@FEATURE_COLLECTION_DTO : {}",
                featureCollection);
    }
}
