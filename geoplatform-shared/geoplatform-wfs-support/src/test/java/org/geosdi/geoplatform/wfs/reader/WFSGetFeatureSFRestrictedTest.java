...
public class WFSGetFeatureSFRestrictedTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        sfRestrictedLayerSchema = jakartaContextBuilder.unmarshal(new File(basePath.concat("LayerSchemaSFRestricted.xml")), LayerSchemaDTO.class);
        getFeatureSFRestricted = Paths.get(basePath.concat("GetFeatureSFRestricted.xml")).toFile();
    ...
    @Test
    public void a_sfRestrictedSchemaStaxReaderTest() throws Exception {
    ...
    @Test
    public void b_sfRestrictedSchemaGeoJsonStaxReaderTest() throws Exception {
        stopWatch.start("wfsGetFeatureGeoJson");
        WFSGetFeatureGeoJsonStaxReader featureGeoJsonStaxReader = new WFSGetFeatureGeoJsonStaxReader(sfRestrictedLayerSchema);
        FeatureCollection featureCollection = featureGeoJsonStaxReader.read(getFeatureSFRestricted);
        stopWatch.stop();
    ...
    @Test
    public void c_sfRestrictedGeoJsonStaxReaderTest() throws Exception {
        ...
        FeatureCollection featureCollection = geoJsonStaxReader.read(getFeatureSFRestricted);
        stopWatch.stop();
