...
public class WFSGetFeatureSiteTRStaxReaderTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        siteTRLayerSchema = jaxbContextBuilder.unmarshal(new File(basePath.concat("LayerSchemaSiteTR.xml")),
    ...
    @Test
    public void c_siteTRWithoutSchemaGeoJsonStaxReaderTest() throws Exception {
        ...
        FeatureCollection featureCollection = geoJsonStaxReader.read(getFeatureSiteTR);
        stopWatch.stop();
