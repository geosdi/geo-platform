...
class ThreadPoolTaskExecutorConfig implements GPAsyncConfigurer {
    ...
    public Executor createAsyncExecutor(@Qualifier(value = "gpTaskExecutorProp") TaskExecutorProperties gpTaskExecutorProp) {
        logger.debug("\n\n########################################Initializing GeoPlatform ThreadPoolTaskExecutor with Properties \n {}\n",
                gpTaskExecutorProp);
        ...
        executor.setKeepAliveSeconds(gpTaskExecutorProp.getKeepAliveTime());
        executor.setDaemon(gpTaskExecutorProp.isDamon());
