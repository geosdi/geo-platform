 ...
 */
package org.geosdi.geoplatform.support.cxf.server;
...
import org.geosdi.geoplatform.configurator.cxf.server.ServerKeystorePasswordCallback;
 ...
 */
public class ServerInterceptorStrategyFactory
        extends AbstractInterceptorStrategyFactory<GPServerStrategyBean> {

    public ServerInterceptorStrategyFactory(GPServerStrategyBean strategyBean) {
        super(strategyBean);
    }
    ...
    protected WSS4JInInterceptor createEncryptionInInterceptor() {
        ...
        inProps.put(WSHandlerConstants.DEC_PROP_FILE,
                strategyBean.getServerPrivateKeyPropertiesFile());
    ...
    protected WSS4JOutInterceptor createEncryptionOutInterceptor() {
        ...
        outProps.put(WSHandlerConstants.ENC_PROP_FILE,
                strategyBean.getClientPublicKeyPropertiesFile());
        outProps.put(WSHandlerConstants.ENCRYPTION_USER,
                strategyBean.getClientKeystoreUser());
