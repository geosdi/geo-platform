 ...
 */
public abstract class JTSBaseWriter<GEOJSON extends GeoJsonObject, JTS extends Geometry> implements JTSGeometryWriter<GEOJSON, JTS> {

    protected final Logger logger = LoggerFactory.getLogger(this.getClass());
    //
    private JTSGeometryWriterImplementorKey key;
    ...
    public JTS writeGeometry(GEOJSON geojson) throws Exception {
        checkArgument(geojson != null, "The Parameter geojson must not be null.");
     ...
     */
    @Override
    public final JTSGeometryWriterImplementorKey getKey() {
     ...
     */
    protected abstract JTSGeometryWriterImplementorKey prepareKey();
