...
public class JTSLineStringWriter extends AbstractJTSLineWriter<LineString, org.geojson.LineString> {
     ...
     */
    @Override
    protected <GEOJSON extends org.geojson.LineString> LineString buildInternal(GEOJSON lineString) throws Exception {
        logger.trace(":::::::::::::::{} is creating JTS LineString for GeoJson LineString : {}\n", this, lineString);
        return GEOMETRY_FACTORY.createLineString(JTS_COORDINATE_WRITER.buildJTSCoordinates(lineString.getCoordinates()));
    }
    ...
    protected JTSGeometryWriterImplementorKey prepareKey() {
        return forClass(org.geojson.LineString.class);
    }
}