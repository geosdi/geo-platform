 ...
 */
public class JTSMultiLineStringWriter extends JTSBaseWriter<MultiLineString, org.locationtech.jts.geom.MultiLineString> {
     ...
     */
    @Override
    public org.locationtech.jts.geom.MultiLineString buildJTSGeometry(@Nonnull(when = NEVER) MultiLineString multiLineString) throws Exception {
        checkArgument(multiLineString != null, "The Parameter multiLineString must not be null.");
        logger.trace(":::::::::::::::{} is creating JTS MultiLineString for GeoJson MultiLineString : {}\n", this, multiLineString);
        return GEOMETRY_FACTORY.createMultiLineString(JTS_COORDINATE_WRITER.buildJTSLineStrings(multiLineString.getCoordinates()));
    }
    ...
    protected JTSGeometryWriterImplementorKey prepareKey() {
        return forClass(MultiLineString.class);
    }
}