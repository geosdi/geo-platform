...
public class JTSMultiPointWriter extends JTSBaseWriter<MultiPoint, org.locationtech.jts.geom.MultiPoint> {
     ...
     */
    @Override
    public org.locationtech.jts.geom.MultiPoint buildJTSGeometry(@Nonnull(when = NEVER) MultiPoint multiPoint) throws Exception {
        Preconditions.checkArgument(multiPoint != null, "The Parameter multiPoint must not be null.");
    ...
    protected JTSGeometryWriterImplementorKey prepareKey() {
        return forClass(MultiPoint.class);
    }
}