...
public class JTSMultiPolygonWriter extends JTSBaseWriter<MultiPolygon, org.locationtech.jts.geom.MultiPolygon> {
     ...
     */
    @Override
    public org.locationtech.jts.geom.MultiPolygon buildJTSGeometry(@Nonnull(when = NEVER) MultiPolygon multiPolygon) throws Exception {
        checkArgument(multiPolygon != null, "The Parameter multiPolygon must not be null.");
        logger.trace(":::::::::::::::{} is creating JTS MultiPolygon for GeoJson MultiPolygon : {}\n", this, multiPolygon);
        return GEOMETRY_FACTORY.createMultiPolygon(JTS_COORDINATE_WRITER.buildJTSPolygons(multiPolygon.getCoordinates()));
    }
    ...
    protected JTSGeometryWriterImplementorKey prepareKey() {
        return forClass(MultiPolygon.class);
    }
}
