...
public class JTSPointWriter extends JTSBaseWriter<Point, org.locationtech.jts.geom.Point> {
     ...
     */
    @Override
    public org.locationtech.jts.geom.Point buildJTSGeometry(@Nonnull(when = NEVER) Point point) throws Exception {
        checkArgument(point != null, "The Parameter point must not be null.");
