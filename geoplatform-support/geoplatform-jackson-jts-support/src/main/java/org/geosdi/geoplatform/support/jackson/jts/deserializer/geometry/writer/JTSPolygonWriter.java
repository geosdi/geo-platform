...
public class JTSPolygonWriter extends JTSBaseWriter<Polygon, org.locationtech.jts.geom.Polygon> {
     ...
     */
    @Override
    public org.locationtech.jts.geom.Polygon buildJTSGeometry(@Nonnull(when = NEVER) Polygon polygon) throws Exception {
        checkArgument(polygon != null, "The Parameter polygon must not be null.");
        logger.trace(":::::::::::::::{} is creating JTS Polygon for GeoJson Polygon : {}\n", this, polygon);
        return GEOMETRY_FACTORY.createPolygon(JTS_COORDINATE_WRITER.buildJTSLinearRing(polygon.getExteriorRing()), JTS_COORDINATE_WRITER.buildJTSLinearRings(polygon.getInteriorRings()));
    }
