 ...
 */
@ThreadSafe
public final class JTSGeometryWriterImplementorFinder<I extends JTSGeometryWriterImplementor<? extends GeoJsonObject, ? extends Geometry>> extends GPBaseImplementorFinder<I> {

    private static final Logger logger = LoggerFactory.getLogger(JTSGeometryWriterImplementorFinder.class);
    //
    private volatile ServiceLoader<JTSGeometryWriterImplementor> loader = ServiceLoader.load(JTSGeometryWriterImplementor.class, currentThread().getContextClassLoader());
    ...
    public Set<I> getValidImplementors() {
        return loadImplementors(JTSGeometryWriterImplementor.class, FALSE);
    }
    ...
    protected <V extends GPImplementor> Set<I> loadImplementors(Class<V> type, Boolean all) {
        Iterator<JTSGeometryWriterImplementor> jtsGeometryWriterImplementors = loader.iterator();
            ...
            public boolean hasNext() {
                ...
                while (jtsGeometryWriterImplementors.hasNext()) {
                    ...
                    if ((type == null) || (type.isInstance(jtsGeometryWriterImplementor))) {
                        if (all || jtsGeometryWriterImplementor.isValid()) {
