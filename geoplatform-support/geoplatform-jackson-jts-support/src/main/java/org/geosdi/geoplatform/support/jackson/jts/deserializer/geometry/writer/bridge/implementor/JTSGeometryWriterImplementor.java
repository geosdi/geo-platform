...
public interface JTSGeometryWriterImplementor<GEOJSON extends GeoJsonObject, JTS extends Geometry> extends GPImplementor<Class<GEOJSON>> {
     ...
     * @throws Exception
     */
    JTS buildJTSGeometry(@Nonnull(when = NEVER) GEOJSON geojson) throws Exception;
    ...
    class JTSGeometryWriterImplementorKey implements GPImplementor.GPImplementorKey<Class<?>> {
         ...
         * @param theClasse
         */
        JTSGeometryWriterImplementorKey(@Nonnull(when = NEVER) Class<?> theClasse) {
         ...
         */
        public static JTSGeometryWriterImplementorKey forClass(@Nonnull(when = NEVER) Class<?> theClasse) {
