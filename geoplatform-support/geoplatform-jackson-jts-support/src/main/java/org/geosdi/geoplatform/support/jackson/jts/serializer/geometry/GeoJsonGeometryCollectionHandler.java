 ...
 */
public class GeoJsonGeometryCollectionHandler extends GPGeoJsonGeometryHandler<JTSGeometryCollectionAdapter> {
     ...
     */
    @Override
    public Class<JTSGeometryCollectionAdapter> getCompatibleGeometry() {
        return JTSGeometryCollectionAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSGeometryCollectionAdapter;
    }
}