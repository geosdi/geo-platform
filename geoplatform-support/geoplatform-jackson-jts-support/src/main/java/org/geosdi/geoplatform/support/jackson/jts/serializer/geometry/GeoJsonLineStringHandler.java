...
import org.geosdi.geoplatform.support.jackson.jts.adapter.JTSLineStringAdapter;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class GeoJsonLineStringHandler extends GPGeoJsonGeometryHandler<JTSLineStringAdapter> {

    public GeoJsonLineStringHandler() {
        super.setSuccessor(new GeoJsonLinearRingHandler());
    }
     ...
     */
    @Override
    public Class<JTSLineStringAdapter> getCompatibleGeometry() {
        return JTSLineStringAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSLineStringAdapter;
    }
}