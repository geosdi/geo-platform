 ...
 */
public class GeoJsonMultiLineStringHandler extends GPGeoJsonGeometryHandler<JTSMultiLinestringAdapter> {

    public GeoJsonMultiLineStringHandler() {
        super.setSuccessor(new GeoJsonMultiPolygonHandler());
    }
     ...
     */
    @Override
    public Class<JTSMultiLinestringAdapter> getCompatibleGeometry() {
        return JTSMultiLinestringAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSMultiLinestringAdapter;
    }
}