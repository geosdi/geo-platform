 ...
 */
public class GeoJsonMultiPointHandler extends GPGeoJsonGeometryHandler<JTSMultiPointAdapter> {
     ...
     */
    @Override
    public Class<JTSMultiPointAdapter> getCompatibleGeometry() {
        return JTSMultiPointAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSMultiPointAdapter;
    }
}