 ...
 */
public class GeoJsonMultiPolygonHandler extends GPGeoJsonGeometryHandler<JTSMultiPolygonAdapter> {
     ...
     */
    @Override
    public Class<JTSMultiPolygonAdapter> getCompatibleGeometry() {
        return JTSMultiPolygonAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSMultiPolygonAdapter;
    }
}