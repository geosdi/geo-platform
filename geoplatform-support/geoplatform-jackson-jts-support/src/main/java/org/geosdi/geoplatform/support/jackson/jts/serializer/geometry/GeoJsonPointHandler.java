 ...
 */
public class GeoJsonPointHandler extends GPGeoJsonGeometryHandler<JTSPointAdapter> {
     ...
     */
    @Override
    public Class<JTSPointAdapter> getCompatibleGeometry() {
        return JTSPointAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSPointAdapter;
    }
}