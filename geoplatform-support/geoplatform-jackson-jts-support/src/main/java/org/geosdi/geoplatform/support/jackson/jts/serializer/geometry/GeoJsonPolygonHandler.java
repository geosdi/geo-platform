 ...
 */
public class GeoJsonPolygonHandler extends GPGeoJsonGeometryHandler<JTSPolygonAdapter> {
     ...
     */
    @Override
    public Class<JTSPolygonAdapter> getCompatibleGeometry() {
        return JTSPolygonAdapter.class;
    }
    ...
    protected Boolean canParseGeometry(GPJTSGeometryAdapter geometryAdapter) {
        return geometryAdapter instanceof JTSPolygonAdapter;
    }
}