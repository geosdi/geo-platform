 ...
 */
public interface GeometryWriter<JTS extends GPJTSGeometryAdapter, GEOJSON extends GeoJsonObject> extends GeometryWriterImplementor<JTS, GEOJSON> {

    GPGeometryWriterImplementorStore GEOMETRY_WRITER_IMPLEMENTOR_STORE = new GeometryWriterImplementorStore();
