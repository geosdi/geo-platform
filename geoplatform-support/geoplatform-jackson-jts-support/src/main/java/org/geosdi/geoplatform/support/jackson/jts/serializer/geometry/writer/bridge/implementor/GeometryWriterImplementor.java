...
public interface GeometryWriterImplementor<JTS extends GPJTSGeometryAdapter, GEOJSON extends GeoJsonObject> extends GPImplementor<Class<JTS>> {
     ...
     * @throws Exception
     */
    void writeGeometry(@Nonnull(when = NEVER) JTS geometry, @Nonnull(when = NEVER) JsonGenerator jsonGenerator) throws Exception;
     ...
     * @throws Exception
     */
    GEOJSON buildGeoJsonGeometry(@Nonnull(when = NEVER) JTS geometry) throws Exception;
    ...
    class GeometryWriterImplementorKey implements GPImplementorKey<Class<?>> {
         ...
         * @param theClasse
         */
        GeometryWriterImplementorKey(@Nonnull(when = NEVER) Class<?> theClasse) {
         ...
         */
        public static GeometryWriterImplementorKey forClass(@Nonnull(when = NEVER) Class<?> theClasse) {
