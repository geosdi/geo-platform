 ...
 */
package org.geosdi.geoplatform.support.jackson.mapper.jakarta;
...
public class CatalogJacksonJakartaMapperTest {

    private static final Logger logger = LoggerFactory.getLogger(CatalogJacksonJakartaMapperTest.class);
    //
    private static final GPJacksonMapper<Catalog> GP_JACKSON_JAKARTA_MAPPER = new GPBaseJacksonMapper<>(Catalog.class,
    ...
    public void a_writeCatalogAsJsonStringTest() throws Exception {
        logger.info("\n{}\n", GP_JACKSON_JAKARTA_MAPPER.writeAsString(CatalogJacksonXmlMapperTest::catalogBean));
    }

    @Test
    public void b_writeCatalogAsJsonStringTest() throws Exception {
        logger.info("\n{}\n", GP_JACKSON_JAKARTA_MAPPER.writeAsString(catalogBean(10)));
    }

    @Test
    public void c_readCatalogFromJsonStringTest() throws Exception {
        Catalog catalog = GP_JACKSON_JAKARTA_MAPPER.read(new StringReader("{\n"
                + "  \"CD\" : [ {\n"
                + "    \"TITLE\" : \"TITLE#0\",\n"
                + "    \"ARTIST\" : \"ARTIST#0\",\n"
                + "    \"COUNTRY\" : \"COUNTRY#0\",\n"
