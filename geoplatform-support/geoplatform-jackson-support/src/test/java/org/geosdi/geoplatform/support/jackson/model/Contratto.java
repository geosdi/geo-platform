 ...
 */
@XmlRootElement(name = "CONTRATTO")
@XmlType(propOrder = {"NUMERO", "DESCRIZIONE", "DATA_EMISSIONE", "VALORE_PUNTOA", "VALORE_PUNTOB",
        "DATA_INIZIO", "DATA_FINE", "IMPORTO_MASSIMO"})
@Getter
@Setter
@ToString
public class Contratto implements Serializable {

    private static final long serialVersionUID = 4914444677368383081L;
    //
