...
public class GPSMTPMailPropertiesBuilder {
    ...
    public GPSMTPMailPropertiesBuilder withSMTPMailProperties(SMTPMailProperties theSMTPMailProp) {
    ...
    public Properties buildJavaMailProperties() {
        ...
        return new Properties() {
...

            {
                ...
                super.put(JavaMailProp.MAIL_HOST.getValue(), smtpMailProp.getHost());
                super.put(JavaMailProp.MAIL_PORT, smtpMailProp.getPort());
