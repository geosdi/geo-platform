...
public class GPMailSpringDetail implements GPMailDetail {
    ...
    public String getFrom() {
        return this.from = (this.from != null) ? this.from
                : gpMailPooledPBEStringEncryptor.decrypt(GPMailDetailSupport.GP_ENC_MAIL_KEY.getValue());
    }
    ...
    public String getReplayTo() {
        return this.replayTo = (this.replayTo != null) ? this.replayTo
                : gpMailPooledPBEStringEncryptor.decrypt(GPMailDetailSupport.GP_ENC_MAIL_KEY.getValue());
    }
    ...
    public String getFromName() {
        return this.fromName = (this.fromName != null) ? this.fromName
                : GPMailDetailSupport.GP_REPLAY_KEY.getValue();
    }
    ...
    public String getReplayToName() {
        return this.replayToName = (this.replayToName != null) ? this.replayToName
                : GPMailDetailSupport.GP_REPLAY_KEY.getValue();
    }

    @Override
    public String toString() {
        return "GPMailSpringDetail{ " + "from = " + getFrom()
