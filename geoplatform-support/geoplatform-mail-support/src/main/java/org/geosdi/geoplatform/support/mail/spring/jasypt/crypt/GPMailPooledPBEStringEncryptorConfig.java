 ...
 */
package org.geosdi.geoplatform.support.mail.spring.jasypt.crypt;
...
class GPMailPooledPBEStringEncryptorConfig {
    ...
    @Autowired
    public PooledPBEStringEncryptor gpMailPooledPBEStringEncryptor(@Qualifier(
            value = "mailPBEConfig") PBEConfig mailPBEConfig) {
