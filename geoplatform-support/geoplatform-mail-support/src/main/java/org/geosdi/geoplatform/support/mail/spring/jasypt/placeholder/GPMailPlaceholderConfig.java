...
class GPMailPlaceholderConfig {
    ...
    public static EncryptablePropertySourcesPlaceholderConfigurer gpMailPropertyConfigurer(@Qualifier(
            ...
            @Value("#{systemProperties['GP_MAIL_FILE_PROP']}") String gpMailFileProp)
        ...
        gpMPC.setNullValue("@null");

        gpMPC.setLocations(placeholderResourcesLoader.loadResources(gpConfigDataDir,
                gpMailFileProp));
        gpMPC.setIgnoreResourceNotFound(Boolean.TRUE);
        gpMPC.setIgnoreUnresolvablePlaceholders(Boolean.TRUE);
