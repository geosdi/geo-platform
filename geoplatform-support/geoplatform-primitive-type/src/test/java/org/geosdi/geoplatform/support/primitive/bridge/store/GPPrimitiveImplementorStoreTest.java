...
public class GPPrimitiveImplementorStoreTest {
    ...
    public void loadIntegerPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(int.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(int[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Integer.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Integer[].class));
    }
    ...
    public void loadBigDecimalPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(BigDecimal.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(BigDecimal[].class));
    }
    ...
    public void loadBigIntegerPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(BigInteger.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(BigInteger[].class));
    }
    ...
    public void loadBooleanPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Boolean.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Boolean[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(boolean.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(boolean[].class));
    }
    ...
    public void loadBytePrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Byte.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Byte[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(byte.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(byte[].class));
    }
    ...
    public void loadDoublePrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Double.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Double[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(double.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(double[].class));
    }
    ...
    public void loadFloatPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Float.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Float[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(float.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(float[].class));
    }
    ...
    public void loadLongPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Long.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Long[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(long.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(long[].class));
    }
    ...
    public void loadNumberPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Number.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Number[].class));
    }
    ...
    public void loadShortPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Short.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Short[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(short.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(short[].class));
    }
    ...
    public void loadCharacterPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Character.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(Character[].class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(char.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(char[].class));
    }
    ...
    public void loadStringPrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(String.class));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(String[].class));
    }
    ...
    public void loadDateTimePrimitiveImplementorTest() throws Exception {
        ...
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(dateTime.getClass()));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(dateTime.toLocalDateTime().getClass()));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(dateTime.toMutableDateTime().getClass()));
        assertTrue(primitiveImplementorStore.isPrimitiveOrWrapper(dateTime.toInstant().getClass()));
    }
