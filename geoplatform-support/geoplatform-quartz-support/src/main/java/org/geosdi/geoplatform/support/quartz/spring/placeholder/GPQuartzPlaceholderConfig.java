...
class GPQuartzPlaceholderConfig {
    ...
    public static PropertySourcesPlaceholderConfigurer gpQuartzPropertyConfigurer(
        ...
        gpQuartzPC.setLocations(placeholderQuartzResourcesLoader.loadResources(
                gpQuartzConfigDataDir,
                gpQuartzFileProp));
        gpQuartzPC.setIgnoreResourceNotFound(Boolean.TRUE);
        gpQuartzPC.setIgnoreUnresolvablePlaceholders(Boolean.TRUE);
