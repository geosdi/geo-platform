...
public abstract class GPBaseJobTask implements JobTask {
    ...
    protected final boolean unscheduleJob(Scheduler scheduler,
    ...
    protected final boolean unscheduleJobs(Scheduler scheduler,
    ...
    protected final void scheduleJob(Scheduler scheduler, Trigger trigger) {
        try {
    ...
    protected final void scheduleJob(Scheduler scheduler, JobDetail jobDetail,
            Trigger trigger) {
        try {
    ...
    protected final void scheduleJobs(Scheduler scheduler,
