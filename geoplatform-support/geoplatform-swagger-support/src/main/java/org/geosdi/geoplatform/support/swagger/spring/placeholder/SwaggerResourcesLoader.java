...
class SwaggerResourcesLoader {
    ...
    Resource[] loadResources(String gpSwaggerDataDir,
        ...
        String fileToSearch = ((gpSwaggerFileProp != null)
                && (!gpSwaggerFileProp.isEmpty())) ? ((gpSwaggerFileProp.contains(
                                "."))
                        && (gpSwaggerFileProp.endsWith(".properties"))) ? gpSwaggerFileProp
                                : (gpSwaggerFileProp.contains(".")) ? gpSwaggerFileProp.substring(
                                                0,
                                                gpSwaggerFileProp.indexOf(".")) + ".properties"
