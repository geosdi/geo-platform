 ...
 */
public interface XMPPBaseProperties extends XMPPProperties {

    /**
     * @param theXMPPHost
     */
    void setXMPPHost(String theXMPPHost);

    /**
     * @param theXMPPPort
     */
    void setXMPPPort(Integer theXMPPPort);

    /**
     * @param theXMPPAuth
     */
    void setXMPPAuth(XMPPAuth theXMPPAuth);
