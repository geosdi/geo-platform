...
class GPXMPPConnectionManagerConfig {
    ...
    /**
     * @param xmppConnectionConfiguration
     * @param gpSpringXMPPAuth
     * @return {@link XMPPConnectionManager}
     */
    @Bean(name = "gpXMPPConnectionManager", initMethod = "initXMPPConnectionManager")
    public XMPPConnectionManager xmppConnectionManager(@Qualifier(value = "xmppConnectionConfiguration") XMPPTCPConnectionConfiguration xmppConnectionConfiguration,
            @Qualifier(value = "gpSpringXMPPAuth") XMPPAuth gpSpringXMPPAuth) {
