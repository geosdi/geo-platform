...
public class GPXMPPConnectionManager implements XMPPConnectionManager {
    ...
    public GPXMPPConnectionManager(ConnectionConfiguration theConnectionConfig,
            XMPPAuth theGPSpringXMPPAuth) {
    ...
    @Override
    public void login() throws XMPPException, SmackException, SaslException,
            IOException {
    ...
    @Override
    public void login(String resource) throws XMPPException, SmackException,
            SaslException, IOException {
        this.connection.login(this.gpSpringXMPPAuth.getXMPPUserName(),
                this.gpSpringXMPPAuth.getXMPPPassword(), resource);
    }

    @Override
    public void sendPacket(Packet packet) throws
    ...
    @Override
    public final void initXMPPConnectionManager() throws SmackException,
