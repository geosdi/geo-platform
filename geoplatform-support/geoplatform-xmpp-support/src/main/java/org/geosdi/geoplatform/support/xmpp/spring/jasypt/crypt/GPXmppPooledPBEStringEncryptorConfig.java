 ...
 *
 */
package org.geosdi.geoplatform.support.xmpp.spring.jasypt.crypt;
 ...
 */
@Configuration
public class GPXmppPooledPBEStringEncryptorConfig {

    @Bean(name = "gpXmppPooledPBEStringEncryptor")
    @Autowired
    public PooledPBEStringEncryptor gpXmppPooledPBEStringEncryptor(@Qualifier(
            value = "xmppPBEConfig") PBEConfig mailPBEConfig) {
