...
public class ServerStrategyBean implements GPServerStrategyBean {
    ...
    public String toString() {
        return getClass().getSimpleName() + " { " + "loggingStrategy = "
                + loggingStrategy + ", securityStrategy = "
                + securityStrategy + ", usernameTokenUser = "
                + usernameTokenUser + ", clientKeystoreUser = "
                + clientKeystoreUser + ", serverKeystoreUser = "
                + serverKeystoreUser + ", serverPrivateKeyPropertiesFile = "
                + serverPrivateKeyPropertiesFile
                + ", clientPublicKeyPropertiesFile = "
                + clientPublicKeyPropertiesFile + '}';
    }
