...
public class ClientStrategyBean implements InterceptorStrategyBean {
    ...
    @Value(value = "${webservice_client_privatekey_properties_file}")
    private String clientPrivateKeyPropertiesFile;
    @Value(value = "${webservice_server_publickey_properties_file}")
