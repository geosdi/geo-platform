 ...
 */
@ThreadSafe
public class GPGeoserverLoadCoverageListRequest extends GPJsonGetConnectorRequest<GPGeoserverListCoverageStores, GeoserverLoadCoverageListRequest> implements GeoserverLoadCoverageListRequest {
    ...
    protected String createUriPath() throws Exception {
        ...
        return ((baseURI.endsWith("/") ? baseURI.concat("workspaces/").concat(workspace).concat("/coveragestores/").concat(store).concat("/coverages.json")
                : baseURI.concat("/workspaces/").concat(workspace).concat("/coveragestores/").concat(store).concat("/coverages.json")));
    }
     ...
     */
    @Override
    protected Class<GPGeoserverListCoverageStores> forClass() {
        return GPGeoserverListCoverageStores.class;
    }
}