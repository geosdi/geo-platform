...
public class GPGeoserverConnectorStoreV216xTest extends GPBaseGeoserverConnectorStoreV216xTest {

    @Test
    public void a_aboutVersionGeoserverConnectorTest() throws Exception {
        GPGeoserverAboutVersionRequest aboutRequest = geoserverConnectorStoreV2_16_x.createAboutVersionRequest();
    ...
    public void b_aboutStatusGeoserverConnectorTest() throws Exception {
        GPGeoserverAboutStatusRequest aboutStatusRequest = geoserverConnectorStoreV2_16_x.createAboutStatusRequest();
    ...
    public void c_workspacesGeoserverConnectorTest() throws Exception {
        GPGeoserverLoadWorkspacesRequest workspacesRequest = geoserverConnectorStoreV2_16_x.loadWorkspacesRequest();
    ...
    public void d_namespacesGeoserverConnectorTest() throws Exception {
        GPGeoserverNamespacesRequest namespacesRequest = geoserverConnectorStoreV2_16_x.createNamespacesRequest();
    ...
    public void e_namespaceGeoserverConnectorTest() throws Exception {
        GPGeoserverNamespaceRequest namespaceRequest = geoserverConnectorStoreV2_16_x.createNamespaceRequest();
    ...
    public void g_layersGeoserverConnectorTest() throws Exception {
        GPGeoserverLayersRequest layersRequest = geoserverConnectorStoreV2_16_x.loadLayersRequest();
    ...
    public void h_stylesGeoserverConnectorTest() throws Exception {
        GPGeoserverStylesRequest stylesRequest = geoserverConnectorStoreV2_16_x.loadStylesRequest();
    ...
    public void i_styleGeoserverConnectorTest() throws Exception {
        GeoserverStyleRequest styleRequest = geoserverConnectorStoreV2_16_x.loadStyleRequest();
    ...
    public void m_layerVectorGeoserverConnectorTest() throws Exception {
        GPGeoserverLoadLayerRequest layerRequest = geoserverConnectorStoreV2_16_x.loadLayerRequest();
    ...
    public void p_createWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverCreateWorkspaceRequest createWorkspaceRequest = geoserverConnectorStoreV2_16_x.createWorkspaceRequest();
    ...
    public void q_loadWorkspaceGeoserverConnectorTest() throws Exception {
        GPGeoserverLoadWorkspaceRequest loadWorkspaceRequest = geoserverConnectorStoreV2_16_x.loadWorkspaceRequest();
    ...
    public void r_updateWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverUpdateWorkspaceRequest updateWorkspaceRequest = geoserverConnectorStoreV2_16_x.updateWorkspaceRequest();
    ...
    public void s_deleteWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverDeleteWorkspaceRequest deleteWorkspaceRequest = geoserverConnectorStoreV2_16_x.deleteWorkspaceRequest();
