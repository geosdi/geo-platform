...
public class GPGeoserverConnectorStoreV219XTest extends GPBaseGeoserverConnectorStoreV219xTest {
    ...
    public void c_workspacesGeoserverConnectorTest() throws Exception {
        GPGeoserverLoadWorkspacesRequest workspacesRequest = geoserverConnectorStoreV2_19_x.loadWorkspacesRequest();
    ...
    public void h_stylesGeoserverConnectorTest() throws Exception {
        GPGeoserverStylesRequest stylesRequest = geoserverConnectorStoreV2_19_x.loadStylesRequest();
    ...
    public void q_loadWorkspaceGeoserverConnectorTest() throws Exception {
        GPGeoserverLoadWorkspaceRequest loadWorkspaceRequest = geoserverConnectorStoreV2_19_x.loadWorkspaceRequest();
