...
public class GPGeoserverFeatureTypesConnectorTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadWorkspaceDatastoreFeatureTypesTest() throws Exception {
        GeoserverLoadWorkspaceDatastoreFeatureTypesRequest workspaceDatastoreFeatureTypesRequest = geoserverConnectorStoreV2_18_x
    ...
    public void e_loadWorkspaceFeatureTypesTest() throws Exception {
        GeoserverLoadWorkspaceFeatureTypesRequest workspaceFeatureTypesRequest = geoserverConnectorStoreV2_18_x.loadWorkspaceFeatureTypesRequest();
    ...
    public void f_createFeatureTypeTest() throws Exception {
        GeoserverCreateFeatureTypeRequest createFeatureTypeRequest = geoserverConnectorStoreV2_18_x.createFeatureTypeRequest();
    ...
    public void g_deleteFeatureTypeTest() throws Exception {
        GeoserverDeleteFeatureTypeRequest deleteFeatureTypeRequest = geoserverConnectorStoreV2_18_x.deleteFeatureTypeRequest();
