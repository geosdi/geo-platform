...
public class GPGeoserverSecurityConnectorStoreV219XTest extends GPBaseGeoserverConnectorStoreV219xTest {
    ...
    public void a_loadGeoserverMasterPasswordTest() throws Exception {
        GPGeoserverGetMasterPasswordRequest geoserverGetMasterPasswordRequest = geoserverConnectorStoreV2_19_x.loadMasterPasswordRequest();
    ...
    public void b_loadGeoserverCatalogRequestTest() throws Exception {
        GPGeoserverGetCatalogRequest geoserverGetCatalogRequest = geoserverConnectorStoreV2_19_x.loadCatalogRequest();
    ...
    public void c_updateGeoserverCatalogRequestTest() throws Exception {
        GPGeoserverUpdateCatalogRequest updateCatalogRequest = geoserverConnectorStoreV2_19_x.updateCatalogRequest();
