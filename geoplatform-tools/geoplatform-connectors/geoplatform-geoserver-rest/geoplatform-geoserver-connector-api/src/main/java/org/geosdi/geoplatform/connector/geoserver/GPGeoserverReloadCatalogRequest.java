 ...
 */
@ThreadSafe
class GPGeoserverReloadCatalogRequest extends GPJsonPostConnectorRequest<Boolean, GeoserverReloadCatalogRequest> implements GeoserverReloadCatalogRequest {

    /**
     * @param theServerConnector
     * @param theJacksonSupport
     */
    GPGeoserverReloadCatalogRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
