 ...
 */
class GPGeoserverRestRunningRequest extends GPJsonGetConnectorRequest<Boolean, GeoserverRestRunningRequest> implements GeoserverRestRunningRequest {

    /**
     * @param server
     * @param theJacksonSupport
     */
    GPGeoserverRestRunningRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
