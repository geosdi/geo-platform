...
class GPGeoserverAboutSystemStatusRequest extends GPJsonGetConnectorRequest<GPGeoserverAboutSystemStatusMetricStore, GeoserverAboutSystemStatusRequest> implements GeoserverAboutSystemStatusRequest {
     ...
     */
    GPGeoserverAboutSystemStatusRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
     ...
     */
    @Override
    protected Class<GPGeoserverAboutSystemStatusMetricStore> forClass() {
        return GPGeoserverAboutSystemStatusMetricStore.class;
    }
}