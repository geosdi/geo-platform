 ...
 */
@ThreadSafe
class GPGeoserverLoadDimensionRequest extends GPJsonGetConnectorRequest<GPGeoserverTimeDimensionResponse, GeoserverLoadDimensionRequest> implements GeoserverLoadDimensionRequest {
     ...
     */
    protected GPGeoserverLoadDimensionRequest(@Nonnull(when = NEVER) GPServerConnector server,
     ...
     */
    @Override
    public GeoserverLoadDimensionRequest withLayerName(String theLayerName) {
    ...
    /**
     * @return {@link Class<GPGeoserverTimeDimensionResponse>}
     */
    @Override
    protected Class<GPGeoserverTimeDimensionResponse> forClass() {
        return GPGeoserverTimeDimensionResponse.class;
    }
}