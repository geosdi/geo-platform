...
import org.geosdi.geoplatform.connector.geoserver.request.layers.GeoserverDeleteLayerRequest;
 ...
 */
@ThreadSafe
public class GPGeoserverDeleteLayerRequest extends GPJsonDeleteConnectorRequest<Boolean, GeoserverDeleteLayerRequest> implements GeoserverDeleteLayerRequest {
     ...
     */
    GPGeoserverDeleteLayerRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
     ...
     */
    @Override
    public GeoserverDeleteLayerRequest withLayerName(String theWorkspaceName) {
     ...
     */
    @Override
    public GeoserverDeleteLayerRequest withRecurse(Boolean theRecurse) {
