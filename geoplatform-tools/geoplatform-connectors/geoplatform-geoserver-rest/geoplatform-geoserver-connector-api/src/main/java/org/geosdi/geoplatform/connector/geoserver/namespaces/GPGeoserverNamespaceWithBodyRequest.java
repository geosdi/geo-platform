...
class GPGeoserverNamespaceWithBodyRequest extends GPJsonPostConnectorRequest<IGPGeoserverCreateWorkspaceResponse, GeoserverNamespaceWithBodyRequest> implements GeoserverNamespaceWithBodyRequest {
     ...
     */
    GPGeoserverNamespaceWithBodyRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
        super(server, theJacksonSupport);
        this.namespaceBody = withInitial(() -> null);
    }
     ...
     */
    @Override
    public GeoserverNamespaceWithBodyRequest withBody(@Nonnull(when = NEVER) IGPGeoserverNamespaceBody theBody) {
        this.namespaceBody.set(theBody);
        return self();
    }
    ...
    protected HttpEntity prepareHttpEntity() throws Exception {
        IGPGeoserverNamespaceBody geoserverNamespaceBody = this.namespaceBody.get();
        checkArgument(geoserverNamespaceBody != null, "The Parameter geoserverNamespaceBody must not be null.");
        String geoserverStyleBodyString = jacksonSupport.getDefaultMapper().writeValueAsString(geoserverNamespaceBody);
        logger.debug("#############################NAME_SPACE_BODY : \n{}\n", geoserverStyleBodyString);
