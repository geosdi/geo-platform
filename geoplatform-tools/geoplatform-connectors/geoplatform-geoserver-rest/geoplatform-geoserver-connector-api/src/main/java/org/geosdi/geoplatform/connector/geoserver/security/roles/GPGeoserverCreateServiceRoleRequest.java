 ...
 */
@ThreadSafe
class GPGeoserverCreateServiceRoleRequest extends GPGeoserverBaseCreateRoleRequest<GeoserverCreateServiceRoleRequest> implements GeoserverCreateServiceRoleRequest {
    ...
    protected String createUriPath() throws Exception {
        ...
        return this.resolvePath("security", "roles", "service", service, "role", role);
    }
}