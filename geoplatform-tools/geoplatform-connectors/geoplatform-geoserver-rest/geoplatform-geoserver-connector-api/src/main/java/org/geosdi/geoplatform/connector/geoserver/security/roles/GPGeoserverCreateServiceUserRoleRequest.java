 ...
 */
@ThreadSafe
class GPGeoserverCreateServiceUserRoleRequest extends GPJsonPostConnectorRequest<Boolean, GeoserverCreateServiceUserRoleRequest> implements GeoserverCreateServiceUserRoleRequest {
     ...
     */
    GPGeoserverCreateServiceUserRoleRequest(@Nonnull(when = NEVER) GPServerConnector server,
     ...
     */
    @Override
    public GeoserverCreateServiceUserRoleRequest withRole(@Nonnull(when = NEVER) String theRole) {
     ...
     */
    @Override
    public GeoserverCreateServiceUserRoleRequest withService(@Nonnull(when = NEVER) String theService) {
     ...
     */
    @Override
    public GeoserverCreateServiceUserRoleRequest withUser(@Nonnull(when = NEVER) String theUser) {
