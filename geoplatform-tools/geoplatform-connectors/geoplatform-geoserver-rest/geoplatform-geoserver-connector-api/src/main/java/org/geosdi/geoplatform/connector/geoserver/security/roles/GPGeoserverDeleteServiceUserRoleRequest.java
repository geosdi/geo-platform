 ...
 */
@ThreadSafe
class GPGeoserverDeleteServiceUserRoleRequest extends GPJsonDeleteConnectorRequest<Boolean, GeoserverDeleteServiceUserRoleRequest> implements GeoserverDeleteServiceUserRoleRequest {
     ...
     */
    @Override
    public GeoserverDeleteServiceUserRoleRequest withRole(String theRole) {
     ...
     */
    @Override
    public GeoserverDeleteServiceUserRoleRequest withService(String theService) {
     ...
     */
    @Override
    public GeoserverDeleteServiceUserRoleRequest withUser(String theUser) {
