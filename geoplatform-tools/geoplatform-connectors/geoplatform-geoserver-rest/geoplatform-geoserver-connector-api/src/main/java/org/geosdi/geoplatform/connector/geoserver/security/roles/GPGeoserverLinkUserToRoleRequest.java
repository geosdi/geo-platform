 ...
 */
@ThreadSafe
class GPGeoserverLinkUserToRoleRequest extends GPJsonPostConnectorRequest<Boolean, GeoserverLinkUserToRoleRequest> implements GeoserverLinkUserToRoleRequest {
     ...
     */
    GPGeoserverLinkUserToRoleRequest(@Nonnull(when = NEVER) GPServerConnector server,
