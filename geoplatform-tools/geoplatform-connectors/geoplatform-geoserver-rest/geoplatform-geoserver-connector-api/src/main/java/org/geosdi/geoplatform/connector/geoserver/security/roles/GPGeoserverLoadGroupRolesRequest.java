...
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverLoadGroupRolesRequest;
 ...
 */
@ThreadSafe
class GPGeoserverLoadGroupRolesRequest extends GPJsonGetConnectorRequest<GPGeoserverRoles, GeoserverLoadGroupRolesRequest> implements GeoserverLoadGroupRolesRequest {
     ...
     */
    GPGeoserverLoadGroupRolesRequest(@Nonnull(when = NEVER) GPServerConnector server,
    ...
    protected String createUriPath() throws Exception {
        ...
        return ((baseURI.endsWith("/") ?
                baseURI.concat("security/roles/").concat("group/").concat(group).concat(".json") :
                baseURI.concat("/security/roles/").concat("group/").concat(group).concat(".json")));
    }
