...
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverLoadServiceUserRolesRequest;
 ...
 */
@ThreadSafe
class GPGeoserverLoadServiceUserRolesRequest extends GPJsonGetConnectorRequest<GPGeoserverRoles, GeoserverLoadServiceUserRolesRequest> implements GeoserverLoadServiceUserRolesRequest {
     ...
     */
    @Override
    public GeoserverLoadServiceUserRolesRequest withUser(@Nonnull(when = NEVER) String theUser) {
     ...
     */
    @Override
    public GeoserverLoadServiceUserRolesRequest withService(@Nonnull(when = NEVER) String theService) {
