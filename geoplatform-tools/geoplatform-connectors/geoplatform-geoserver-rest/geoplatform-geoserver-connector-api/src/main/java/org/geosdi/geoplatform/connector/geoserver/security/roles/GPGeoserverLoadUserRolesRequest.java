 ...
 */
@ThreadSafe
class GPGeoserverLoadUserRolesRequest extends GPJsonGetConnectorRequest<GPGeoserverRoles, GeoserverLoadUserRolesRequest> implements GeoserverLoadUserRolesRequest {
     ...
     */
    GPGeoserverLoadUserRolesRequest(@Nonnull(when = NEVER) GPServerConnector server,
    ...
    protected String createUriPath() throws Exception {
        ...
        return ((baseURI.endsWith("/") ?
                baseURI.concat("security/roles/").concat("user/").concat(user).concat(".json") :
                baseURI.concat("/security/roles/").concat("user/").concat(user).concat(".json")));
    }
