...
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverUnlinkGroupToRoleRequest;
 ...
 */
@ThreadSafe
class GPGeoserverUnlinkGroupToRoleRequest extends GPJsonDeleteConnectorRequest<Boolean, GeoserverUnlinkGroupToRoleRequest> implements GeoserverUnlinkGroupToRoleRequest {
     ...
     */
    GPGeoserverUnlinkGroupToRoleRequest(@Nonnull(when = NEVER) GPServerConnector server,
