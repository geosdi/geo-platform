...
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverLinkUserToRoleRequest;
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverLoadUserRolesRequest;
import org.geosdi.geoplatform.connector.geoserver.request.security.roles.GeoserverUnlinkUserToRoleRequest;
 ...
 */
@ThreadSafe
class GPGeoserverUnlinkUserToRoleRequest extends GPJsonDeleteConnectorRequest<Boolean, GeoserverUnlinkUserToRoleRequest> implements GeoserverUnlinkUserToRoleRequest {
     ...
     */
    GPGeoserverUnlinkUserToRoleRequest(@Nonnull(when = NEVER) GPServerConnector server,
     ...
     */
    @Override
    public GeoserverUnlinkUserToRoleRequest withRole(@Nonnull(when = NEVER) String theRole) {
     ...
     */
    @Override
    public GeoserverUnlinkUserToRoleRequest withUser(@Nonnull(when = NEVER) String theUser) {
    ...
    protected String createUriPath() throws Exception {
        ...
        return ((baseURI.endsWith("/") ?
                baseURI.concat("security/roles/role/").concat(role).concat("/user/").concat(user).concat(".json") :
                baseURI.concat("/security/roles/role/").concat(role).concat("/user/").concat(user).concat(".json")));
    }
