 ...
 */
public abstract class GPGeoserverBaseCreateRoleRequest<R extends GeoserverBaseRoleRequest> extends GPJsonPostConnectorRequest<Boolean, R> implements GeoserverBaseRoleRequest<R> {
     ...
     */
    protected GPGeoserverBaseCreateRoleRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector,
