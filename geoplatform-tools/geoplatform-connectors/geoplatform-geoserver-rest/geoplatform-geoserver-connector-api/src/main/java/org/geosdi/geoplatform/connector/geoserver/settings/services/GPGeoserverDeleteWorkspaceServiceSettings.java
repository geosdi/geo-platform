 ...
 */
public abstract class GPGeoserverDeleteWorkspaceServiceSettings<R extends GeoserverDeleteWorkspaceServiceSettings> extends GPJsonDeleteConnectorRequest<Boolean, R> implements GeoserverDeleteWorkspaceServiceSettings<R> {
     ...
     */
    protected GPGeoserverDeleteWorkspaceServiceSettings(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
