...
import org.geosdi.geoplatform.connector.geoserver.request.settings.services.GeoserverLoadWorkspaceServiceSettingsRequest;
 ...
 */
@ThreadSafe
public abstract class GPGeoserverLoadWorkspaceServiceSettingsRequest<T extends GeoserverWorkspaceServiceSettings, R extends GeoserverLoadWorkspaceServiceSettingsRequest> extends GPJsonGetConnectorRequest<T, R> implements GeoserverLoadWorkspaceServiceSettingsRequest<T, R> {
     ...
     */
    protected GPGeoserverLoadWorkspaceServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
     ...
     */
    @Override
    public R withWorkspace(@Nonnull(when = NEVER) String theWorkspaceName) {
