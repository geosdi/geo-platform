 ...
 */
public abstract class GPGeoserverUpdateWorkspaceServiceSettingsRequest<Body extends GeoserverWorkspaceServiceSettings, R extends GeoserverUpdateWorkspaceServiceSettingsRequest> extends GPGeoserverUpdateServiceSettingsRequest<Body, R> implements GeoserverUpdateWorkspaceServiceSettingsRequest<Body, R> {
     ...
     */
    protected GPGeoserverUpdateWorkspaceServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
