 ...
 */
@ThreadSafe
class GPGeoserverLoadWCSWorkspaceServiceSettingsRequest extends GPGeoserverLoadWorkspaceServiceSettingsRequest<GPGeoserverWCSWorkspaceServiceSettings, GeoserverLoadWCSWorkspaceServiceSettingsRequest> implements GeoserverLoadWCSWorkspaceServiceSettingsRequest {

    /**
     * @param server
     * @param theJacksonSupport
     */
    GPGeoserverLoadWCSWorkspaceServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
    ...
    /**
     * @return {@link Class<GPGeoserverWCSWorkspaceServiceSettings>}
     */
    @Override
    protected Class<GPGeoserverWCSWorkspaceServiceSettings> forClass() {
        return GPGeoserverWCSWorkspaceServiceSettings.class;
    }
}