 ...
 */
@ThreadSafe
class GPGeoserverLoadWFSWorkspaceServiceSettingsRequest extends GPGeoserverLoadWorkspaceServiceSettingsRequest<GPGeoserverWFSWorkspaceServiceSettings, GeoserverLoadWFSWorkspaceServiceSettingsRequest> implements GeoserverLoadWFSWorkspaceServiceSettingsRequest {

    /**
     * @param server
     * @param theJacksonSupport
     */
    GPGeoserverLoadWFSWorkspaceServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
        super(server, theJacksonSupport);
    }

    /**
     * @return {@link Class<GPGeoserverWFSWorkspaceServiceSettings>}
     */
    @Override
    protected Class<GPGeoserverWFSWorkspaceServiceSettings> forClass() {
        return GPGeoserverWFSWorkspaceServiceSettings.class;
    }
