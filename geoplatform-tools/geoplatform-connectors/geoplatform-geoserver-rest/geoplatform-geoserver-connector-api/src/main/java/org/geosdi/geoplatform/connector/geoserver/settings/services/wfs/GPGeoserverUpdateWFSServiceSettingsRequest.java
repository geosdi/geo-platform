...
import org.geosdi.geoplatform.connector.geoserver.request.settings.services.wfs.GeoserverUpdateWFSServiceSettingsRequest;
 ...
 */
@ThreadSafe
class GPGeoserverUpdateWFSServiceSettingsRequest extends GPGeoserverUpdateServiceSettingsRequest<GeoserverWFSServiceSettings, GeoserverUpdateWFSServiceSettingsRequest> implements GeoserverUpdateWFSServiceSettingsRequest {

    /**
     * @param theServerConnector
     * @param theJacksonSupport
     */
    GPGeoserverUpdateWFSServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
