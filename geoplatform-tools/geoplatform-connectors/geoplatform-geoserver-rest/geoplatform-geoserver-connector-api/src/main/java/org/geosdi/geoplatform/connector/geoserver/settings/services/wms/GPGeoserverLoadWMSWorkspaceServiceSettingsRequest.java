 ...
 */
@ThreadSafe
class GPGeoserverLoadWMSWorkspaceServiceSettingsRequest extends GPGeoserverLoadWorkspaceServiceSettingsRequest<GPGeoserverWMSWorkspaceServiceSettings, GeoserverLoadWMSWorkspaceServiceSettingsRequest> implements GeoserverLoadWMSWorkspaceServiceSettingsRequest {

    /**
     * @param server
     * @param theJacksonSupport
     */
    GPGeoserverLoadWMSWorkspaceServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
        super(server, theJacksonSupport);
    }

    /**
     * @return {@link Class<GPGeoserverWMSWorkspaceServiceSettings>}
     */
    @Override
    protected Class<GPGeoserverWMSWorkspaceServiceSettings> forClass() {
        return GPGeoserverWMSWorkspaceServiceSettings.class;
    }
