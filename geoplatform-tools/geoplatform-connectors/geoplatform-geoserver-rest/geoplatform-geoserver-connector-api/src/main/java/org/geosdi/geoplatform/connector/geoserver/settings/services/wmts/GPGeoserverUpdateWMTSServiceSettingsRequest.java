...
import org.geosdi.geoplatform.connector.geoserver.request.settings.services.wmts.GeoserverUpdateWMTSServiceSettingsRequest;
 ...
 */
@ThreadSafe
class GPGeoserverUpdateWMTSServiceSettingsRequest extends GPGeoserverUpdateServiceSettingsRequest<GeoserverWMTSServiceSettings, GeoserverUpdateWMTSServiceSettingsRequest> implements GeoserverUpdateWMTSServiceSettingsRequest {

    /**
     * @param theServerConnector
     * @param theJacksonSupport
     */
    GPGeoserverUpdateWMTSServiceSettingsRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
