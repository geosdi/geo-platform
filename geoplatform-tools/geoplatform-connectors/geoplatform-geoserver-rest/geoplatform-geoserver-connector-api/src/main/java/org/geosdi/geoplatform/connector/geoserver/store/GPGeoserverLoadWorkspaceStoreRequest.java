 ...
 */
package org.geosdi.geoplatform.connector.geoserver.store;
 ...
 */
public abstract class GPGeoserverLoadWorkspaceStoreRequest<T extends GPGeoserverServiceStore, R extends GeoserverLoadWorkspaceStoreRequest<T, R>> extends GPGeoserverExsistRequest<T, R> implements GeoserverLoadWorkspaceStoreRequest<T, R> {
     ...
     */
    protected GPGeoserverLoadWorkspaceStoreRequest(@Nonnull(when = NEVER) GPServerConnector server,
