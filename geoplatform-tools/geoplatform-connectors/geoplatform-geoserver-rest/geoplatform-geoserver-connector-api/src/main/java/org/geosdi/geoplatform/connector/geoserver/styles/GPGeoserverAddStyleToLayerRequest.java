...
import org.geosdi.geoplatform.connector.geoserver.request.styles.GeoserverAddStyleToLayerRequest;
 ...
 */
@ThreadSafe
class GPGeoserverAddStyleToLayerRequest extends GPGeoserverBaseCreateStyleRequest<IGPGeoserverStyleBody, GeoserverAddStyleToLayerRequest> implements GeoserverAddStyleToLayerRequest {
     ...
     */
    GPGeoserverAddStyleToLayerRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
     ...
     */
    @Override
    public GeoserverAddStyleToLayerRequest withLayer(@Nonnull(when = NEVER) String theLayer) {
        this.layer.set(theLayer);
        return self();
    }
