...
class GPGeoserverWorkspaceStyleRequest extends GPJsonGetConnectorRequest<GPGeoserverSingleStyle, GeoserverWorkspaceStyleRequest> implements GeoserverWorkspaceStyleRequest {
     ...
     */
    GPGeoserverWorkspaceStyleRequest(@Nonnull(when = NEVER) GPServerConnector server, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
    ...
    protected String createUriPath() throws Exception {
        ...
        return this.resolvePath("workspaces", workspaceName, "styles", styleName, "styles.json");
    }
