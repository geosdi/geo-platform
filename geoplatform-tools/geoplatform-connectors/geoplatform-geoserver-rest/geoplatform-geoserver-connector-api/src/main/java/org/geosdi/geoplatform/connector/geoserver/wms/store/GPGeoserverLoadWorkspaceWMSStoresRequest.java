...
class GPGeoserverLoadWorkspaceWMSStoresRequest extends GPGeoserverGetConnectorRequest<GeoserverWMSStores, GPGeoserverWMSEmptyStores, GeoserverLoadWorkspaceWMSStoresRequest> implements GeoserverLoadWorkspaceWMSStoresRequest {
     ...
     */
    @Override
    public GeoserverLoadWorkspaceWMSStoresRequest withWorkspace(@Nonnull(when = NEVER) String theWorkspace) {
    ...
    protected String createUriPath() throws Exception {
        ...
        return ((baseURI.endsWith("/") ? baseURI.concat("workspaces/").concat(workspace).concat("/wmsstores.json") : baseURI.concat("/workspaces/").concat(workspace).concat("/wmsstores.json")));
    }
