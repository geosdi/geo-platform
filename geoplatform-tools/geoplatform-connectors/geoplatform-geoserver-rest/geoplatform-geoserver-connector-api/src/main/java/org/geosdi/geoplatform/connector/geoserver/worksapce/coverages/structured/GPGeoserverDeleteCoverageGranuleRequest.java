 ...
 */
@ThreadSafe
class GPGeoserverDeleteCoverageGranuleRequest extends GPGeoserverBaseDeleteStructuredCoverageRequest<GeoserverDeleteCoverageGranuleRequest> implements GeoserverDeleteCoverageGranuleRequest {
     ...
     */
    GPGeoserverDeleteCoverageGranuleRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
     ...
     */
    @Override
    public GeoserverDeleteCoverageGranuleRequest withGranuleID(@Nonnull(when = NEVER) String theGranuleID) {
