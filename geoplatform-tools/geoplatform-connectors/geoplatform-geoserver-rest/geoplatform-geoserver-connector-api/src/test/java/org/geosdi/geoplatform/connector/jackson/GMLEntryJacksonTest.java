...
import static org.geosdi.geoplatform.connector.geoserver.model.settings.service.wfs.gml.GMLVersion.V_10;
...
public class GMLEntryJacksonTest {

    private static final Logger logger = LoggerFactory.getLogger(GMLEntryJacksonTest.class);

    @Test
    public void a_marshallGMLEntryAsXmlStringTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@GML_ENTRY : \n{}\n", JACKSON_JAXB_XML_SUPPORT.writeAsString(GMLEntryJacksonTest::toGMLEntry));
    }

    @Test
    public void b_unmarshallGMLEntryFromXmlStringTest() throws Exception {
        logger.info("#####################GML_ENTRY : {}\n", JACKSON_JAXB_XML_SUPPORT.getDefaultMapper()
                .readValue(new StringReader("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
                        ...
                        + "    </gml>\n"
                        + "</entry>"), GMLEntry.class));
    }

    @Test
    public void c_marshallGMLEntryAsJsonStringTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@GML_ENTRY \n{}\n", jacksonSupport.writeAsString(GMLEntryJacksonTest::toGMLEntry));
    }

    @Test
    public void d_unmarshallGMLEntryFromJsonStringTest() throws Exception {
    ...
    /**
     * @return {@link GMLEntry}
     */
    public static GMLEntry toGMLEntry() {
