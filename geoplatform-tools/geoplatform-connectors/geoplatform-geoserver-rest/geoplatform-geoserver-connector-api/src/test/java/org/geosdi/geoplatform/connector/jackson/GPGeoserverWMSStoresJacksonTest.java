...
public class GPGeoserverWMSStoresJacksonTest {

    private static final Logger logger = LoggerFactory.getLogger(GPGeoserverWMSStoresJacksonTest.class);

    @Test
    public void a_unmarshallGPGeoserverWMStoresTest() throws Exception {
