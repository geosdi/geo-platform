...
public abstract class GPGeoserverCoverageStoresConnector extends GPGeoserverDatastoresConnector implements IGPGeoserverCoverageStoresConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverCoverageStoresConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
