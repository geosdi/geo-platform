...
public abstract class GPGeoserverDatastoresConnector extends GPGeoserverWMSStoreConnector implements IGPGeoserverDatastoresConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverDatastoresConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
