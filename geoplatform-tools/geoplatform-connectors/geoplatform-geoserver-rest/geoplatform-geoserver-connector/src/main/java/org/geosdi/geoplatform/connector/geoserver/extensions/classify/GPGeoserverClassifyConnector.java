 ...
 */
public abstract class GPGeoserverClassifyConnector extends GPGeoserverRasterizeConnector implements IGPGeoserverClassifyConnector {
     ...
     * @param version
     */
    public GPGeoserverClassifyConnector(String urlServer, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    public GPGeoserverClassifyConnector(String urlServer, GPSecurityConnector securityConnector,
     ...
     * @param version
     */
    public GPGeoserverClassifyConnector(String urlServer, GPPooledConnectorConfig pooledConnectorConfig,
     ...
     * @param theVersion
     */
    public GPGeoserverClassifyConnector(URL server, GPSecurityConnector securityConnector,
     ...
     * @param theVersion
     */
    public GPGeoserverClassifyConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig,
     ...
     * @param theVersion
     */
    protected GPGeoserverClassifyConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
