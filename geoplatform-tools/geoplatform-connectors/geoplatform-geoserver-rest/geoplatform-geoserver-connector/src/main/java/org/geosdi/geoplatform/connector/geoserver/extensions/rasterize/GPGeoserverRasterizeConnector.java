...
public abstract class GPGeoserverRasterizeConnector extends GPGeoserverUniqueValuesConnector implements IGPGeoserverRasterizeConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverRasterizeConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
