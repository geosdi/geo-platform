...
public abstract class GPGeoserverUniqueValuesConnector extends GPGeoserverLayerGroupsConnector implements IGPGeoserverUniqueValuesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverUniqueValuesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
