...
public abstract class GPGeoserverFeatureTypesConnector extends GPGeoserverCoverageStoresConnector implements IGPGeoserverFeatureTypesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverFeatureTypesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
