...
public abstract class GPGeoserverLayerGroupsConnector extends GPGeoserverSettingsConnector implements IGPGeoserverLayerGroupsConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverLayerGroupsConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
