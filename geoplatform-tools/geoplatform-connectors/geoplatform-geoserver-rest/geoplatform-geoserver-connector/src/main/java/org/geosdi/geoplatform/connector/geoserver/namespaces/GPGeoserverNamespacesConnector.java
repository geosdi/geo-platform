...
public abstract class GPGeoserverNamespacesConnector extends GPGeoserverCoveragesConnector implements IGPGeoserverNamespacesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverNamespacesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
