...
import org.geosdi.geoplatform.connector.geoserver.security.groups.GPGeoserverGroupsConnector;
 ...
 */
public abstract class GPGeoserverCatalogConnector extends GPGeoserverGroupsConnector implements IGPGeoserverCatalogConnector {
     ...
     * @param version
     */
    protected GPGeoserverCatalogConnector(String urlServer, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPGeoserverCatalogConnector(String urlServer, GPSecurityConnector securityConnector,
     ...
     * @param version
     */
    protected GPGeoserverCatalogConnector(String urlServer, GPPooledConnectorConfig pooledConnectorConfig,
     ...
     * @param theVersion
     */
    protected GPGeoserverCatalogConnector(URL server, GPSecurityConnector securityConnector,
     ...
     * @param theVersion
     */
    protected GPGeoserverCatalogConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig,
     ...
     * @param theVersion
     */
    protected GPGeoserverCatalogConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
