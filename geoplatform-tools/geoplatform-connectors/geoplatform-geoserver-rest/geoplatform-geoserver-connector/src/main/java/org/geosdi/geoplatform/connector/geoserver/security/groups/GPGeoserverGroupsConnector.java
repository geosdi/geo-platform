...
public abstract class GPGeoserverGroupsConnector extends GPGeoserverUsersConnector implements IGPGeoserverGroupsConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverGroupsConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
