...
public abstract class GPGeoserverServicesConnector extends GPGeoserverFeatureTypesConnector implements IGPGeoserverServicesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverServicesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
