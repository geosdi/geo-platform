...
public abstract class GPGeoserverUsersConnector extends GPGeoserverServicesConnector implements IGPGeoserverUsersConnector {
     ...
     * @param version
     */
    protected GPGeoserverUsersConnector(String urlServer, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPGeoserverUsersConnector(String urlServer, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPGeoserverUsersConnector(String urlServer, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param theVersion
     */
    protected GPGeoserverUsersConnector(URL server, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPGeoserverUsersConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPGeoserverUsersConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
