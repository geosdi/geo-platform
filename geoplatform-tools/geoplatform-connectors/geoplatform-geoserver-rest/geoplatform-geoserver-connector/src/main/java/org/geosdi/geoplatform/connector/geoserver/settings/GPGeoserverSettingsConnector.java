...
public abstract class GPGeoserverSettingsConnector extends GPGeoserverWMSServiceSettingsConnector implements IGPGeoserverSettingsConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverSettingsConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
