 ...
 */
public abstract class GPGeoserverWMSServiceSettingsConnector extends GPGeoserverWFSServiceSettingsConnector implements IGPGeoserverWMSServiceSettingsConnector{
     ...
     * @param version
     */
    protected GPGeoserverWMSServiceSettingsConnector(String urlServer, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPGeoserverWMSServiceSettingsConnector(String urlServer, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPGeoserverWMSServiceSettingsConnector(String urlServer, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param theVersion
     */
    protected GPGeoserverWMSServiceSettingsConnector(URL server, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPGeoserverWMSServiceSettingsConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPGeoserverWMSServiceSettingsConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
