...
public abstract class GPGeoserverStylesConnector extends GPGeoserverLayersConnector implements IGPGeoserverStylesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverStylesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
