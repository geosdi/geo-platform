...
public abstract class GPGeoserverWMSStoreConnector extends GPGeoserverWMTSStoreConnector implements IGPGeoserverWMSStoreConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverWMSStoreConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
