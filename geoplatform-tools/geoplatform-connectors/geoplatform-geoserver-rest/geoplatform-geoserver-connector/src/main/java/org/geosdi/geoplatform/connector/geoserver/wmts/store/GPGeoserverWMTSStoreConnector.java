...
public abstract class GPGeoserverWMTSStoreConnector extends GPGeoserverStylesConnector implements IGPGeoserverWMTSStoreConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverWMTSStoreConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
