...
public abstract class GPGeoserverWorkspacesConnector extends GPGeoserverAboutConnector implements IGPGeoserverWorkspacesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverWorkspacesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
