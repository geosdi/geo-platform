...
public abstract class GPGeoserverCoveragesConnector extends GPStructuredCoverageConnector implements IGPGeoserverCoveragesConnector {
     ...
     * @param theVersion
     */
    protected GPGeoserverCoveragesConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
