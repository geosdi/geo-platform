...
import org.geosdi.geoplatform.connector.geoserver.request.workspaces.coverages.structured.*;
 ...
 */
public abstract class GPStructuredCoverageConnector extends GPGeoserverWorkspacesConnector implements IGPStructuredCoverageConnector {
     ...
     * @param version
     */
    protected GPStructuredCoverageConnector(String urlServer, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPStructuredCoverageConnector(String urlServer, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param version
     */
    protected GPStructuredCoverageConnector(String urlServer, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, String version) {
     ...
     * @param theVersion
     */
    protected GPStructuredCoverageConnector(URL server, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPStructuredCoverageConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
     ...
     * @param theVersion
     */
    protected GPStructuredCoverageConnector(URL server, GPPooledConnectorConfig pooledConnectorConfig, GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, DefaultClientTlsStrategy defaultClientTlsStrategy, JacksonSupport theJacksonSupport, GeoserverVersion theVersion) {
    ...
    /**
     * @return {@link GeoserverLoadStructuredCoverageSchemaRequest}
     */
    @Override
    ...
    /**
     * @return {@link GeoserverDeleteCoverageGranuleRequest}
     */
    @Override
