...
import org.geosdi.geoplatform.connector.store.fonts.GeoserverFontsStore;
...
public abstract class GeoserverLoggingStore extends GeoserverFontsStore implements GPGeoserverLoggingStore{
     ...
     * @param theServer
     */
    protected GeoserverLoggingStore(GPGeoserverConnector theServer) {
        super(theServer);
    }
    ...
    public GeoserverLoadLoggingRequest loadLoggingRequest() {
        return this.server.loadLoggingRequest();
    }
    ...
    public GeoserverUpdateLoggingRequest updateLoggingRequest() {
        return this.server.updateLoggingRequest();
    }
}