 ...
 */
package org.geosdi.geoplatform.connector.store.security.catalog;
...
import org.geosdi.geoplatform.connector.store.security.groups.GeoserverGroupsConnectorStore;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public abstract class GeoserverCatalogConnectorStore extends GeoserverGroupsConnectorStore implements GPGeoserverCatalogConnectorStore {

    /**
     * @param theServer
     */
    protected GeoserverCatalogConnectorStore(GPGeoserverConnector theServer) {
        super(theServer);
    }
