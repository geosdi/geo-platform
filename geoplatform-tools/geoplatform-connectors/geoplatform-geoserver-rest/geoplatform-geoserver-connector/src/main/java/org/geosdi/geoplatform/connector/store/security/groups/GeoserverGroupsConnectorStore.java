 ...
 */
package org.geosdi.geoplatform.connector.store.security.groups;
...
import org.geosdi.geoplatform.connector.store.security.users.GeoserverUsersConnectorStore;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public abstract class GeoserverGroupsConnectorStore extends GeoserverUsersConnectorStore implements GPGeoserverGroupsConnectorStore {

    /**
     * @param theServer
     */
    protected GeoserverGroupsConnectorStore(GPGeoserverConnector theServer) {
        super(theServer);
    }
    ...
    public GeoserverLoadGroupsRequest loadGroupsRequest() {
        return this.server.loadGroupsRequest();
    }
    ...
    public GeoserverCreateGroupRequest createGroupRequest() {
        return this.server.createGroupRequest();
    }
    ...
    public GeoserverDeleteGroupRequest deleteGroupRequest() {
        return this.server.deleteGroupRequest();
    }
}