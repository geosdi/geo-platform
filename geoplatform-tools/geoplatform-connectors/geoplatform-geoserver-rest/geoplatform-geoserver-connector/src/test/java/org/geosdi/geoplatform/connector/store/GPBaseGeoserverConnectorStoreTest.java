...
public abstract class GPBaseGeoserverConnectorStoreTest {
    ...
    //
    private static final String geoserverURLV3_0_x = "http://150.145.141.92/geoserver/rest";
    protected static GPGeoserverConnectorStore geoserverConnectorStoreV3_0_x;
    ...
    public static void beforeClass() throws Exception {
        geoserverConnectorStoreV3_0_x = geoserverConnectorBuilder()
                .withServerUrl(new URI(geoserverURLV3_0_x).toURL())
    ...
    public static void afterClass() throws Exception {
        geoserverConnectorStoreV3_0_x.dispose();
    }
}