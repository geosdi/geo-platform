 ...
 */
public abstract class GPBaseGeoserverConnectorStoreV223xTest {

    protected static final Logger logger = LoggerFactory.getLogger(GPBaseGeoserverConnectorStoreV223xTest.class);
    //
    private static final String geoserverURLV2_23_X = "http://150.145.141.180/geoserver/rest";
    protected static GPGeoserverConnectorStore geoserverConnectorStoreV2_23_x;
    ...
    public static void beforeClass() throws Exception {
        geoserverConnectorStoreV2_23_x = geoserverConnectorBuilder()
                .withServerUrl(new URL(geoserverURLV2_23_X))
    ...
    public static void afterClass() throws Exception {
        geoserverConnectorStoreV2_23_x.dispose();
    }
}