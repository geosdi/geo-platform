...
public class GPGeoserverConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_aboutVersionGeoserverConnectorTest() throws Exception {
        GeoserverAboutVersionRequest aboutRequest = geoserverConnectorStoreV2_22_x.createAboutVersionRequest();
    ...
    public void b_aboutStatusGeoserverConnectorTest() throws Exception {
        GeoserverAboutStatusRequest aboutStatusRequest = geoserverConnectorStoreV2_22_x.createAboutStatusRequest();
    ...
    public void c_workspacesGeoserverConnectorTest() throws Exception {
        GeoserverLoadWorkspacesRequest workspacesRequest = geoserverConnectorStoreV2_22_x.loadWorkspacesRequest();
    ...
    public void d_namespacesGeoserverConnectorTest() throws Exception {
        GeoserverNamespacesRequest namespacesRequest = geoserverConnectorStoreV2_22_x.createNamespacesRequest();
    ...
    public void e_namespaceGeoserverConnectorTest() throws Exception {
        GeoserverNamespaceRequest namespaceRequest = geoserverConnectorStoreV2_22_x.createNamespaceRequest();
    ...
    public void g_layersGeoserverConnectorTest() throws Exception {
        GeoserverLayersRequest layersRequest = geoserverConnectorStoreV2_22_x.loadLayersRequest();
    ...
    public void h_stylesGeoserverConnectorTest() throws Exception {
        GeoserverStylesRequest stylesRequest = geoserverConnectorStoreV2_22_x.loadStylesRequest();
    ...
    public void i_styleGeoserverConnectorTest() throws Exception {
        GeoserverStyleRequest styleRequest = geoserverConnectorStoreV2_22_x.loadStyleRequest();
    ...
    public void m_layerVectorGeoserverConnectorTest() throws Exception {
        GeoserverLoadLayerRequest layerRequest = geoserverConnectorStoreV2_22_x.loadLayerRequest();
    ...
    public void p_createWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverCreateWorkspaceRequest createWorkspaceRequest = geoserverConnectorStoreV2_22_x.createWorkspaceRequest();
    ...
    public void q_loadWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverLoadWorkspaceRequest loadWorkspaceRequest = geoserverConnectorStoreV2_22_x.loadWorkspaceRequest();
    ...
    public void r_updateWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverUpdateWorkspaceRequest updateWorkspaceRequest = geoserverConnectorStoreV2_22_x.updateWorkspaceRequest();
    ...
    public void s_deleteWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverDeleteWorkspaceRequest deleteWorkspaceRequest = geoserverConnectorStoreV2_22_x.deleteWorkspaceRequest();
    ...
    public void t_aboutManifestGeoserverConnectorTest() throws Exception {
        GeoserverAboutManifestRequest aboutManifestRequest = geoserverConnectorStoreV2_22_x.createAboutManifestRequest();
    ...
    public void u_aboutSystemStatusGeoserverConnectorTest() throws Exception {
        GeoserverAboutSystemStatusRequest aboutSystemStatusRequest = geoserverConnectorStoreV2_22_x.createAboutSystemStatusRequest();
