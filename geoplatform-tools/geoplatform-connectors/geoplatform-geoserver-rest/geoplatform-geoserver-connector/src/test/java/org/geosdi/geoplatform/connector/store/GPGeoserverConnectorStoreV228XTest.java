...
public class GPGeoserverConnectorStoreV228XTest extends GPBaseGeoserverConnectorStoreV228xTest {

    @Test
    public void a_aboutVersionGeoserverConnectorTest() throws Exception {
        GeoserverAboutVersionRequest aboutRequest = geoserverConnectorStoreV2_28_x.createAboutVersionRequest();
    ...
    public void b_aboutStatusGeoserverConnectorTest() throws Exception {
        GeoserverAboutStatusRequest aboutStatusRequest = geoserverConnectorStoreV2_28_x.createAboutStatusRequest();
    ...
    public void c_workspacesGeoserverConnectorTest() throws Exception {
        GeoserverLoadWorkspacesRequest workspacesRequest = geoserverConnectorStoreV2_28_x.loadWorkspacesRequest();
    ...
    public void d_namespacesGeoserverConnectorTest() throws Exception {
        GeoserverNamespacesRequest namespacesRequest = geoserverConnectorStoreV2_28_x.createNamespacesRequest();
    ...
    public void e_namespaceGeoserverConnectorTest() throws Exception {
        GeoserverNamespaceRequest namespaceRequest = geoserverConnectorStoreV2_28_x.createNamespaceRequest();
    ...
    public void g_layersGeoserverConnectorTest() throws Exception {
        GeoserverLayersRequest layersRequest = geoserverConnectorStoreV2_28_x.loadLayersRequest();
    ...
    public void h_stylesGeoserverConnectorTest() throws Exception {
        GeoserverStylesRequest stylesRequest = geoserverConnectorStoreV2_28_x.loadStylesRequest();
    ...
    public void i_styleGeoserverConnectorTest() throws Exception {
        GeoserverStyleRequest styleRequest = geoserverConnectorStoreV2_28_x.loadStyleRequest();
    ...
    public void m_layerVectorGeoserverConnectorTest() throws Exception {
        GeoserverLoadLayerRequest layerRequest = geoserverConnectorStoreV2_28_x.loadLayerRequest();
    ...
    public void o_layerGeoserverConnectorMultiThreadTest() throws Exception {
        ...
        fromIterable(layersRequest.getResponse().getLayers())
                .filter(Objects::nonNull)
                .subscribe(value -> ofVirtual().name("GP_GEOSERVER_CONNECTOR_V226X_" + counter.getAndIncrement()).start(new GeoserverLayerTask(layerRequest, value.getLayerName())), Throwable::printStackTrace);
        sleep(1000);
    }
    ...
    public void q_loadWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverLoadWorkspaceRequest loadWorkspaceRequest = geoserverConnectorStoreV2_28_x.loadWorkspaceRequest();
    ...
    public void r_updateWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverUpdateWorkspaceRequest updateWorkspaceRequest = geoserverConnectorStoreV2_28_x.updateWorkspaceRequest();
    ...
    public void s_deleteWorkspaceGeoserverConnectorTest() throws Exception {
        GeoserverDeleteWorkspaceRequest deleteWorkspaceRequest = geoserverConnectorStoreV2_28_x.deleteWorkspaceRequest();
    ...
    public void t_reloadGeoserverCatalogTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@GEOSERVER_RELOAD_CATALOG_RESPONSE : {}\n", geoserverConnectorStoreV2_28_x.reloadCatalog());
    }

    @Test
    public void u_aboutSystemStatusGeoserverConnectorTest() throws Exception {
        GeoserverAboutSystemStatusRequest aboutSystemStatusRequest = geoserverConnectorStoreV2_28_x.createAboutSystemStatusRequest();
