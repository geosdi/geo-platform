...
public class GPGeoserverCoveragesConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadWorkspaceCoveragesTest() throws Exception {
        GeoserverLoadCoveragesRequest loadCoveragesRequest = geoserverConnectorStoreV2_26_x.loadWorkspaceCoveragesRequest();
    ...
    public void c_loadCoverageTest() throws Exception {
        GeoserverLoadCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_26_x.loadWorkspaceCoverageRequest();
    ...
    public void d_loadWorkspaceStoreCoverageTest() throws Exception {
        GeoserverLoadStoreCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_26_x.loadWorkspaceStoreCoverageRequest();
    ...
    public void e_resetCoverageCacheTest() throws Exception {
        GeoserverResetCoverageCacheRequest resetCoverageCacheRequest = geoserverConnectorStoreV2_26_x.resetCoverageCacheRequest();
