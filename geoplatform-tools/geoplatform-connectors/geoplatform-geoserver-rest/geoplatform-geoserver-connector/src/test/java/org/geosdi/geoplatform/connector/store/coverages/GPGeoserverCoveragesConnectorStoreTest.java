...
public class GPGeoserverCoveragesConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadWorkspaceCoveragesTest() throws Exception {
        GeoserverLoadCoveragesRequest loadCoveragesRequest = geoserverConnectorStoreV3_0_x.loadWorkspaceCoveragesRequest();
    ...
    public void c_loadCoverageTest() throws Exception {
        GeoserverLoadCoverageRequest loadCoverageRequest = geoserverConnectorStoreV3_0_x.loadWorkspaceCoverageRequest();
    ...
    public void d_loadWorkspaceStoreCoverageTest() throws Exception {
        GeoserverLoadStoreCoverageRequest loadCoverageRequest = geoserverConnectorStoreV3_0_x.loadWorkspaceStoreCoverageRequest();
    ...
    public void e_resetCoverageCacheTest() throws Exception {
        GeoserverResetCoverageCacheRequest resetCoverageCacheRequest = geoserverConnectorStoreV3_0_x.resetCoverageCacheRequest();
