...
public class GPGeoserverCoveragesConnectorStoreV220XTest extends GPBaseGeoserverConnectorStoreV220xTest {

    @Test
    public void a_loadWorkspaceCoveragesTest() throws Exception {
        GeoserverLoadCoveragesRequest loadCoveragesRequest = geoserverConnectorStoreV2_20_x.loadWorkspaceCoveragesRequest();
    ...
    public void c_loadCoverageTest() throws Exception {
        GeoserverLoadCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_20_x.loadWorkspaceCoverageRequest();
    ...
    public void d_loadWorkspaceStoreCoverageTest() throws Exception {
        GPGeoserverLoadStoreCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_20_x.loadWorkspaceStoreCoverageRequest();
