...
public class GPGeoserverCoveragesConnectorStoreV221XTest extends GPBaseGeoserverConnectorStoreV221xTest {

    @Test
    public void a_loadWorkspaceCoveragesTest() throws Exception {
        GeoserverLoadCoveragesRequest loadCoveragesRequest = geoserverConnectorStoreV2_21_x.loadWorkspaceCoveragesRequest();
    ...
    public void c_loadCoverageTest() throws Exception {
        GeoserverLoadCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_21_x.loadWorkspaceCoverageRequest();
