...
public class GPGeoserverCoveragesConnectorStoreV223XTest extends GPBaseGeoserverConnectorStoreV223xTest {

    @Test
    public void a_loadWorkspaceCoveragesTest() throws Exception {
        GeoserverLoadCoveragesRequest loadCoveragesRequest = geoserverConnectorStoreV2_23_x.loadWorkspaceCoveragesRequest();
    ...
    public void c_loadCoverageTest() throws Exception {
        GeoserverLoadCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_23_x.loadWorkspaceCoverageRequest();
    ...
    public void d_loadWorkspaceStoreCoverageTest() throws Exception {
        GeoserverLoadStoreCoverageRequest loadCoverageRequest = geoserverConnectorStoreV2_23_x.loadWorkspaceStoreCoverageRequest();
    ...
    public void e_resetCoverageCacheTest() throws Exception {
        GeoserverResetCoverageCacheRequest resetCoverageCacheRequest = geoserverConnectorStoreV2_23_x.resetCoverageCacheRequest();
