...
public class GPGeoserverCoverageStoresConnectorStoreV227XTest extends GPBaseGeoserverConnectorStoreV227xTest {

    @Test
    public void a_loadCoverageStoresConnectorTest() throws Exception {
        GeoserverLoadCoverageStoresRequest loadCoverageStoresRequest = geoserverConnectorStoreV2_26_x.loadCoverageStoresRequest();
    ...
    public void c_loadArcGridSampleCoverageStoreConnectorTest() throws Exception {
        GeoserverLoadCoverageStoreRequest loadCoverageStoreRequest = geoserverConnectorStoreV2_26_x.loadCoverageStoreRequest();
