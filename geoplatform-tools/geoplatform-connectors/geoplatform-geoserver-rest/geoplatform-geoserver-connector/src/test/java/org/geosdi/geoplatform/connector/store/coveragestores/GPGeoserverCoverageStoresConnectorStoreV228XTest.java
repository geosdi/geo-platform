...
public class GPGeoserverCoverageStoresConnectorStoreV228XTest extends GPBaseGeoserverConnectorStoreV228xTest {

    @Test
    public void a_loadCoverageStoresConnectorTest() throws Exception {
        GeoserverLoadCoverageStoresRequest loadCoverageStoresRequest = geoserverConnectorStoreV2_28_x.loadCoverageStoresRequest();
    ...
    public void c_loadArcGridSampleCoverageStoreConnectorTest() throws Exception {
        GeoserverLoadCoverageStoreRequest loadCoverageStoreRequest = geoserverConnectorStoreV2_28_x.loadCoverageStoreRequest();
