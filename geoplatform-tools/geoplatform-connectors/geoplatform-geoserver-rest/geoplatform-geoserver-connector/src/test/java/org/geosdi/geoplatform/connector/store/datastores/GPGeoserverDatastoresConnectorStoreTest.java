...
public class GPGeoserverDatastoresConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadGeoserverDatastoresConnectorTest() throws Exception {
        GeoserverLoadDatastoresRequest loadDatastoresRequest = geoserverConnectorStoreV3_0_x.loadDatastoresRequest();
    ...
    public void b_loadGeoserverDatastoreConnectorTest() throws Exception {
        GeoserverLoadDatastoreRequest loadDatastoreRequest = geoserverConnectorStoreV3_0_x.loadDatastoreRequest();
    ...
    public void c_loadAllGeoserverDatastoresConnectorTest() throws Exception {
        GeoserverLoadWorkspacesRequest loadWorkspacesRequest = geoserverConnectorStoreV3_0_x.loadWorkspacesRequest();
    ...
    public void d_createGeoserverDatastoreConnectorTest() throws Exception {
        ...
        GeoserverCreateDatastoreRequest createDatastoreRequest = geoserverConnectorStoreV3_0_x.createDatastoreRequest();
        ...
        logger.info("####################CREATE_DATASTORE_RESPONSE : \n{}\n", createDatastoreRequest
                .withDatastoreBody(postgisDatastoreBodyBuilder().withName("datastore_test_1")
                        ...
                        .withPassword("0x,postgres,0x")
                        .build()).getResponse());
        assertTrue(geoserverConnectorStoreV3_0_x.deleteDatastoreRequest().withWorkspaceName("workspace_test_5").withDatastoreName("datastore_test").getResponse());
        assertTrue(geoserverConnectorStoreV3_0_x.deleteDatastoreRequest().withWorkspaceName("workspace_test_5").withDatastoreName("datastore_test_1").getResponse());
        assertTrue(geoserverConnectorStoreV3_0_x.deleteWorkspaceRequest().withWorkspaceName("workspace_test_5").getResponse());
    }
    ...
    public void e_updateGeoserverDatastoreConnectorTest() throws Exception {
        ...
        logger.info("####################CREATE_DATASTORE_RESPONSE : \n{}\n", createDatastoreRequest.getResponse());
        GeoserverUpdateDatastoreRequest updateDatastoreRequest = geoserverConnectorStoreV3_0_x.updateDatastoreRequest();
        ...
        assertTrue(geoserverConnectorStoreV3_0_x.deleteWorkspaceRequest().withWorkspaceName("workspace_test_6").withRecurse(TRUE).getResponse());
    }
}