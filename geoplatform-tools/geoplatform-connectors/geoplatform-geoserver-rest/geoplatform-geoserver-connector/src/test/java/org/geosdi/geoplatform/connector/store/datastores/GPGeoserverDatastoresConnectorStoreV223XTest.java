...
public class GPGeoserverDatastoresConnectorStoreV223XTest extends GPBaseGeoserverConnectorStoreV223xTest {

    @Test
    public void a_loadGeoserverDatastoresConnectorTest() throws Exception {
        GeoserverLoadDatastoresRequest loadDatastoresRequest = geoserverConnectorStoreV2_23_x.loadDatastoresRequest();
    ...
    public void b_loadGeoserverDatastoreConnectorTest() throws Exception {
        GeoserverLoadDatastoreRequest loadDatastoreRequest = geoserverConnectorStoreV2_23_x.loadDatastoreRequest();
    ...
    public void c_loadAllGeoserverDatastoresConnectorTest() throws Exception {
        GeoserverLoadWorkspacesRequest loadWorkspacesRequest = geoserverConnectorStoreV2_23_x.loadWorkspacesRequest();
    ...
    public void d_createGeoserverDatastoreConnectorTest() throws Exception {
        ...
        GeoserverCreateDatastoreRequest createDatastoreRequest = geoserverConnectorStoreV2_23_x.createDatastoreRequest();
        ...
        logger.info("####################CREATE_DATASTORE_RESPONSE : \n{}\n", createDatastoreRequest
                .withDatastoreBody(postgisDatastoreBodyBuilder().withName("datastore_test_1")
                        ...
                        .withPassword("0x,postgres,0x")
                        .build()).getResponse());
        assertTrue(geoserverConnectorStoreV2_23_x.deleteDatastoreRequest().withWorkspaceName("workspace_test_5").withDatastoreName("datastore_test").getResponse());
        assertTrue(geoserverConnectorStoreV2_23_x.deleteDatastoreRequest().withWorkspaceName("workspace_test_5").withDatastoreName("datastore_test_1").getResponse());
        assertTrue(geoserverConnectorStoreV2_23_x.deleteWorkspaceRequest().withWorkspaceName("workspace_test_5").getResponse());
    }
    ...
    public void e_updateGeoserverDatastoreConnectorTest() throws Exception {
        ...
        logger.info("####################CREATE_DATASTORE_RESPONSE : \n{}\n", createDatastoreRequest.getResponse());
        GeoserverUpdateDatastoreRequest updateDatastoreRequest = geoserverConnectorStoreV2_23_x.updateDatastoreRequest();
        ...
        assertTrue(geoserverConnectorStoreV2_23_x.deleteWorkspaceRequest().withWorkspaceName("workspace_test_6").withRecurse(TRUE).getResponse());
    }
}