 ...
 */
public class GPGoeserverClassifyConnectorV220XStoreTest extends GPBaseGeoserverConnectorStoreV228xTest {

    @Test
    public void classifyTest() throws Exception {
        GeoserverClassifyRequest request = geoserverConnectorStoreV2_28_x.classifyData();
