...
public class GPGeoserverLayerGroupsConnectorStoreV223XTest extends GPBaseGeoserverConnectorStoreV223xTest {

    @Test
    public void a_loadGeoserverLoadLayerGroupsRequestTest() throws Exception {
        GeoserverLoadLayerGroupsRequest loadLayerGroupRequest = geoserverConnectorStoreV2_23_x.loadLayerGroups();
    ...
    public void b_loadGeoserverLayerGroupRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@LOAD_LAYER_GROUP_RESPONSE : {}\n",
                geoserverConnectorStoreV2_23_x.loadLayerGroupRequest().withLayerGroupName("spearfish").getResponse());
    }

    @Test
    public void c_loadGeoserverLayerGroupRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@LOAD_LAYER_GROUP_RESPONSE : {}\n",
                geoserverConnectorStoreV2_23_x.loadLayerGroupRequest().withLayerGroupName("LAYER_GROUP_TEST")
                        .getResponse());
    }
    ...
    public void d_loadWorkspaceGeoserverLayerGroupsRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@LOAD_WORKSPACE_LAYER_GROUP_RESPONSE : {}\n",
                geoserverConnectorStoreV2_23_x.loadWorkspaceLayerGroupsRequest().withWorkspace("sf").getResponse());
    }

    @Test
    public void e_createGeoserverLayerGroupRequestTest() throws Exception {
        logger.info("###################{}\n", geoserverConnectorStoreV2_23_x.createLayerGroupRequest()
    ...
    public void d_deleteGeoserverLayerGroupRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@DELETE_LAYER_GROUP_RESPONSE : {}\n", geoserverConnectorStoreV2_23_x.deleteLayerGroupRequest()
    ...
    public void e_createGeoserverWorkspaeLayerGroupRequestTest() throws Exception {
        logger.info("###################{}\n", geoserverConnectorStoreV2_23_x.createWorkspaceLayerGroupRequest()
                .withWorkspace("tiger")
    ...
    public void f_loadGeoserverWorkspaceLayerGroupRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@LOAD_WORKSPACE_LAYER_GROUP_RESPONSE : {}\n", geoserverConnectorStoreV2_23_x.loadWorkspaceLayerGroupsRequest()
                .withWorkspace("tiger")
                .getResponse());
    }
    ...
    public void g_deleteGeoserverWorkspaceLayerGroupRequestTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@DELETE_LAYER_GROUP_RESPONSE : {}\n", geoserverConnectorStoreV2_23_x.deleteWorkspaceLayerGroupRequest()
                .withWorkspace("tiger")
