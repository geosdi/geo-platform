...
public class GeoserverConnectorRolesTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void f_createRole() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createRole().withRole("test_role").getResponse());
    }
    ...
    public void g_linkUserToRole() throws Exception {
        ...
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createUserRequest().withBody(createUser).getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.linkUserToRole().withRole("test_role").withUser("vsalvia")
                        .getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.unlinkUserToRole().withRole("test_role").withUser("vsalvia")
                        .getResponse());
    }
    ...
    public void h_linkGroupToRole() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createGroupRequest().withGropuName("test_group").getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.linkGroupToRole().withRole("test_role").withGroup("test_group")
                        .getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.unlinkGroupToRole().withRole("test_role").withGroup("test_group")
                        .getResponse());
    }
    ...
    public void i_createServiceRoleTest() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createServiceRole().withService("default").withRole("test_role2")
                        .getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteServiceRole().withService("default").withRole("test_role2")
                        .getResponse());
    }
    ...
    public void l_createServiceUserRoleTest() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createServiceUserRole().withService("default").withRole("test_role")
                        .withUser("vsalvia").getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteServiceUserRole().withService("default").withRole("test_role")
    ...
    public void m_createServiceGroupRoleTest() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.createServiceGroupRole().withService("default")
                        .withRole("test_role").withGroup("test_group").getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteServiceGroupRole().withService("default")
    ...
    public void z_deleteAll() throws Exception {
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteRole().withRole("test_role").getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteUserRequest().withUser("vsalvia").getResponse());
        logger.info("################### {}\n",
                this.geoserverConnectorStoreV2_19_x.deleteGroupRequest().withGropuName("test_group").getResponse());
    }
