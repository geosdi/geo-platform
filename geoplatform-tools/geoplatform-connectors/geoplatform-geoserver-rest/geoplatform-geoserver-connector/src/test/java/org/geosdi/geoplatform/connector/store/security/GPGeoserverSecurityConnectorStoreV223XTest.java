...
public class GPGeoserverSecurityConnectorStoreV223XTest extends GPBaseGeoserverConnectorStoreV223xTest {

    @Test
    public void a_loadGeoserverMasterPasswordTest() throws Exception {
        GeoserverGetMasterPasswordRequest geoserverGetMasterPasswordRequest = geoserverConnectorStoreV2_23_x.loadMasterPasswordRequest();
    ...
    public void b_loadGeoserverCatalogRequestTest() throws Exception {
        GeoserverGetCatalogRequest geoserverGetCatalogRequest = geoserverConnectorStoreV2_23_x.loadCatalogRequest();
    ...
    public void c_updateGeoserverCatalogRequestTest() throws Exception {
        GeoserverUpdateCatalogRequest updateCatalogRequest = geoserverConnectorStoreV2_23_x.updateCatalogRequest();
    ...
    public void d_loadGeoserverUsersRequest() throws Exception {
        logger.info("#####################GP_GEOSERVER_USERS_RESPONSE : {}\n", geoserverConnectorStoreV2_23_x.loadUsersRequest().getResponse());
    }
    ...
    public void e_createGeoserverUserRequestTest() throws Exception {
        ...
        logger.info("@@@@@@@@@@@@@@@@@@@@@GP_GEOSERVER_CREATE_USER_RESPONSE : {}\n", geoserverConnectorStoreV2_23_x.createUserRequest()
    ...
    public void m_loadGeoserverLayerRulesRequestTest() throws Exception {
        logger.info("####################GP_GEOSERVER_LOAD_LAYER_RULES_RESPONSE : {}\n",
                geoserverConnectorStoreV2_23_x.loadAclLayers().getResponse());
    }
}