...
public class GPGeoserverSecurityConnectorStoreV22XTest extends GPBaseGeoserverConnectorStoreV22xTest {
    ...
    public void a_loadGeoserverMasterPasswordTest() throws Exception {
        GeoserverGetMasterPasswordRequest geoserverGetMasterPasswordRequest = geoserverConnectorStoreV2_20_x.loadMasterPasswordRequest();
    ...
    public void b_loadGeoserverCatalogRequestTest() throws Exception {
        GeoserverGetCatalogRequest geoserverGetCatalogRequest = geoserverConnectorStoreV2_20_x.loadCatalogRequest();
    ...
    public void c_updateGeoserverCatalogRequestTest() throws Exception {
        GeoserverUpdateCatalogRequest updateCatalogRequest = geoserverConnectorStoreV2_20_x.updateCatalogRequest();
