...
public class GPGeoserverSettingsConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadGeoserverGlobalSettingsRequestTest() throws Exception {
        GeoserverLoadGlobalSettingsRequest loadGlobalSettingsRequest = geoserverConnectorStoreV3_0_x.loadGeoserverGlobalSettingRequest();
    ...
    public void b_updateGeoserverGlobalSettingsRequestTest() throws Exception {
        ...
        GeoserverUpdateGlobalSettingsRequest updateGlobalSettingsRequest = geoserverConnectorStoreV3_0_x.updateGlobalSettingsRequest();
    ...
    public void d_loadGeoserverContactSettingsRequestTest() throws Exception {
        GeoserverLoadContactSettingsRequest contactSettingsRequest = geoserverConnectorStoreV3_0_x.loadGeoserverContactSettingsRequest();
