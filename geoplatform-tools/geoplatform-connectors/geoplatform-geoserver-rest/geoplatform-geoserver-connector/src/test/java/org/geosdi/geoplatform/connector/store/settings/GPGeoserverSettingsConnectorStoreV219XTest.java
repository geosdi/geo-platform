...
public class GPGeoserverSettingsConnectorStoreV219XTest extends GPBaseGeoserverConnectorStoreV219xTest {
    ...
    public void a_loadGeoserverGlobalSettingsRequestTest() throws Exception {
        GeoserverLoadGlobalSettingsRequest loadGlobalSettingsRequest = geoserverConnectorStoreV2_19_x.loadGeoserverGlobalSettingRequest();
    ...
    public void d_loadGeoserverContactSettingsRequestTest() throws Exception {
        GeoserverLoadContactSettingsRequest contactSettingsRequest = geoserverConnectorStoreV2_19_x.loadGeoserverContactSettingsRequest();
