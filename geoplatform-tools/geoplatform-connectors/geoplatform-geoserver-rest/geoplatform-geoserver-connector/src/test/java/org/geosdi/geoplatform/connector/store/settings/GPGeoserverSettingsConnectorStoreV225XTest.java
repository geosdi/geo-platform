...
public class GPGeoserverSettingsConnectorStoreV225XTest extends GPBaseGeoserverConnectorStoreV225xTest {

    @Test
    public void a_loadGeoserverGlobalSettingsRequestTest() throws Exception {
        GeoserverLoadGlobalSettingsRequest loadGlobalSettingsRequest = geoserverConnectorStoreV2_25_x.loadGeoserverGlobalSettingRequest();
    ...
    public void b_updateGeoserverGlobalSettingsRequestTest() throws Exception {
        ...
        GeoserverUpdateGlobalSettingsRequest updateGlobalSettingsRequest = geoserverConnectorStoreV2_25_x.updateGlobalSettingsRequest();
    ...
    public void d_loadGeoserverContactSettingsRequestTest() throws Exception {
        GeoserverLoadContactSettingsRequest contactSettingsRequest = geoserverConnectorStoreV2_25_x.loadGeoserverContactSettingsRequest();
