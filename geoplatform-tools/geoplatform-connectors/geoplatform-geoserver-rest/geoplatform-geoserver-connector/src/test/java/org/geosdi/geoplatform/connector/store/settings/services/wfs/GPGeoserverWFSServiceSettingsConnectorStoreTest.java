...
public class GPGeoserverWFSServiceSettingsConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadWFSServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWFSServiceSettingsRequest wfsServiceSettingsRequest = geoserverConnectorStoreV2_28_x.loadWFSServiceSettingsRequest();
    ...
    public void b_loadWFSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWFSWorkspaceServiceSettingsRequest wfsWorkspaceServiceSettingsRequest = geoserverConnectorStoreV2_28_x.loadWFSWorkspaceServiceSettingsRequest();
    ...
    public void c_updateWFSServiceSettingsRequestTest() throws Exception {
        GeoserverUpdateWFSServiceSettingsRequest updateWFSServiceSettingsRequest = geoserverConnectorStoreV2_28_x.updateWFSServiceSettingsRequest();
        ...
        GPGeoserverWFSServiceSettings retrieveWFSSettings = geoserverConnectorStoreV2_28_x.loadWFSServiceSettingsRequest().getResponse();
    ...
    public void d_updateWFSServiceSettingsRequestTest() throws Exception {
        ...
        logger.info("###################WFS_UPDATE_SERVICE_SETTINGS_RESPONSE : {}\n", geoserverConnectorStoreV2_28_x.updateWFSServiceSettingsRequest()
    ...
    public void e_updateWFSWorkspaceServiceSettingsRequestTest() throws Exception {
        try (InputStream wfsWorkspaceServiceSettingsStream = currentThread().getContextClassLoader().getResourceAsStream("WFSWorkspaceServiceSettings.xml")) {
            ...
            GeoserverUpdateWFSWorkspaceServiceSettingsRequest updateWFSWorkspaceSettingsRequest = geoserverConnectorStoreV2_28_x.updateWFSWorkspaceServiceSettingsRequest();
    ...
    public void g_deleteWFSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverDeleteWFSWorkspaceServiceSettingsRequest deleteWFSWorkspaceServiceSettingRequest = geoserverConnectorStoreV2_28_x.deleteWFSWorkspaceServiceSettingsRequest();
