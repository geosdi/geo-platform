...
public class GPGeoserverWMSServiceSettingsConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadWMSServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMSServiceSettingsRequest wmsServiceSettingsRequest = geoserverConnectorStoreV2_22_x.loadWMSServiceSettingRequest();
    ...
    public void b_loadWMSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMSWorkspaceServiceSettingsRequest wmsWorkspaceServiceSettingsRequest = geoserverConnectorStoreV2_22_x.loadWMSWorkspaceServiceSettingsRequest();
    ...
    public void c_updateWMSServiceSettingsRequestTest() throws Exception {
        GeoserverUpdateWMSServiceSettingsRequest updateWMSServiceSettingsRequest = geoserverConnectorStoreV2_22_x.updateWMSServiceSettingsRequest();
        ...
        GPGeoserverWMSServiceSettings retrieveWMSSettings = geoserverConnectorStoreV2_22_x.loadWMSServiceSettingRequest().getResponse();
    ...
    public void d_updateWMSServiceSettingsRequestTest() throws Exception {
        ...
        logger.info("###################WMS_UPDATE_SERVICE_SETTINGS_RESPONSE : {}\n", geoserverConnectorStoreV2_22_x.updateWMSServiceSettingsRequest()
    ...
    public void e_updateWMSWorkspaceServiceSettingsRequestTest() throws Exception {
        try (InputStream wmsWorkspaceServiceSettingsStream = currentThread().getContextClassLoader().getResourceAsStream("WMSWorkspaceServiceSettings.xml")) {
            ...
            GeoserverUpdateWMSWorkspaceSettingsRequest updateWMSWorkspaceSettingsRequest = geoserverConnectorStoreV2_22_x.updateWMSWorkspaceServiceSettingsRequest();
    ...
    public void g_deleteWMSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverDeleteWMSWorkspaceServiceSettingRequest deleteWMSWorkspaceServiceSettingRequest = geoserverConnectorStoreV2_22_x.deleteWMSWorkspaceServiceSettingsRequest();
