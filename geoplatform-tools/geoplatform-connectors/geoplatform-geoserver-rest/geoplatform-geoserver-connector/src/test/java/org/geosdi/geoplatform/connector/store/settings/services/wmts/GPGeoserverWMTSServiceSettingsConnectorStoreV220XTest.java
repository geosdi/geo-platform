...
public class GPGeoserverWMTSServiceSettingsConnectorStoreV220XTest extends GPBaseGeoserverConnectorStoreV220xTest {
    ...
    public void c_updateWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverUpdateWMTSServiceSettingsRequest updateWMTSServiceSettingsRequest = geoserverConnectorStoreV2_20_x.updateWMTSServiceSettingsRequest();
        ...
        GPGeoserverWMTSServiceSettings retrieveWMTSSettings = geoserverConnectorStoreV2_20_x.loadWMTSServiceSettingsRequest().getResponse();
    ...
    public void d_updateWMTSServiceSettingsRequestTest() throws Exception {
        ...
        logger.info("###################WMTS_UPDATE_SERVICE_SETTINGS_RESPONSE : {}\n", geoserverConnectorStoreV2_20_x.updateWMTSServiceSettingsRequest()
    ...
    public void e_updateWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        try (InputStream wmtsWorkspaceServiceSettingsStream = currentThread().getContextClassLoader().getResourceAsStream("WMTSWorkspaceServiceSettings.xml")) {
            ...
            GeoserverUpdateWMTSWorkspaceServiceSettingsRequest updateWMTSWorkspaceSettingsRequest = geoserverConnectorStoreV2_20_x.updateWMTSWorkspaceServiceSettingsRequest();
    ...
    public void g_deleteWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverDeleteWMTSWorkspaceServiceSettingsRequest deleteWMTSWorkspaceServiceSettingRequest = geoserverConnectorStoreV2_20_x.deleteWMTSWorkspaceServiceSettingsRequest();
