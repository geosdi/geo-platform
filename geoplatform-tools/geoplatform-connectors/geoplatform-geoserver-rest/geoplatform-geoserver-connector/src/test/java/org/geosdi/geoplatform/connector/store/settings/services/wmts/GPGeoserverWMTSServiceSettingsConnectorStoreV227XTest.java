...
public class GPGeoserverWMTSServiceSettingsConnectorStoreV227XTest extends GPBaseGeoserverConnectorStoreV227xTest {

    @Test
    public void a_loadWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMTSServiceSettingsRequest wmtsServiceSettingsRequest = geoserverConnectorStoreV2_27_x.loadWMTSServiceSettingsRequest();
    ...
    public void b_loadWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMTSWorkspaceServiceSettingsRequest wmtsWorkspaceServiceSettingsRequest = geoserverConnectorStoreV2_27_x.loadWMTSWorkspaceServiceSettingsRequest();
    ...
    public void c_updateWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverUpdateWMTSServiceSettingsRequest updateWMTSServiceSettingsRequest = geoserverConnectorStoreV2_27_x.updateWMTSServiceSettingsRequest();
        ...
        GPGeoserverWMTSServiceSettings retrieveWMTSSettings = geoserverConnectorStoreV2_27_x.loadWMTSServiceSettingsRequest().getResponse();
    ...
    public void d_updateWMTSServiceSettingsRequestTest() throws Exception {
        ...
        logger.info("###################WMTS_UPDATE_SERVICE_SETTINGS_RESPONSE : {}\n", geoserverConnectorStoreV2_27_x.updateWMTSServiceSettingsRequest()
    ...
    public void e_updateWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        try (InputStream wmtsWorkspaceServiceSettingsStream = currentThread().getContextClassLoader().getResourceAsStream("WMTSWorkspaceServiceSettings.xml")) {
            ...
            GeoserverUpdateWMTSWorkspaceServiceSettingsRequest updateWMTSWorkspaceSettingsRequest = geoserverConnectorStoreV2_27_x.updateWMTSWorkspaceServiceSettingsRequest();
    ...
    public void g_deleteWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverDeleteWMTSWorkspaceServiceSettingsRequest deleteWMTSWorkspaceServiceSettingRequest = geoserverConnectorStoreV2_27_x.deleteWMTSWorkspaceServiceSettingsRequest();
