...
public class GPGeoserverWMTSServiceSettingsConnectorStoreV228XTest extends GPBaseGeoserverConnectorStoreV228xTest {

    @Test
    public void a_loadWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMTSServiceSettingsRequest wmtsServiceSettingsRequest = geoserverConnectorStoreV2_28_x.loadWMTSServiceSettingsRequest();
    ...
    public void b_loadWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverLoadWMTSWorkspaceServiceSettingsRequest wmtsWorkspaceServiceSettingsRequest = geoserverConnectorStoreV2_28_x.loadWMTSWorkspaceServiceSettingsRequest();
    ...
    public void c_updateWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverUpdateWMTSServiceSettingsRequest updateWMTSServiceSettingsRequest = geoserverConnectorStoreV2_28_x.updateWMTSServiceSettingsRequest();
        ...
        GPGeoserverWMTSServiceSettings retrieveWMTSSettings = geoserverConnectorStoreV2_28_x.loadWMTSServiceSettingsRequest().getResponse();
    ...
    public void d_updateWMTSServiceSettingsRequestTest() throws Exception {
        GeoserverWMTSServiceSettings wmtsServiceSettings = JACKSON_JAXB_XML_SUPPORT.getDefaultMapper()
                .readValue(new File(of(new File(".").getCanonicalPath(), "src", "test", "resources", "WMTSServiceSettings")
                        .collect(joining(separator, "", ".xml"))), GPGeoserverWMTSServiceSettings.class);
        logger.info("###################WMTS_UPDATE_SERVICE_SETTINGS_RESPONSE : {}\n", geoserverConnectorStoreV2_28_x.updateWMTSServiceSettingsRequest()
    ...
    public void e_updateWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        try (InputStream wmtsWorkspaceServiceSettingsStream = currentThread().getContextClassLoader().getResourceAsStream("WMTSWorkspaceServiceSettings.xml")) {
            ...
            GeoserverUpdateWMTSWorkspaceServiceSettingsRequest updateWMTSWorkspaceSettingsRequest = geoserverConnectorStoreV2_28_x.updateWMTSWorkspaceServiceSettingsRequest();
    ...
    public void g_deleteWMTSWorkspaceServiceSettingsRequestTest() throws Exception {
        GeoserverDeleteWMTSWorkspaceServiceSettingsRequest deleteWMTSWorkspaceServiceSettingRequest = geoserverConnectorStoreV2_28_x.deleteWMTSWorkspaceServiceSettingsRequest();
