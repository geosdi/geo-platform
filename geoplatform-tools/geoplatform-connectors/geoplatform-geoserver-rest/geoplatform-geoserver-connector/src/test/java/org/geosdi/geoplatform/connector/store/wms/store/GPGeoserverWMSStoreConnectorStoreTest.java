...
public class GPGeoserverWMSStoreConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadGeoserverWMSStoresRequestTest() throws Exception {
        GPGeoserverWMSStores wmsStores = geoserverConnectorStoreV3_0_x.loadWorkspaceWMSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void b_createGeoserverWMSStoreRequestTest() throws Exception {
        GeoserverCreateWMSStoreRequest request = geoserverConnectorStoreV3_0_x.createWMSStoreRequest()
                .withWorkspace("sf")
    ...
    public void d_loadGeoserverWMSStoreRequestTest() throws Exception {
        GPGeoserverWMSStore wmsStore = geoserverConnectorStoreV3_0_x.loadWorkspaceWMSStoreRequest()
                .withWorkspace("sf")
    ...
    public void e_updateGeoserverWMSStoreRequestTest() throws Exception {
        ...
        logger.info("{}\n", geoserverConnectorStoreV3_0_x.updateWMSStoreRequest()
                .withWorkspace("sf")
                .withStore("remote")
