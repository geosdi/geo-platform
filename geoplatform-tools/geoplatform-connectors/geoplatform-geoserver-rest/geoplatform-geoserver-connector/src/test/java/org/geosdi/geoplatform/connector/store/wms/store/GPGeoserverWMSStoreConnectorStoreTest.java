...
public class GPGeoserverWMSStoreConnectorStoreTest extends GPBaseGeoserverConnectorStoreV220xTest {

    @Test
    public void a_loadGeoserverWMSStoresRequestTest() throws Exception {
        GeoserverWMSStores wmsStores = geoserverConnectorStoreV2_20_x.loadWorkspaceWMSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
