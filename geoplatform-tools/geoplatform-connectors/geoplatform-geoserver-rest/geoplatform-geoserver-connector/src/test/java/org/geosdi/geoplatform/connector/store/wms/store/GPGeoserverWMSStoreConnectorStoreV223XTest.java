...
public class GPGeoserverWMSStoreConnectorStoreV223XTest extends GPBaseGeoserverConnectorStoreV223xTest {

    @Test
    public void a_loadGeoserverWMSStoresRequestTest() throws Exception {
        GPGeoserverWMSStores wmsStores = geoserverConnectorStoreV2_23_x.loadWorkspaceWMSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void b_createGeoserverWMSStoreRequestTest() throws Exception {
        GeoserverCreateWMSStoreRequest request = geoserverConnectorStoreV2_23_x.createWMSStoreRequest()
                .withWorkspace("sf")
    ...
    public void d_loadGeoserverWMSStoreRequestTest() throws Exception {
        GPGeoserverWMSStore wmsStore = geoserverConnectorStoreV2_23_x.loadWorkspaceWMSStoreRequest()
                .withWorkspace("sf")
    ...
    public void e_updateGeoserverWMSStoreRequestTest() throws Exception {
        ...
        logger.info("{}\n", geoserverConnectorStoreV2_23_x.updateWMSStoreRequest()
                .withWorkspace("sf")
                .withStore("remote")
