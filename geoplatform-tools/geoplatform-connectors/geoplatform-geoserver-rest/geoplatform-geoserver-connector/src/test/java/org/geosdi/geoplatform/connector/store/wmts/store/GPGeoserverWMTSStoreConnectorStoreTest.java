...
public class GPGeoserverWMTSStoreConnectorStoreTest extends GPBaseGeoserverConnectorStoreTest {
    ...
    public void a_loadGeoserverWMTSStoresRequestTest() throws Exception {
        GPGeoserverWMTSStores wmtsStores = geoserverConnectorStoreV3_0_x.loadWorkspaceWMTSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void b_createGeoserverWMTSStoreRequestTest() throws Exception {
        GeoserverCreateWMTSStoreRequest request = geoserverConnectorStoreV3_0_x.createWMTSStoreRequest()
                .withWorkspace("sf")
    ...
    public void c_loadGeoserverWMTSStoresRequestTest() throws Exception {
        GPGeoserverWMTSStores wmsStores = geoserverConnectorStoreV3_0_x.loadWorkspaceWMTSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void d_loadGeoserverWMTSStoreRequestTest() throws Exception {
        GPGeoserverWMTSStore wmtsStore = geoserverConnectorStoreV3_0_x.loadWorkspaceWMTSStoreRequest()
                .withWorkspace("sf")
    ...
    public void e_updateGeoserverWMTSStoreRequestTest() throws Exception {
        ...
        logger.info("{}\n", geoserverConnectorStoreV3_0_x.updateWMTSStoreRequest()
                .withWorkspace("sf")
