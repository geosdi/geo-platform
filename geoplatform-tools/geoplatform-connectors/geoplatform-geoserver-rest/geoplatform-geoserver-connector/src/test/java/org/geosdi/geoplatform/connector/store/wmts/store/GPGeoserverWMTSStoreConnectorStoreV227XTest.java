...
public class GPGeoserverWMTSStoreConnectorStoreV227XTest extends GPBaseGeoserverConnectorStoreV227xTest {
    ...
    public void a_loadGeoserverWMTSStoresRequestTest() throws Exception {
        GPGeoserverWMTSStores wmtsStores = geoserverConnectorStoreV2_27_x.loadWorkspaceWMTSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void b_createGeoserverWMTSStoreRequestTest() throws Exception {
        GeoserverCreateWMTSStoreRequest request = geoserverConnectorStoreV2_27_x.createWMTSStoreRequest()
                .withWorkspace("sf")
    ...
    public void c_loadGeoserverWMTSStoresRequestTest() throws Exception {
        GPGeoserverWMTSStores wmsStores = geoserverConnectorStoreV2_27_x.loadWorkspaceWMTSStoresRequest()
                .withWorkspace("sf")
                .getResponse();
    ...
    public void d_loadGeoserverWMTSStoreRequestTest() throws Exception {
        GPGeoserverWMTSStore wmtsStore = geoserverConnectorStoreV2_27_x.loadWorkspaceWMTSStoreRequest()
                .withWorkspace("sf")
    ...
    public void e_updateGeoserverWMTSStoreRequestTest() throws Exception {
        ...
        logger.info("{}\n", geoserverConnectorStoreV2_27_x.updateWMTSStoreRequest()
                .withWorkspace("sf")
