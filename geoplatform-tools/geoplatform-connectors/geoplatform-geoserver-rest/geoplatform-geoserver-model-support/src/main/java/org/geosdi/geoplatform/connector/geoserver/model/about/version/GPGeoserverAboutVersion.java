...
@Setter
@ToString
@JsonSerialize(using = GPGeoserverAboutVersionSerializer.class)
@JsonDeserialize(using = GPGeoserverAboutVersionDeserializer.class)
...
public class GPGeoserverAboutVersion implements IGPGeoserverAboutVersion {
    ...
    //
    @XmlElements(value = {@XmlElement(name = "resource", type = GPGeoserverVersionResource.class)})
