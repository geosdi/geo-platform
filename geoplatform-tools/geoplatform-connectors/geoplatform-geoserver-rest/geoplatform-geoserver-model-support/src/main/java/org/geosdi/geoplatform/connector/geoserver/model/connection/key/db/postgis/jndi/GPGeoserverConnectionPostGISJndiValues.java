...
public enum GPGeoserverConnectionPostGISJndiValues implements IGPGeoserverConnectionKey {
     ...
     * @param theKey
     */
    GPGeoserverConnectionPostGISJndiValues(@Nonnull(when = When.NEVER) IGPGeoserverConnectionKey theKey) {
    ...
    public static List<IGPGeoserverConnectionKey> requiredValues() {
        return Stream.of(JNDI_REFERENCE_MAME, GPGeoserverConnectionPostGISValues.DBTYPE)
                .collect(toList());
    }
    ...
    public static List<IGPGeoserverConnectionKey> defaultValues() {
        return Stream.of(GPGeoserverConnectionPostGISValues.DBTYPE, GPGeoserverConnectionPostGISValues.SCHEMA, FETCH_SIZE, BATCH_INSERT_SIZE, EXPOSE_PRIMARY_KEYS,
                GPGeoserverConnectionPostGISValues.LOOSE_BBOX, GPGeoserverConnectionPostGISValues.ESTIMATED_EXTENDS, GPGeoserverConnectionPostGISValues.PREPARED_STATEMENTS, GPGeoserverConnectionPostGISValues.ENCODE_FUNCTIONS, GPGeoserverConnectionPostGISValues.SUPPORT_ON_THE_FLY_GEOMETRY_SEMPLIFICATION)
                .collect(toList());
    }
}