...
public interface GPGeoserverCreateDatastoreBodyBuilder<Builder extends GPGeoserverCreateDatastoreBodyBuilder<?>> extends Serializable {
     ...
     * @return {@link Builder}
     */
    Builder withName(@Nonnull(when = When.NEVER) String theName);
    ...
    abstract class GPCreateDatastoreBodyBuilder<Builder extends GPGeoserverCreateDatastoreBodyBuilder<?>> implements GPGeoserverCreateDatastoreBodyBuilder<Builder> {
         ...
         * @param theType
         */
        protected GPCreateDatastoreBodyBuilder(@Nonnull(when = When.NEVER) GeoserverDatastoreType theType) {
         ...
         */
        @Override
        public Builder withName(@Nonnull(when = When.NEVER) String theName) {
            this.name = theName;
            return self();
        }
        ...
        public final IGPGeoserverCreateDatastoreBody build() throws Exception {
            Preconditions.checkArgument((this.name != null) && !(this.name.trim().isEmpty()), "The Parameter name must not be null or an empty string.");
