...
public interface IGPGeopackageDatastoreBodyBuilder extends GPGeoserverDatastoreBodyDatabaseBuilder<IGPGeopackageDatastoreBodyBuilder> {
     ...
     */
    IGPGeopackageDatastoreBodyBuilder withDatabase(@Nonnull(when = When.NEVER) File theDatabase);
    ...
    class GPGeopackageDatastoreBodyBuilder extends GeoserverDatastoreBodyDatabaseBuilder<IGPGeopackageDatastoreBodyBuilder> implements IGPGeopackageDatastoreBodyBuilder {
         ...
         */
        @Override
        public IGPGeopackageDatastoreBodyBuilder withDatabase(@Nonnull(when = When.NEVER) File theDatabase) {
            this.connectionParameters.compute(GPGeoserverConnectionGeoPackageValues.DATABASE.getConnectionKey(), (k, v) -> (theDatabase != null) ? theDatabase.getPath() : v);
            return self();
        }
        ...
        public IGPGeopackageDatastoreBodyBuilder withUser(@Nullable String theUser) {
            this.connectionParameters.compute(GPGeoserverConnectionGeoPackageValues.USER.getConnectionKey(), (k, v) -> ((theUser != null) && !(theUser.trim().isEmpty())) ? theUser : v);
            return self();
        }
