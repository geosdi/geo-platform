    ...
    class GPPostgisDatastoreBodyBuilder extends GeoserverDatastoreBodyDatabaseBuilder<IGPPostgisDatastoreBodyBuilder> implements IGPPostgisDatastoreBodyBuilder {
        ...
        public IGPPostgisDatastoreBodyBuilder withSupportOnTheFlyGeometrySemplification(@Nullable Boolean theSupportOnTheFlyGeometrySemplification) {
            this.connectionParameters.compute(
                    GPGeoserverConnectionPostGISValues.SUPPORT_ON_THE_FLY_GEOMETRY_SEMPLIFICATION.getConnectionKey(), (k, v) -> (theSupportOnTheFlyGeometrySemplification != null) ? theSupportOnTheFlyGeometrySemplification.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withCreateDatabase(@Nullable Boolean theCreateDatabase) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.CREATE_DATABASE.getConnectionKey(), (k, v) -> (theCreateDatabase != null) ? theCreateDatabase.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withCreateDatabaseParams(@Nullable String theCreateDatabaseParams) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.CREATE_DATABASE_PARAMS.getConnectionKey(), (k, v) -> ((theCreateDatabaseParams != null) && !(theCreateDatabaseParams.trim().isEmpty())) ? theCreateDatabaseParams : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withMaxOpenPreparedStatements(@Nullable Integer theMaxOpenPreparedStatements) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.MAX_OPEN_PREPARED_STATEMENTS.getConnectionKey(), (k, v) -> ((theMaxOpenPreparedStatements != null) && (theMaxOpenPreparedStatements > 0)) ? theMaxOpenPreparedStatements.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withEncodeFunctions(@Nullable Boolean theEncodeFunctions) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.ENCODE_FUNCTIONS.getConnectionKey(), (k, v) -> (theEncodeFunctions != null) ? theEncodeFunctions.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withLooseBbox(@Nullable Boolean theLooseBbox) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.LOOSE_BBOX.getConnectionKey(), (k, v) -> (theLooseBbox != null) ? theLooseBbox.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withEstimatedExtends(@Nullable Boolean theEstimatedExtends) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.ESTIMATED_EXTENDS.getConnectionKey(), (k, v) -> (theEstimatedExtends != null) ? theEstimatedExtends.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withDatabase(@Nullable String theDatabase) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.DATABASE.getConnectionKey(), (k, v) -> ((theDatabase != null) && !(theDatabase.trim().isEmpty())) ? theDatabase : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withTestWhileIdle(@Nullable Boolean theTestWhileIdle) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.TEST_WHILE_IDLE.getConnectionKey(), (k, v) -> (theTestWhileIdle != null) ? theTestWhileIdle.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withPreparedStatements(@Nullable Boolean thePreparedStatements) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.PREPARED_STATEMENTS.getConnectionKey(), (k, v) -> (thePreparedStatements != null) ? thePreparedStatements.toString() : v);
            return self();
        }
        ...
        public IGPPostgisDatastoreBodyBuilder withSchema(@Nullable String theSchema) {
            this.connectionParameters.compute(GPGeoserverConnectionPostGISValues.SCHEMA.getConnectionKey(), (k, v) -> ((theSchema != null) && !(theSchema.trim().isEmpty())) ? theSchema : v);
            return self();
        }
