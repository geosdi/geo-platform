...
import org.geosdi.geoplatform.connector.geoserver.model.extensions.importer.targetworkspace.IGPGeoserverWorkspaceImporter;
...
@Builder
@NoArgsConstructor
public class GPGeoserverCreateImportResponse implements IGPCreateImportResponse {

    private static final long serialVersionUID = 4265752750961771854L;
    //
    private Integer id;
    private String href;
    private GeoserverStateImport state;
    private Boolean archive;
    private IGPGeoserverWorkspaceImporter targetWorkspace;
    private IGPGeoserverTargetStoreImporter targetStore;
    @JsonProperty(value = "tasks")
    private List<IGPGeoserverTaskImporter> tasks;
    private IGPGeoserverImporterData data;
}
