 ...
 */
class GPFeatureTypeAttributesDeserializer extends StdDeserializer<GPFeatureTypeAttributes> {

    private static final Logger logger = LoggerFactory.getLogger(GPFeatureTypeAttributesDeserializer.class);

    GPFeatureTypeAttributesDeserializer() {
