...
public class GPGeoserverFeatureTypesList implements IGPGeoserverFeatureTypesList {
     ...
     */
    @JsonCreator
    public GPGeoserverFeatureTypesList(@Nonnull(when = When.NEVER) @JsonProperty(value = "string") List<String> theValues) {
        Preconditions.checkArgument(theValues != null, "The Parameter values must not be null.");
