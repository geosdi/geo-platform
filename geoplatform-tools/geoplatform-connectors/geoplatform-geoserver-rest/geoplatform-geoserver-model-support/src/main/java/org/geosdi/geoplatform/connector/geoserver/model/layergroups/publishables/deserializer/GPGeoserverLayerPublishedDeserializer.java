 ...
 */
public class GPGeoserverLayerPublishedDeserializer extends StdDeserializer<GPGeoserverLayerPublished> {

    public GPGeoserverLayerPublishedDeserializer() {
        super(GPGeoserverLayerPublished.class);
    }
    ...
    public GPGeoserverLayerPublished deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
        ...
        do {
            ...
            switch (propertyName != null ? propertyName : "") {
                case "name": {
                    layerName = jsonParser.getText();
                    break;
                }
                case "link": {
        ...
        return internalDeserialize(type, layerName, link);
    }
     ...
     * @param layerName
     * @param link
     * @return {@link GPGeoserverLayerPublished}
     */
    private GPGeoserverLayerPublished internalDeserialize(String type, String layerName, String link) {
        return (type != null) ? new GPGeoserverLayerTypePublished() {
            {
                super.setLayerName(layerName);
                super.setLink(link);
                super.setType(type);
            }
        } : new GPGeoserverLayerPublished() {
            {
                super.setLayerName(layerName);
                super.setLink(link);
            }
