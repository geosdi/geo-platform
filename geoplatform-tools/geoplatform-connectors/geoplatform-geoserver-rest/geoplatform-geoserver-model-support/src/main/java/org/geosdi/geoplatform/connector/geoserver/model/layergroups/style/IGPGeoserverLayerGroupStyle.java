 ...
 */
@JsonDeserialize(as = GPGeoserverLayerGroupStyle.class, using = JsonNodeDeserializer.class)
public interface IGPGeoserverLayerGroupStyle extends IGPGeoserverStyle {
}