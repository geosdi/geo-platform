 ...
 */
public class GPGeoserverMetadataMapType extends GPGenericMapType<String, String, GPGeoserverMetadataParam> {
    ...
    /**
     * @return {@link List<GPGeoserverMetadataParam>}
     */
    @Override
    public List<GPGeoserverMetadataParam> getEntry() {
     ...
     */
    @Override
    public void setEntry(List<GPGeoserverMetadataParam> entry) {
     ...
     */
    @Override
    protected GPGeoserverMetadataParam toEntry(Map.Entry<String, String> entry) {
