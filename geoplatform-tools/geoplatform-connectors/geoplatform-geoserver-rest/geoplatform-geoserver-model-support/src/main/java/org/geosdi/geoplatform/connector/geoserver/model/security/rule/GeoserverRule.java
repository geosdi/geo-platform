 ...
 */
@JsonSerialize(using = GeoserverRuleSerializer.class)
@JsonDeserialize(using = GeoserverRuleDeserializer.class)
public interface GeoserverRule extends Serializable {
     ...
     * @param theResource
     */
    void setResource(String theResource);
