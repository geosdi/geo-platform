 ...
 */
public class GeoserverRulesDeserializer extends StdDeserializer<GeoserverRules> {

    private static final Logger logger = LoggerFactory.getLogger(GeoserverRulesDeserializer.class);

    GeoserverRulesDeserializer() {
        super(GeoserverRules.class);
    }
