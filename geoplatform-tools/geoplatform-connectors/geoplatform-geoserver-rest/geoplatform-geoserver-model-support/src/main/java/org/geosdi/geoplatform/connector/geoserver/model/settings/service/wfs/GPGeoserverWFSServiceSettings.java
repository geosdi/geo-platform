...
public class GPGeoserverWFSServiceSettings extends GPGeoserverServiceSettings implements GeoserverWFSServiceSettings {

    private static final long serialVersionUID = -3103233605460188644L;
    //
    ...
    @XmlElement(name = "gml")
    private GMLEntryContainer container;
    private GeoserverWFSServiceLevel serviceLevel;
