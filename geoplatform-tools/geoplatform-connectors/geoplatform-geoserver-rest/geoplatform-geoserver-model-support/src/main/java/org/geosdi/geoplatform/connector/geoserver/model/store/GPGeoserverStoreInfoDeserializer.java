 ...
 */
class GPGeoserverStoreInfoDeserializer extends StdDeserializer<GPGeoserverStoreInfo> {

    private static final Logger logger = LoggerFactory.getLogger(GPGeoserverStoreInfoDeserializer.class);

    GPGeoserverStoreInfoDeserializer() {
        super(GPGeoserverStoreInfo.class);
    }
    ...
    public GPGeoserverStoreInfo deserialize(JsonParser jsonParser, DeserializationContext ctxt) throws JacksonException {
        ...
        GeoserverStoreInfoType storeInfoType = GeoserverStoreInfoType.forType(_class);
        return ((storeInfoType != null) ? this.toModel(storeInfoType, name, href) : null);
    }
    ...
    /**
     * @param theStoreTypeInfo
     * @param theName
     * @param theHref
     * @return {@link GPGeoserverStoreInfo}
     */
    GPGeoserverStoreInfo toModel(GeoserverStoreInfoType theStoreTypeInfo, String theName, String theHref) {
        switch (theStoreTypeInfo) {
            case FEATURE:
                return new GPGeoserverFeatureTypesStoreInfo() {
                    {
                        super.setName(theName);
                        super.setHref(theHref);
                    }
                };
            case COVERAGE:
                return new GPGeoserverCoverageStoreInfo() {
                    {
                        super.setName(theName);
                        super.setHref(theHref);
                    }
