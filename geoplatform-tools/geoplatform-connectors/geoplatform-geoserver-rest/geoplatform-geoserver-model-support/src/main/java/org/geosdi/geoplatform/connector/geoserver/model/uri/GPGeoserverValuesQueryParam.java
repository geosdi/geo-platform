 ...
 */
@Immutable
public class GPGeoserverValuesQueryParam extends GeoserverQueryParam<GPGeoserverValueQueryParam[]> {
     ...
     * @param theValue
     */
    public GPGeoserverValuesQueryParam(@Nonnull(when = NEVER) String theKey, @Nullable GPGeoserverValueQueryParam[] theValue) {
