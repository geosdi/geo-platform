...
public class GeoserverCreateWorkspaceBody implements GPGeoserverCreateWorkspaceBody {
     ...
     */
    public GeoserverCreateWorkspaceBody(@Nonnull(when = When.NEVER) String theWorkspaceName) {
        Preconditions.checkArgument((theWorkspaceName != null) && !(theWorkspaceName.trim().isEmpty()), "The Parameter workspaceName must not be null or an Empty String.");
