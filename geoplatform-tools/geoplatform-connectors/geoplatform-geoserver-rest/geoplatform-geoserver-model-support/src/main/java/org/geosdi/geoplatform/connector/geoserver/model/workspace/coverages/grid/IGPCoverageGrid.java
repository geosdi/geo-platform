...
public interface IGPCoverageGrid extends Serializable {
     ...
     * @param theDimension
     */
    void setDimension(String theDimension);
     ...
     * @param <Range>
     */
    <Range extends IGPCoverageGridRange> void setRange(Range theRange);

    /**
     * @return {@link Boolean}
     */
    @XmlTransient
    default boolean isSetRange() {
     ...
     * @param <Transform>
     */
    <Transform extends IGPCoverageGridTransformation> void setTransform(Transform theTransform);

    /**
     * @return {@link Boolean}
     */
    @XmlTransient
    default boolean isSetTransform() {
