...
public class GPGeoserverCoverageStoreBody implements GeoserverCoverageStoreBody {
     ...
     * @param theUrl
     */
    public GPGeoserverCoverageStoreBody(@Nonnull(when = When.NEVER) @JsonProperty(value = "name") String theName,
            @Nonnull(when = When.NEVER) @JsonProperty(value = "url") String theUrl) {
        this.name = theName;
        this.url = theUrl;
    }
}