 ...
 */
public interface GeoserverCreateLayerGroupRequest extends GeoserverBaseCreateLayerGroupRequest<GPGeoserverLayerGroupBody, GeoserverCreateLayerGroupRequest> {
     ...
     */
    @Override
    GeoserverCreateLayerGroupRequest withBody(@Nonnull(when = NEVER) GPGeoserverLayerGroupBody theLayerGroupBody);
}