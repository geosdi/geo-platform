...
public interface GeoserverDeleteLayerWorkspaceRequest extends GPJsonConnectorRequest<Boolean, GeoserverDeleteLayerWorkspaceRequest> {
     ...
     */
    GeoserverDeleteLayerWorkspaceRequest withWorkspaceName(@Nonnull(when = When.NEVER) String theWorkspaceName);

    /**
     * @param theLayerName
     * @return {@link GeoserverDeleteLayerWorkspaceRequest}
     */
    GeoserverDeleteLayerWorkspaceRequest withLayerName(@Nonnull(when = When.NEVER) String theLayerName);
