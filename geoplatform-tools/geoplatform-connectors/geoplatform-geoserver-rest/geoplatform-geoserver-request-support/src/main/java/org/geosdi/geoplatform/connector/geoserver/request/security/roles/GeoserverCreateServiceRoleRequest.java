 ...
 */
public interface GeoserverCreateServiceRoleRequest extends GeoserverBaseRoleRequest<GeoserverCreateServiceRoleRequest> {

    /**
     * @param theService
     * @return {@link GeoserverCreateServiceRoleRequest}
     */
    GeoserverCreateServiceRoleRequest withService(@Nonnull(when = NEVER) String theService);
}