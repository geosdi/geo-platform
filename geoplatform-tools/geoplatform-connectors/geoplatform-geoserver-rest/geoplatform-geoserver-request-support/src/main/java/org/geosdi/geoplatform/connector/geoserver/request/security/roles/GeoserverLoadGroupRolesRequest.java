 ...
 */
public interface GeoserverLoadGroupRolesRequest extends GPJsonConnectorRequest<GPGeoserverRoles, GeoserverLoadGroupRolesRequest> {
     ...
     */
    GeoserverLoadGroupRolesRequest withGroup(@Nonnull(when = NEVER) String theGroup);
}