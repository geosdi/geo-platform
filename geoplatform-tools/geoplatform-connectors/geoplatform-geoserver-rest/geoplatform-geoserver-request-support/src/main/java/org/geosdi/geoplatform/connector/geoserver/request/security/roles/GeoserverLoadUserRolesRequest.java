 ...
 */
public interface GeoserverLoadUserRolesRequest extends GPJsonConnectorRequest<GPGeoserverRoles, GeoserverLoadUserRolesRequest> {
     ...
     */
    GeoserverLoadUserRolesRequest withUser(@Nonnull(when = NEVER) String theUser);
}