 ...
 */
public interface GeoserverCreateAclServicesRequest extends GPJsonConnectorRequest<Boolean, GeoserverCreateAclServicesRequest> {

    /**
     * @param theGeoserverRulesBody
     * @return {@link GeoserverCreateAclServicesRequest}
     */
    GeoserverCreateAclServicesRequest withBody(@Nonnull(when = NEVER) GPGeoserverRules theGeoserverRulesBody);
}