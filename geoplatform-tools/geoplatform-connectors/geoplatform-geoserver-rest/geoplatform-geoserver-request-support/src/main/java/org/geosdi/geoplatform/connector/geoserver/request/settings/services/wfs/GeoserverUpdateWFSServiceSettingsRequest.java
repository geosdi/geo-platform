 ...
 */
public interface GeoserverUpdateWFSServiceSettingsRequest extends GeoserverUpdateServiceSettingsRequest<GeoserverWFSServiceSettings, GeoserverUpdateWFSServiceSettingsRequest> {
     ...
     */
    @Override
    GeoserverUpdateWFSServiceSettingsRequest withBody(@Nonnull(when = NEVER) GeoserverWFSServiceSettings theBody);
}