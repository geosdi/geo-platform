 ...
 */
public interface GeoserverLoadWorkspaceStoresRequest<Stores extends GPGeoserverStores, R extends GeoserverLoadWorkspaceStoresRequest> extends GPJsonConnectorRequest<Stores, R> {
