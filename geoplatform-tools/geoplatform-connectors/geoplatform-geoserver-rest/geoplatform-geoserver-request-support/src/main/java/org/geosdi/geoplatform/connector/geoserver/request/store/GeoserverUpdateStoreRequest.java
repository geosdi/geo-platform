 ...
 */
public interface GeoserverUpdateStoreRequest<Body extends GPGeoserverServiceStoreBody, R extends GeoserverUpdateStoreRequest<Body, R>> extends GeoserverCreateOrUpdateStoreRequest<Boolean, Body, R> {
