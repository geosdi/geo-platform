...
public interface GeoserverDeleteWorkspaceStyleRequest extends GeoserverBaseDeleteStyleRequest<GeoserverDeleteWorkspaceStyleRequest> {
     ...
     */
    GeoserverDeleteWorkspaceStyleRequest withWorkspace(@Nonnull(when = When.NEVER) String theWorkspace);
     ...
     */
    @Override
    GeoserverDeleteWorkspaceStyleRequest withStyle(@Nonnull(when = When.NEVER) String theStyle);
