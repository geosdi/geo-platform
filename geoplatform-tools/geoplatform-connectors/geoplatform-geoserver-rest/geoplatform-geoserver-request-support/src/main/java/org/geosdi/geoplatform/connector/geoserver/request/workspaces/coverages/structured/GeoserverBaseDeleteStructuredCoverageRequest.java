 ...
 */
public interface GeoserverBaseDeleteStructuredCoverageRequest<ConnectorDeleteRequest extends GeoserverBaseDeleteStructuredCoverageRequest> extends GeoserverBaseStructuredCoverageRequest<Boolean, ConnectorDeleteRequest> {
     ...
     */
    ConnectorDeleteRequest withFilter(@Nullable String theFilter);
     ...
     * @return {@link ConnectorDeleteRequest}
     */
    ConnectorDeleteRequest withPurge(@Nullable GPGeoserverPurgeParam thePurge);
     ...
     * @return {@link ConnectorDeleteRequest}
     */
    ConnectorDeleteRequest withUpdateBbox(@Nullable Boolean theUpdateBbox);
}