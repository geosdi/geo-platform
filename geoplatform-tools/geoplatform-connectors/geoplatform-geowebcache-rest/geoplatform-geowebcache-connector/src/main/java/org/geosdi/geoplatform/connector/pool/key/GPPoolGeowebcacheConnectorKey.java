...
public class GPPoolGeowebcacheConnectorKey extends GPPoolConnectorKey implements IGPPoolGeowebcacheConnectorKey {
     ...
     */
     GPPoolGeowebcacheConnectorKey(@Nonnull(when = NEVER) URL serverUrl, @Nullable GPPooledConnectorConfig pooledConnectorConfig,
