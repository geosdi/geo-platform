 ...
 */
package org.geosdi.geoplatform.connector.store.reloading;
 ...
 */
public abstract class GeowebcacheReloadingConnectorStore extends GPConnectorStore<GPGeowebcacheConnector> implements GPGeowebcacheReloadingConnectorStore {

    /**
     * @param theServer
     */
    protected GeowebcacheReloadingConnectorStore(GPGeowebcacheConnector theServer) {
        super(theServer);
    }
    ...
    public GeowebcacheReloadingRequest createReloadingRequest() {
        return this.server.createReloadingRequest();
    }
}