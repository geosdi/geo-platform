...
public class GPPoolConnectorKey {
    ...
    public GPPoolConnectorKey(URL serverUrl, GPPooledConnectorConfig pooledConnectorConfig,
            GPSecurityConnector securityConnector, String version) {
        this(serverUrl, pooledConnectorConfig, securityConnector, null, version);
    }

    public GPPoolConnectorKey(URL serverUrl, GPPooledConnectorConfig pooledConnectorConfig,
            GPSecurityConnector securityConnector, HttpClientProxyConfiguration proxyConfiguration, String version) {
