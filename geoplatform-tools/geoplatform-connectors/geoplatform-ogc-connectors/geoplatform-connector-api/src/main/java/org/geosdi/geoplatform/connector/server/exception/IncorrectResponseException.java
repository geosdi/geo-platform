...
import static org.geosdi.geoplatform.connector.server.request.GPConnectorRequest.INCORRECT_RESPONSE_MESSAGE;
...
public class IncorrectResponseException extends RuntimeException {
    ...
    public IncorrectResponseException() {
        this(INCORRECT_RESPONSE_MESSAGE);
    }
    ...
    public IncorrectResponseException(Throwable cause) {
        super(INCORRECT_RESPONSE_MESSAGE, cause);
    }
     ...
     * @since 1.7
     */
    public IncorrectResponseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
