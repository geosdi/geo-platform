 ...
 */
abstract class GPBaseSendJsonConnectorRequest<T, H extends HttpUriRequest, ConnectorRequest extends GPJsonConnectorRequest> extends GPBaseJsonConnectorRequest<T, H, ConnectorRequest> {

    /**
     * @param theServerConnector
     * @param theJacksonSupport
     */
    GPBaseSendJsonConnectorRequest(@Nonnull(when = NEVER) GPServerConnector theServerConnector, @Nonnull(when = NEVER) JacksonSupport theJacksonSupport) {
