...
public interface GPSecurityConnector {
    ...
    static final GPMockSecurityConnector MOCK_SECURITY = new GPMockSecurityConnector();
    ...
    <C extends GPConnectorRequest, H extends HttpUriRequest> CloseableHttpResponse secure(
            C connectorRequest, H httpRequest) throws ClientProtocolException, IOException;
