 ...
 */
public interface GPConnectorQueryParam<B extends Object> extends Serializable {
    ...
    abstract class ConnectorQueryParam<B extends Object> implements GPConnectorQueryParam<B> {
         ...
         * @param theValue
         */
        protected ConnectorQueryParam(@Nonnull(when = NEVER) String theKey, @Nullable B theValue) {
