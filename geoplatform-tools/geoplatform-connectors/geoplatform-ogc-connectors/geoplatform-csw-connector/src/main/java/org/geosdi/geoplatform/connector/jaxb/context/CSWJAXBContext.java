...
public class CSWJAXBContext extends GeoPlatformJAXBContext {
     ...
     * @throws JAXBException
     */
    public CSWJAXBContext(String contextPath, ClassLoader classLoader, Map<String, ?> properties) throws JAXBException {
     ...
     * @throws JAXBException
     */
    public CSWJAXBContext(String contextPath, ClassLoader classLoader) throws JAXBException {
