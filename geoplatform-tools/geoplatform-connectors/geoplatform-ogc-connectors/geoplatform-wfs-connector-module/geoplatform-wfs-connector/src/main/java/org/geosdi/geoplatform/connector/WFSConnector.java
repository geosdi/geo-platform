...
public interface WFSConnector {
     ...
     */
    <T> WFSGetCapabilitiesRequest<T> createGetCapabilitiesRequest();

    /**
     * @return {@link WFSDescribeFeatureTypeRequest}
     */
    <T> WFSDescribeFeatureTypeRequest<T> createDescribeFeatureTypeRequest();

    /**
     * @return {@link WFSGetFeatureRequest}
     */
    <T> WFSGetFeatureRequest<T> createGetFeatureRequest();

    /**
     * @return {@link WFSTransactionRequest}
     */
    <T> WFSTransactionRequest<T> createTransactionRequest();
}