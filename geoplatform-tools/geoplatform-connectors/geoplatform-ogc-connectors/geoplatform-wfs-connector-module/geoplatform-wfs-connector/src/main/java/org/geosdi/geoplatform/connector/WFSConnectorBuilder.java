 ...
 */
public class WFSConnectorBuilder extends AbstractConnectorBuilder<WFSConnectorBuilder, GPWFSConnectorStore> {

    protected WFSConnectorBuilder() {
    }

    /**
     * <p>Create a new GeoPlatform WFSConnectorBuilder with which to define a
