 ...
 */
public interface GPWFSGetFeatureReader<Feature extends Object> extends GPImplementor<GPWFSGetFeatureOutputFormat> {
     ...
     * @throws Exception
     */
    Feature read(@Nonnull(when = NEVER) InputStream inputStream) throws Exception;
}