 ...
 */
public class GPWFSGetFeatureGeoJsonReader implements GPWFSGetFeatureReader<FeatureCollection> {

    private static final Logger logger = LoggerFactory.getLogger(GPWFSGetFeatureGeoJsonReader.class);
    //
