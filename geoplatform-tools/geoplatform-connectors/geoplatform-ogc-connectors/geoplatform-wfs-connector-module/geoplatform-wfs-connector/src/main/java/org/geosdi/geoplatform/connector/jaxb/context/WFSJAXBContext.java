...
public class WFSJAXBContext extends GeoPlatformJAXBContext {
     ...
     * @throws JAXBException
     */
    public WFSJAXBContext(String contextPath, ClassLoader classLoader, Map<String, ?> properties) throws JAXBException {
     ...
     * @throws JAXBException
     */
    public WFSJAXBContext(String contextPath, ClassLoader classLoader) throws JAXBException {
