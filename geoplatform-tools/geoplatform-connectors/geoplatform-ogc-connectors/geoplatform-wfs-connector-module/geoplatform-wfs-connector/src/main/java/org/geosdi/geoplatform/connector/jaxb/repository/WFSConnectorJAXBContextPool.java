 ...
 */
public final class WFSConnectorJAXBContextPool implements GeoPlatformJAXBContextProvider {

    private static final Logger logger = LoggerFactory.getLogger(WFSConnectorJAXBContextPool.class);
