 ...
 */
public class GPWFSConnectorBuilderPool
        extends AbstractConnectorBuilder<GPWFSConnectorBuilderPool, GPWFSConnectorStore> {
    ...
    public static GPWFSConnectorBuilderPool newInstance() {
        return new GPWFSConnectorBuilderPool();
    }

    @Override
    public GPWFSConnectorStore build() throws Exception {
        Preconditions.checkNotNull(serverUrl, "WFS Server URL must "
                + "not be null.");

        GPPoolConnectorKey keyConnector = new GPPoolConnectorKey(serverUrl,
                pooledConnectorConfig, securityConnector, version);

        GPWFSConnectorStore wfsStore = wfsConnectorPool.borrowObject(
                keyConnector);
     ...
     */
    @Override
    protected GPWFSConnectorBuilderPool self() {
        return this;
    }
}
