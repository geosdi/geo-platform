 ...
 */
public class WFSGetCapabilitiesRequestV110 extends WFSRequest<WFSCapabilitiesType, GetCapabilitiesType> implements WFSGetCapabilitiesRequest<WFSCapabilitiesType> {

    /**
     * @param server
     */
    public WFSGetCapabilitiesRequestV110(@Nonnull(when = NEVER) GPServerConnector server) {
        super(server);
    }

    /**
     * @return {@link GetCapabilitiesType}
     */
    @Override
