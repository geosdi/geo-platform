...
public final class QueryRestrictionRepository implements WFSQueryRestrictionRepository<ComparisonOpsType> {
    ...
    //
    private static final EnumMap<OperatorType, QueryRestrictionStrategy<ComparisonOpsType>> parameters = Maps.newEnumMap(OperatorType.class);

    static {
        for (QueryRestrictionStrategy<ComparisonOpsType> queryRestrictionStrategy : QueryRestrictionsStrategyFinder.getValidStrategies()) {
     ...
     */
    public QueryRestrictionStrategy<ComparisonOpsType> getQueryRestrictionStrategy(OperatorType operatorType) {
