 ...
 */
public interface WFSQueryRestrictionRepository<T extends ComparisonOpsType> extends GPImplementorStore<QueryRestrictionStrategy<T>> {

    /**
     * @param operatorType
     * @return {@link QueryRestrictionStrategy<T>}
     */
    QueryRestrictionStrategy<T> getQueryRestrictionStrategy(@Nonnull(when = NEVER) WFSOperatorType operatorType);
}