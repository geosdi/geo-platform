 ...
 */
public enum FeaturesNamespace implements GPFeaturesNamespace {
     ...
     * @param theValue
     */
    FeaturesNamespace(@Nonnull(when = When.NEVER) FeatureNamespace theValue) {
        checkArgument(theValue != null, "The Parameter featureNamespace must not be null.");
        this.value = theValue;
    }
