 ...
 */
abstract class BaseGetFeatureGeoJsonStaxGml3ReaderTest {

    final Logger logger = LoggerFactory.getLogger(this.getClass());
    //
    static final JacksonSupport<JsonMapper> JACKSON_SUPPORT =  builder(FALSE)
            ...
            .build();
    static final GetFeatureGeoJsonStaxGml3Reader getFeatureGeoJsonStaxGml3Reader = new GetFeatureGeoJsonStaxGml3Reader();
