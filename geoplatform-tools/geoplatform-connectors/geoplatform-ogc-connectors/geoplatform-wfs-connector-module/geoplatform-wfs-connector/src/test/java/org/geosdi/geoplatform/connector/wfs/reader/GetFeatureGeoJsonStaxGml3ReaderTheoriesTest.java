...
public class GetFeatureGeoJsonStaxGml3ReaderTheoriesTest extends BaseGetFeatureGeoJsonStaxGml3ReaderTest {
    ...
    public static String[] data() {
        return new String[] {"extra_rt_webgis_strade_comunali.xml", "extra_rt_webgis:Cippi_SR_SP_ettometriche_v1.xml",
                ...
                "extra_rt_webgis:strade_private.xml", "aggregati_strutturali_edificato.xml"};
    }
