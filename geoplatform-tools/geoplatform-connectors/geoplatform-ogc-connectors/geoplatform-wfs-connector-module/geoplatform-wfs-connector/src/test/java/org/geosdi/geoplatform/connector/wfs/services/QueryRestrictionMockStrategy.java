...
import org.geosdi.geoplatform.connector.server.request.v110.query.repository.QueryRestrictionStrategyKey;
...
public class QueryRestrictionMockStrategy implements QueryRestrictionStrategy<ComparisonOpsType> {
     ...
     */
    @Override
    public QueryRestrictionStrategyKey getKey() {
        return QueryRestrictionStrategyKey.forStrategy(this);
    }
