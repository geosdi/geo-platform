...
public class QueryRestrictionStrategyFinderTest {
    ...
    //
    private static final GPImplementorFinder<QueryRestrictionStrategy<?>> finder = new QueryRestrictionsStrategyFinder<>();

    @Test
    public void a_getAllQueryRestrictionStrategyImplementorsTest() {
        Set<QueryRestrictionStrategy<?>> strategies = finder.getAllImplementors();
    ...
    @Test
    public void c_getAllQueryRestrictionValidStrategyImplementorsTest() {
        Set<QueryRestrictionStrategy<?>> strategies = finder.getValidImplementors();
