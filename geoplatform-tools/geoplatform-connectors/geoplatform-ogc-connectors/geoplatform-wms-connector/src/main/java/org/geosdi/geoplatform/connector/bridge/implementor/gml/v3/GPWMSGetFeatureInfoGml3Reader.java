 ...
 */
package org.geosdi.geoplatform.connector.bridge.implementor.gml.v3;
 ...
 */
public class GPWMSGetFeatureInfoGml3Reader implements GPWMSGetFeatureInfoReader<Object> {

    protected final Logger logger = LoggerFactory.getLogger(this.getClass());
    //
    protected static final GPWMSGetFeatureInfoStaxGml3Reader wmsGetFeatureInfoStaxGml3Reader = new GPWMSGetFeatureInfoStaxGml3Reader();
    ...
    public Object read(@Nonnull(when = NEVER) InputStream inputStream) throws Exception {
        ...
        return wmsGetFeatureInfoStaxGml3Reader.read(new InputStreamReader(inputStream, UTF_8));
    }
    ...
    /**
     * <p>Specify if {@link org.geosdi.geoplatform.support.bridge.implementor.GPImplementor} is Valid or Not.</p>
     *
     * @return {@link Boolean}
     */
    @Override
