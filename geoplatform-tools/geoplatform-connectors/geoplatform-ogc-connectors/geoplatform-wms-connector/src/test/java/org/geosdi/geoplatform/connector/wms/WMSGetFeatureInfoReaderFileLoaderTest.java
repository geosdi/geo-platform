...
public class WMSGetFeatureInfoReaderFileLoaderTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        storage = IGPConnectorFileStorage.of(of("geoserver-Vigneti-GetFeatureInfo.xml", "geoserver-GetFeatureInfo.xml",
                "geoserver-GetFeatureInfo1.xml", "geoserver-GetFeatureInfo-Point.xml", "geoserver-GetFeatureInfo-MultiLineString.xml",
                ...
                "comuniBasilicata-GetFeatureInfo.xml", "corine-GetFeatureInfo.xml", "airports.xml", "geologia.xml",
                "livelloEdifici.xml", "volumetria.xml", "livelloEdifici1.xml", "masw.xml", "CF_zonepianificazione_mappeinterattive.xml",
                "PianoCampiFlegrei.xml", "PianiCampiFlegrei.xml", "rsdi_alt_300_a_400.xml", "aziende.xml", "EneaClipFilled.xml",
                "test.xml", "ParchiBasilicata.xml", "centri_abitati.xml", "mobileBeni.xml", "PercorsiNavette.xml")
