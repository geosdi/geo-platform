...
public class WMSGetMapBaseRequestTest {
    ...
    public void a_wmsBoundigBoxKeyValuePairTest() throws Exception {
        Assert.assertTrue(wmsBoundinBox.toWMSKeyValuePair().equalsIgnoreCase("BBOX=-130.0,24.0,-66.0,50.0"));
    ...
    public void b_wmsGetMapKeyValuePairTest() throws Exception {
        GPWMSGetMapBaseRequest wmsGetMapBaseRequest = new WMSGetMapBaseRequest(wmsBoundinBox, Arrays.asList("topp:states"),
                "EPSG:4326", "550", "250");
        Assert.assertTrue(wmsGetMapBaseRequest.toWMSKeyValuePair().equalsIgnoreCase("LAYERS=topp:states&SRS=EPSG:4326&BBOX=-130.0,24.0,-66.0,50.0&WIDTH=550&HEIGHT=250"));
