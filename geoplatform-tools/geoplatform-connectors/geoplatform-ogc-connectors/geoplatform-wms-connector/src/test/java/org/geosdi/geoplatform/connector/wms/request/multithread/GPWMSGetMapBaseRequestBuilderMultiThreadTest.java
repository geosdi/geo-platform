...
public class GPWMSGetMapBaseRequestBuilderMultiThreadTest {
    ...
    public void wmGetMapBaseRequestBuilderMultiThreadTest() throws Exception {
        List<String> urls = Stream.of("http://150.145.141.180/geoserver/topp/wms?service=WMS&version=1.1.0&request=GetMap&layers=topp%3Atasmania_roads&bbox=145.19754%2C-43.423512%2C148.27298000000002%2C-40.852802&width=551&height=545&srs=EPSG%3A4326&format=application/openlayers",
