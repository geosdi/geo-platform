 ...
 */
public class WMSGetFeatureInfoReaderGml3FileLoaderTest extends WMSGetFeatureInfoReaderFileLoaderTest {

    protected static File destDir;

    @BeforeClass
    public static void beforeClass() throws Exception {
        basePath = of(new File(".").getCanonicalPath(), "src", "test", "resources", "stax", "gml3")
    ...
    public static Stream<String> toStreamFilesName() {
        return of("CartografiaTematica.xml", "ComuniSardegna.xml", "AlberiMonumentali.xml", "FreaCovid.xml",
                ...
                "AcquePubbliche.xml", "cen_abi_a_polygon.xml");
    }
