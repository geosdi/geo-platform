...
public class GPWMSFeatureStoreTheoriesGml3Test extends WMSGetFeatureInfoTheoriesGml3Test {

    private static final Logger logger = LoggerFactory.getLogger(GPWMSFeatureStoreTheoriesGml3Test.class);
    ...
    public void wmsGetFeatureInfoStaxFeatureReaderTest(String fileName) throws Exception {
        ...
        logger.info("#######################FEATURE_STORE : \n{}\n for File : {}\n", wmsGetFeatureInfoStaxGml3Reader.readAsStore(file), fileName);
    }
}