 ...
 */
package org.geosdi.geoplatform.connector.wms.stax2.gm3.multithread.aalto;
...
import static org.geosdi.geoplatform.connector.wms.stax2.gm3.WMSGetFeatureInfoAaltoGml3ReaderTest.wmsGetFeatureInfoAaltoGml3Reader;
 ...
 */
public class WMSGetFeatureInfoMultiThreadAaltoGml3ReaderTest extends GPWMSGetFeatureMultiThreadGml3Test {

    private static final Logger logger = LoggerFactory.getLogger(WMSGetFeatureInfoMultiThreadAaltoGml3ReaderTest.class);
    ...
    static class WMSGetFeatureInfoAaltoGml3ReaderTask implements Runnable {

        private static final Logger logger = LoggerFactory.getLogger(WMSGetFeatureInfoAaltoGml3ReaderTask.class);
        //
         ...
         * @param theDoneSignal
         */
        WMSGetFeatureInfoAaltoGml3ReaderTask(@Nonnull(when = NEVER) String theFileName, @Nonnull(when = NEVER) CountDownLatch theStartSignal,
        ...
        public void run() {
            try {
                ...
                logger.info("#######################FEATURE_COLLECTION : \n{}\n for File : {}\n", JACKSON_SUPPORT.getDefaultMapper()
                        .writeValueAsString(wmsGetFeatureInfoAaltoGml3Reader.read(new File(fileName))), fileName);
