...
public class WMSGetFeatureInfoTheoriesWoodstoxGml3ReaderTest extends WMSGetFeatureInfoTheoriesGml3Test {

    private static final Logger logger = LoggerFactory.getLogger(WMSGetFeatureInfoTheoriesWoodstoxGml3ReaderTest.class);
    ...
    public void wmsGetFeatureInfoWoodstoxFeatureGml3ReaderTest(String fileName) throws Exception {
        ...
        logger.info("#######################FEATURE_COLLECTION : \n{}\n for File : {}\n", JACKSON_SUPPORT.getDefaultMapper()
                .writeValueAsString(wmsGetFeatureInfoWoodstoxGml3Reader.read(file)), fileName);
    }
}