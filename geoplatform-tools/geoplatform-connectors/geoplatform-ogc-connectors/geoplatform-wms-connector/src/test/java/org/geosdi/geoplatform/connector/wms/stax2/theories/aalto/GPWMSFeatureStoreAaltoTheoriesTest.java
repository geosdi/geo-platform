...
public class GPWMSFeatureStoreAaltoTheoriesTest extends WMSGetFeatureInfoTheoriesTest {

    private static final Logger logger = LoggerFactory.getLogger(GPWMSFeatureStoreAaltoTheoriesTest.class);
    ...
    public void wmsGetFeatureInfoWoodstoxFeatureReaderTest(String fileName) throws Exception {
        ...
        logger.info("#######################FEATURE_STORE : \n{}\n for File : {}\n", wmsGetFeatureInfoAaltoReader.readAsStore(file), fileName);
    }
}