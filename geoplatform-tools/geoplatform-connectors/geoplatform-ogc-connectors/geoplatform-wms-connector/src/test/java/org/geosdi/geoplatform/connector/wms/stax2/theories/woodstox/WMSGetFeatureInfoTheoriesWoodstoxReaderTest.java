...
public class WMSGetFeatureInfoTheoriesWoodstoxReaderTest extends WMSGetFeatureInfoTheoriesTest {

    private static final Logger logger = LoggerFactory.getLogger(WMSGetFeatureInfoTheoriesWoodstoxReaderTest.class);
    ...
    public void wmsGetFeatureInfoWoodstoxFeatureReaderTest(String fileName) throws Exception {
        ...
        logger.info("#######################FEATURE_COLLECTION : \n{}\n for File : {}\n", JACKSON_SUPPORT.getDefaultMapper()
                .writeValueAsString(wmsGetFeatureInfoWoodstoxReader.read(file)), fileName);
    }
}