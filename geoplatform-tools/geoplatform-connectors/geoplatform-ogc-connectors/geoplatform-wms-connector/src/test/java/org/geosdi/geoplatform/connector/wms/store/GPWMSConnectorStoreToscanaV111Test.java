...
public class GPWMSConnectorStoreToscanaV111Test {

    private static final Logger logger = LoggerFactory.getLogger(GPWMSConnectorStoreToscanaV111Test.class);
    //
    ...
    public void a_wmsGetCapabilitiesV111Test() throws Exception {
        ...
        logger.debug("###############################WMS_GET_CAPABILITIES_V111_TOSCANA_RESPONSE : {}\n", wmsGetCapabilitiesRequest.getResponseAsString());
    }
    ...
    public void b_wmsDescribeLayerV11Test() throws Exception {
        ...
        logger.info("##########################WMS_DESCRIBE_LAYER_RESPONSE_V111 : {}\n", wmsDescribeLayerRequest
                .withLayers("extra_rt_webgis:elem_ridotto_2", "extra_rt_webgis:cen_abi_a_polygon", "extra_rt_webgis:strade_regionali").getResponse());
    }
}