...
public class DefaultGMLUnmarshaller extends AbstractGMLUnmarshaller {
    ...
    @Override
    public <T> T unmarshal(File f) throws JAXBException,
                                          ParserException {
    ...
    @Override
    public <T> T unmarshal(URL url) throws JAXBException,
                                           ParserException {
        return (T) super.parseElement(this.unmarshaller.unmarshal(url));
    }

    @Override
    public <T> T unmarshal(InputSource source) throws JAXBException,
                                                      ParserException {
    ...
    @Override
    public <T> T unmarshal(Node node) throws JAXBException,
                                             ParserException {
    ...
    public void dispose() throws Exception {
        logger.debug("DISPOSING UNMARSHALLER @@@@@@@@@@@@@@@@@@@@@");
    }
}
