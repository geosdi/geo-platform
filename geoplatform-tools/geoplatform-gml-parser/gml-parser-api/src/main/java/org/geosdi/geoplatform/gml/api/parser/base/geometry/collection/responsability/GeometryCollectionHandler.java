...
import org.geosdi.geoplatform.gml.api.parser.base.geometry.collection.responsability.geojson.GeometryCollectionGeoJsonHandler;
 ...
 */
public abstract class GeometryCollectionHandler extends GeometryCollectionGeoJsonHandler implements IGeometryCollectionHandler {
     ...
     */
    protected GeometryCollection forwardParseGeometry(AbstractGeometricAggregate gmlGeometry) throws ParserException {
        if (successor != null) {
