...
public class MultiGeometryCollectionHandler extends GeometryCollectionHandler {
    ...
    public GeometryCollection parseGeometry(AbstractGeometricAggregate gmlGeometry) throws ParserException {
        return isCompatibleGeometry(gmlGeometry) ? multiGeometryParser.parseGeometry((MultiGeometry) gmlGeometry)
    ...
    public org.geojson.GeometryCollection parseGeometryAsGeoJson(AbstractGeometricAggregate gmlGeometry) throws ParserException {
        return isCompatibleGeometry(gmlGeometry) ? multiGeometryParser.parseGeometryAsGeoJson((MultiGeometry) gmlGeometry)
