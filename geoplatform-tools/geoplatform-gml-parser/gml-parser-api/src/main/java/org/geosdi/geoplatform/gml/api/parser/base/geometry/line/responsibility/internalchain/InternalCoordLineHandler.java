 ...
 */
public class InternalCoordLineHandler extends AbstractInternalChainHandler<Point, org.geojson.Point> {
    ...
    public Point buildGeometry(GeometryFactory geometryFactory, Object object) throws ParserException {
        ...
        if (object instanceof Coord) {
            return geometryFactory.createPoint(coordinateBaseParser.parseCoordinate((Coord) object));
        }
        throw new ParserException("Unespected Value : " + object + " to build GML Geometry.");
    }
    ...
    public org.geojson.Point buildGeometryAsGeoJson(Object object) throws ParserException {
        ...
        if (object instanceof Coord) {
            return new org.geojson.Point(coordinateBaseParser.parseCoordinateAsGeoJson((Coord) object));
        }
        throw new ParserException("Unespected Value : " + object + " to build GML Geometry.");
    }
}