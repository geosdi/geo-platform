 ...
 */
public class GMLBaseLinearRingParser extends AbstractGMLBaseParser<LinearRing, LinearRingProperty, org.locationtech.jts.geom.LinearRing> {

    private CoordinateBaseParser coordinateParser;
    private GMLBasePointParser pointParser;
    private AbstractGeometryHandler<LinearRing, org.locationtech.jts.geom.LinearRing, GMLBasePointParser, CoordinateBaseParser> mixedLinearRingHandler;
     ...
     */
    @Override
    protected org.locationtech.jts.geom.LinearRing canParseGeometry(LinearRing gmlGeometry)
            throws ParserException {
     ...
     */
    @Override
    public org.locationtech.jts.geom.LinearRing parseGeometry(LinearRingProperty propertyType)
            throws ParserException {
