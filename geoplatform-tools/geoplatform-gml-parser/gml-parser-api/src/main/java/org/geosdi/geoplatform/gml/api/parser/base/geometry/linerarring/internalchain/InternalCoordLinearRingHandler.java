 ...
 */
public class InternalCoordLinearRingHandler extends AbstractInternalChainHandler<Point, org.geojson.Point> {
    ...
    public Point buildGeometry(GeometryFactory geometryFactory, Object object) throws ParserException {
        ...
        return object instanceof Coord
                ? geometryFactory.createPoint(coordinateBaseParser.parseCoordinate((Coord) object))
    ...
    public org.geojson.Point buildGeometryAsGeoJson(Object object) throws ParserException {
        ...
        return object instanceof Coord
                ? new org.geojson.Point(coordinateBaseParser.parseCoordinateAsGeoJson((Coord) object))
