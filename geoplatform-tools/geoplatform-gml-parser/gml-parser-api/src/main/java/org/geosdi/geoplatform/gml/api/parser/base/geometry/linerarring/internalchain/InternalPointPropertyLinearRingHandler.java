 ...
 */
public class InternalPointPropertyLinearRingHandler extends AbstractInternalChainHandler<Point, org.geojson.Point> {
    ...
    public Point buildGeometry(GeometryFactory geometryFactory, Object object) throws ParserException {
        ...
        throw new ParserException("There are no Rings in this Chain to build JTS Geometry with this Object : " + object);
    }
    ...
    public org.geojson.Point buildGeometryAsGeoJson(Object object) throws ParserException {
        ...
        if (object instanceof PointProperty) {
            return pointParser.parseGeometryAsGeoJson((PointProperty) object);
        }
        throw new ParserException("There are no Rings in this Chain to build GeoJson Geometry with this Object : " + object);
    }
}