...
public class LineStringHandler extends MultiCurveHandler {
    ...
    public void parseGeometry(List<LineString> lines, AbstractCurve gmlGeometry) throws ParserException {
        if (isCompatibleGeometry(gmlGeometry)) {
            lines.add(lineStringParser.parseGeometry((org.geosdi.geoplatform.gml.api.LineString) gmlGeometry));
        } else {
    ...
    public void parseGeometryAsGeoJson(List<org.geojson.LineString> lines, AbstractCurve gmlGeometry) throws ParserException {
        if (isCompatibleGeometry(gmlGeometry)) {
            lines.add(lineStringParser.parseGeometryAsGeoJson((org.geosdi.geoplatform.gml.api.LineString) gmlGeometry));
        } else {
