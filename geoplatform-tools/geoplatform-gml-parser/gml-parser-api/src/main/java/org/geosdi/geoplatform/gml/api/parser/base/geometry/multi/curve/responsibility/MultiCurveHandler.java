...
public abstract class MultiCurveHandler {
     ...
     */
    public abstract void parseGeometry(List<LineString> collection, AbstractCurve gmlGeometry) throws ParserException;
     ...
     * @throws ParserException
     */
    protected void forwardParseGeometry(List<LineString> collection, AbstractCurve gmlGeometry) throws ParserException {
        if (successor != null) {
