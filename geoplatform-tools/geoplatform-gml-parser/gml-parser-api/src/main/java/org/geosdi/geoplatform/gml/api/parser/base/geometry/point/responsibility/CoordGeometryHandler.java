...
public class CoordGeometryHandler extends BasePointGeometryHandler {
    ...
    public Point buildGeometry(GeometryFactory geometryFactory, org.geosdi.geoplatform.gml.api.Point gmlGeometry,
        ...
        if (gmlGeometry.isSetCoord()) {
            return geometryFactory.createPoint(parser.parseCoordinate(gmlGeometry.getCoord()));
        } else {
    ...
    public org.geojson.Point buildGeometryAsGeoJson(org.geosdi.geoplatform.gml.api.Point gmlGeometry, CoordinateBaseParser parser)
            throws ParserException {
        if (gmlGeometry.isSetCoord()) {
            return new org.geojson.Point(parser.parseCoordinateAsGeoJson(gmlGeometry.getCoord()));
        } else {
