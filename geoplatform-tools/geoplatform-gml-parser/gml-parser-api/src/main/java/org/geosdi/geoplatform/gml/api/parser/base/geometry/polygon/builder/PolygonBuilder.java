...
public interface PolygonBuilder {
     ...
     * @throws ParserException
     */
    LineString buildExteriorPolygonAsGeoJson(Polygon polygon) throws ParserException;
     ...
     * @throws ParserException
     */
    LineString[] buildInteriorPolygonAsGeoJson(Polygon polygon) throws ParserException;
}
