 ...
 */
public abstract class BaseGeometryHandler<A extends AbstractGeometry, G extends Geometry, P extends AbstractParser> {

    protected BaseGeometryHandler<A, G, P> successor;
    ...
    protected G forwarBuildGeometry(GeometryFactory geometryFactory,
        ...
        throw new ParserException("Unable to Buid Geometry "
                + "with Parser " + parser);
    }
     ...
     */
    public void setSuccessor(BaseGeometryHandler<A, G, P> successor) {
