 ...
 */
public class CurveParserParameter implements
        BaseParameterValue<GMLBaseCurveParser> {
    ...
    public GMLBaseCurveParser getValue() {
        return curveParser = (curveParser == null)
                             ? new GMLBaseCurveParser(
