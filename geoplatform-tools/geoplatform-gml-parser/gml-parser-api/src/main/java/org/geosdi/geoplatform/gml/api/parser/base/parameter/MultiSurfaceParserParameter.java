 ...
 */
class MultiSurfaceParserParameter implements
        BaseParameterValue<GMLBaseMultiSurfaceParser> {
    ...
    public MultiSurfaceParserParameter(
    ...
    public GMLBaseMultiSurfaceParser getValue() {
        return multiSurfaceParser = (multiSurfaceParser == null)
                                    ? new GMLBaseMultiSurfaceParser(
                geometryParameter.getValue(), srsParameter.getValue(),
                polygonParameter.getValue()) : multiSurfaceParser;
    }
}
