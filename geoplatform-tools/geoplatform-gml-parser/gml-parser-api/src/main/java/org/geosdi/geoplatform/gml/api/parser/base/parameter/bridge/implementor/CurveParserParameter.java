...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_CURVE_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class CurveParserParameter implements BaseParameterValue<GMLBaseCurveParser> {

    private GMLBaseCurveParser curveParser;

    /**
     * @return {@link GMLBaseCurveParser}
     */
    @Override
    public GMLBaseCurveParser getValue() {
        return curveParser = ((curveParser == null) ? new GMLBaseCurveParser(getDefaultGeometryFactory(),
