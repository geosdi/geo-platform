 ...
 */
public class LineStringParserParameter implements BaseParameterValue<GMLBaseLineStringParser> {
    ...
    public GMLBaseLineStringParser getValue() {
        return lineStringParser = ((lineStringParser == null)
                ? new GMLBaseLineStringParser(getDefaultGeometryFactory(), getDefaultSRSParser(),
                getDefaultCoordinateBaseParser(), getDefaultPointParser()) : lineStringParser);
    }
    ...
    public GPImplementorKey<BaseParameterEnum> getKey() {
        return DEFAULT_LINE_STRING_PARSER;
    }
