 ...
 */
public class LinearRingParserParameter implements BaseParameterValue<GMLBaseLinearRingParser> {
    ...
    public GMLBaseLinearRingParser getValue() {
        return linearRingParser = ((linearRingParser == null)
                ? new GMLBaseLinearRingParser(getDefaultCoordinateBaseParser(), getDefaultPointParser(),
