...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_MULTI_GEOMETRY_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class MultiGeometryParserParameter implements BaseParameterValue<GMLBaseMultiGeometryParser> {
    ...
    public GMLBaseMultiGeometryParser getValue() {
        return multiGeometryParser = ((multiGeometryParser == null) ? new GMLBaseMultiGeometryParser() : multiGeometryParser);
    }
    ...
    public GPImplementorKey<BaseParameterEnum> getKey() {
        return DEFAULT_MULTI_GEOMETRY_PARSER;
    }
