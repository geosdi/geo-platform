...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_MULTI_LINE_STRING_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class MultiLineStringParserParameter implements BaseParameterValue<GMLBaseMultiLineStringParser> {
    ...
    public GMLBaseMultiLineStringParser getValue() {
        return multiLineStringParser = ((multiLineStringParser == null)
                ? new GMLBaseMultiLineStringParser(getDefaultGeometryFactory(), getDefaultSRSParser(),
