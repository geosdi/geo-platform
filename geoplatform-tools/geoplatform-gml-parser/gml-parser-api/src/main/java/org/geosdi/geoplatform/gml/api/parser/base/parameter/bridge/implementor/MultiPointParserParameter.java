...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_MULTI_POINT_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class MultiPointParserParameter implements BaseParameterValue<GMLBaseMultiPointParser> {
    ...
    public GMLBaseMultiPointParser getValue() {
        return multiPointParser = ((multiPointParser == null) ? new GMLBaseMultiPointParser(getDefaultGeometryFactory(),
                getDefaultSRSParser(), getDefaultPointParser()) : multiPointParser);
    }
    ...
    public GPImplementorKey<BaseParameterEnum> getKey() {
        return DEFAULT_MULTI_POINT_PARSER;
    }
