...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_MULTI_POLYGON_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class MultiPolygonParserParameter implements BaseParameterValue<GMLBaseMultiPolygonParser> {

    private GMLBaseMultiPolygonParser multiPolygonParser;

    @Override
    public GMLBaseMultiPolygonParser getValue() {
        return multiPolygonParser = ((multiPolygonParser == null) ? new GMLBaseMultiPolygonParser(getDefaultGeometryFactory(),
                getDefaultSRSParser(), getDefaultPolygonParser()) : multiPolygonParser);
    }
    ...
    public GPImplementorKey<BaseParameterEnum> getKey() {
        return DEFAULT_MULTI_POLYGON_PARSER;
    }
