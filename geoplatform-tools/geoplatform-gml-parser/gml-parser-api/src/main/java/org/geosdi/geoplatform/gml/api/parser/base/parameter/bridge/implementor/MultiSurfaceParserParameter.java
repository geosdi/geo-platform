...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_MULTI_SURFACE_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class MultiSurfaceParserParameter implements BaseParameterValue<GMLBaseMultiSurfaceParser> {

    private GMLBaseMultiSurfaceParser multiSurfaceParser;

    /**
     * @return {@link GMLBaseMultiSurfaceParser}
     */
    @Override
    public GMLBaseMultiSurfaceParser getValue() {
        return multiSurfaceParser = ((multiSurfaceParser == null)
                ? new GMLBaseMultiSurfaceParser(getDefaultGeometryFactory(), getDefaultSRSParser(),
