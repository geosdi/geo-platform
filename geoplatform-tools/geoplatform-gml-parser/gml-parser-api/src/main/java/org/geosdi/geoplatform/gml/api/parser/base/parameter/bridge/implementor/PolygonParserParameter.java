...
import static org.geosdi.geoplatform.gml.api.parser.base.parameter.bridge.implementor.BaseParameterEnum.DEFAULT_POLYGON_PARSER;

/**
 * @author Giuseppe La Scaleia - CNR IMAA geoSDI Group
 * @email giuseppe.lascaleia@geosdi.org
 */
public class PolygonParserParameter implements BaseParameterValue<GMLBasePolygonParser> {
    ...
    public GMLBasePolygonParser getValue() {
        return polygonParser = ((polygonParser == null) ? new GMLBasePolygonParser(getDefaultLinearRingParser(),
