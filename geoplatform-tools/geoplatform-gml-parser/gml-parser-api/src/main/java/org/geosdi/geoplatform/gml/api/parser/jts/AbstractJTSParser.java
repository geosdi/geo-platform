...
public abstract class AbstractJTSParser<A extends AbstractGeometry, P extends PropertyType, G extends Geometry>
     ...
     */
    @Override
    public A parseGeometry(G jtsGeometry) throws ParserException {
        A gmlGeometry = canParseGeometry(jtsGeometry);
        srsParser.parseSRS(jtsGeometry, gmlGeometry);
        return gmlGeometry;
    }
     ...
     * @throws ParserException
     */
    protected abstract A canParseGeometry(G jtsGeometry) throws ParserException;

    /**
     * @return the gmlObjectFactory
     */
    public GMLObjectFactory getGmlObjectFactory() {
     ...
     */
    public AbstractJTSSRSParser getSrsParser() {
        return srsParser;
    }
}