 ...
 *
 */
package org.geosdi.geoplatform.gml.api.parser.jts.geometry.line;
...
public class JTSLineStringParser extends AbstractJTSParser<LineString, LineStringProperty, com.vividsolutions.jts.geom.LineString> {
    ...
    public JTSLineStringParser(AbstractGMLObjectFactory theGmlObjectFactory,
    ...
    @Override
    public LineStringProperty parseProperty(
            com.vividsolutions.jts.geom.LineString jtsGeometry)
            throws ParserException {

        Preconditions.checkNotNull(jtsGeometry, "The JTS LineString Geometry "
                + "must not be null.");
    ...
    @Override
    public JAXBElement<? extends LineString> buildJAXBElement(
