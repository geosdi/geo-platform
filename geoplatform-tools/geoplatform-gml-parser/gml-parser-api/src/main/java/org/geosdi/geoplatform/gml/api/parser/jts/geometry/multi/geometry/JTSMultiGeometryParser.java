...
public class JTSMultiGeometryParser extends AbstractJTSParser<MultiGeometry, MultiGeometryProperty, GeometryCollection> {
    ...
    public JTSMultiGeometryParser(AbstractGMLObjectFactory theGmlObjectFactory,
    ...
    @Override
    protected MultiGeometry canParseGeometry(GeometryCollection jtsGeometry)
        ...
        for (int i = 0; i < jtsGeometry.getNumGeometries(); i++) {
            ...
            multiGeometry.addGeometryMember(jtsSextanteParser.parseProperty(
                    theGeom));
        }
    ...
    @Override
    public MultiGeometryProperty parseProperty(GeometryCollection jtsGeometry)
            throws ParserException {

        Preconditions.checkNotNull(jtsGeometry, "The JTS GeometryCollection "
                + "must not be null.");

        MultiGeometryProperty multiGeometryProperty = gmlObjectFactory.createMultiGeometryPropertyType();
        multiGeometryProperty.setAbstractGeometricAggregate(this.buildJAXBElement(
                jtsGeometry));
    ...
    @Override
    public JAXBElement<? extends MultiGeometry> buildJAXBElement(
            GeometryCollection geometry)
            throws ParserException {

        return gmlObjectFactory.createMultiGeometry(
                super.parseGeometry(geometry));
    }
}
