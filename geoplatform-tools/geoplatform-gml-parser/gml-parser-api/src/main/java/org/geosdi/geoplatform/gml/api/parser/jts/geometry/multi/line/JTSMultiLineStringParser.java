 ...
 */
public class JTSMultiLineStringParser extends AbstractJTSParser<MultiLineString, MultiLineStringProperty, com.vividsolutions.jts.geom.MultiLineString> {

    private JTSLineStringParser lineStringParser;

    public JTSMultiLineStringParser(AbstractGMLObjectFactory theGmlObjectFactory,
    ...
    @Override
    protected MultiLineString canParseGeometry(
            com.vividsolutions.jts.geom.MultiLineString jtsGeometry)
        ...
        for (int i = 0; i < jtsGeometry.getNumGeometries(); i++) {
            ...
            multiLineString.addLineStringMember(lineStringParser.parseProperty(
                    lineString));
        }
    ...
    @Override
    public MultiLineStringProperty parseProperty(
            com.vividsolutions.jts.geom.MultiLineString jtsGeometry)
            throws ParserException {

        Preconditions.checkNotNull(jtsGeometry, "The JTS MultiLineString "
        ...
        multiLineStringProperty.setMultiLineString(super.parseGeometry(
                jtsGeometry));
    ...
    @Override
    public JAXBElement<? extends MultiLineString> buildJAXBElement(
            com.vividsolutions.jts.geom.MultiLineString geometry) throws ParserException {
        return gmlObjectFactory.createMultiLineString(super.parseGeometry(
                geometry));
    }
}
