...
public class JTSMultiLineStringParser extends AbstractJTSParser<MultiLineString, MultiLineStringProperty, com.vividsolutions.jts.geom.MultiLineString> {
     ...
     */
    @Override
    protected MultiLineString canParseGeometry(com.vividsolutions.jts.geom.MultiLineString jtsGeometry)
            throws ParserException {
     ...
     */
    @Override
    public MultiLineStringProperty parseProperty(com.vividsolutions.jts.geom.MultiLineString jtsGeometry)
            throws ParserException {
     ...
     */
    @Override
    public JAXBElement<? extends MultiLineString> buildJAXBElement(com.vividsolutions.jts.geom.MultiLineString geometry)
            throws ParserException {
