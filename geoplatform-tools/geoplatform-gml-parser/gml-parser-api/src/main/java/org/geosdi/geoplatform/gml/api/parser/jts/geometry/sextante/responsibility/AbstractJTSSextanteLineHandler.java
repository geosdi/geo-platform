 ...
 */
public abstract class AbstractJTSSextanteLineHandler extends JTSSextanteHandler {
    ...
    protected boolean isCompatibleParser() {
        return (acquireParser() instanceof JTSLineStringParser);
    }
    ...
    protected boolean isCompatibleGeometry(Object jtsGeometry) {
        return (jtsGeometry instanceof LineString);
    }
