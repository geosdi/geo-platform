 ...
 */
public abstract class AbstractJTSSextantePointHandler
    ...
    public JAXBElement<? extends AbstractGeometry> buildJAXBElement(
        ...
        return isCompatibleGeometry(geometry)
               ? acquireParser().buildJAXBElement((Point) geometry)
