 ...
 */
class JTSLineStringParserParameter implements
    ...
    public JTSLineStringParser getValue() {
        return jtsLineStringParser = (jtsLineStringParser == null)
                                     ? new JTSLineStringParser(
                objectFactoryParameter.getValue(), srsParameter.getValue(),
                coordinateParameter.getValue()) : jtsLineStringParser;
    }
}
