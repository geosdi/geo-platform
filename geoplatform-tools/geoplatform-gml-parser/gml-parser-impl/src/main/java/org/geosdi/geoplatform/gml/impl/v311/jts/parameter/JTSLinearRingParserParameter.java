 ...
 */
class JTSLinearRingParserParameter implements
        ParameterValue<JTSLinearRingParser> {
    ...
    public JTSLinearRingParserParameter(
    ...
    public JTSLinearRingParser getValue() {
        return jtsLinearRingParser = (jtsLinearRingParser == null)
                                     ? new JTSLinearRingParser(
                objectFactoryParameter.getValue(), srsParameter.getValue(),
                coordinateParameter.getValue()) : jtsLinearRingParser;
    }
}
