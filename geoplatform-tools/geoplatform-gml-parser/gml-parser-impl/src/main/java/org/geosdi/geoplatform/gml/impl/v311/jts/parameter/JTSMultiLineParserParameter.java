 ...
 */
class JTSMultiLineParserParameter implements
    ...
    public JTSMultiLineParserParameter(
            ...
            ParameterValue<JTSLineStringParser> theLineStringParameter) {
        this.objectFactoryParameter = theObjectFactoryParameter;
        this.srsParameter = theSrsParameter;
        this.lineStringParameter = theLineStringParameter;
    }

    @Override
    public JTSMultiLineStringParser getValue() {
        return jtsMultiLineParser = (jtsMultiLineParser == null)
                                    ? new JTSMultiLineStringParser(
                objectFactoryParameter.getValue(), srsParameter.getValue(),
                lineStringParameter.getValue()) : jtsMultiLineParser;
    }
}
