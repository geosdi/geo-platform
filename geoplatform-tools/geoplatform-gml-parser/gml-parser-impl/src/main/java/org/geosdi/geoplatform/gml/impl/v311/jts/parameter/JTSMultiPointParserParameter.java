 ...
 */
class JTSMultiPointParserParameter implements
    ...
    public JTSMultiPointParserParameter(
            ...
            ParameterValue<JTSPointParser> thePointParameter) {
        this.objectFactoryParameter = theObjectFactoryParameter;
        this.srsParameter = theSrsParameter;
        this.pointParameter = thePointParameter;
    }

    @Override
    public JTSMultiPointParser getValue() {
        return jtsMultiPointParser = (jtsMultiPointParser == null)
                                     ? new JTSMultiPointParser(
                objectFactoryParameter.getValue(), srsParameter.getValue(),
                pointParameter.getValue()) : jtsMultiPointParser;
    }
}
