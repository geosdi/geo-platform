...
class JTSPolygonParserParameter implements ParameterValue<JTSPolygonParser> {
    ...
    public JTSPolygonParserParameter(
            ...
            ParameterValue<JTSLinearRingParser> theLinearRingParameter) {
        this.objectFactoryParameter = theObjectFactoryParameter;
        this.srsParameter = theSrsParameter;
        this.linearRingParameter = theLinearRingParameter;
    }

    @Override
    public JTSPolygonParser getValue() {
        return jtsPolygonParser = (jtsPolygonParser == null)
                                  ? new JTSPolygonParser(
                objectFactoryParameter.getValue(), srsParameter.getValue(),
                linearRingParameter.getValue()) : jtsPolygonParser;
    }
}
