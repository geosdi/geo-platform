...
import static org.geosdi.geoplatform.gml.impl.v311.jts.parameter.bridge.implementor.JTSParameterEnum.DEFAULT_JTS_MULTI_GEOMETRY_PARSER;
 ...
 */
public class JTSMultiGeometryParserParameter implements JTSParameterValue<JTSMultiGeometryParser> {
    ...
    public JTSMultiGeometryParser getValue() {
        return jtsMultiGeometryParser = ((jtsMultiGeometryParser == null) ?
                new JTSMultiGeometryParser(getDefaultGmlObjectFactory(), getDefaultSRSParser(),
                        getDefaultSextanteParser()) : jtsMultiGeometryParser);
    }
    ...
    public GPImplementorKey<JTSParameterEnum> getKey() {
        return DEFAULT_JTS_MULTI_GEOMETRY_PARSER;
    }
