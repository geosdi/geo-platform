 ...
 */
public class BasePooledPBEStringEncryptorDecorator implements GPEncryptorConfigurator {
    ...
    public boolean matches(String encryptedText, String plainText) {
        String originalPlainPassword = this.pooledPBEStringEncryptor.decrypt(encryptedText);
