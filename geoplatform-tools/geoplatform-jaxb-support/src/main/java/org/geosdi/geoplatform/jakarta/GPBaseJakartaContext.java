 ...
 */
public abstract class GPBaseJakartaContext {
     ...
     *                                        contextPath</li> </ol>
     */
    public GPBaseJakartaContext(String contextPath, ClassLoader classLoader, Map<String, ?> properties)
     ...
     */
    public GPBaseJakartaContext(@Nonnull(when = NEVER) Class... classToBeBound) throws JAXBException {
     ...
     */
    public GPBaseJakartaContext(@Nonnull(when = NEVER) JAXBContext theJaxbContext) {
