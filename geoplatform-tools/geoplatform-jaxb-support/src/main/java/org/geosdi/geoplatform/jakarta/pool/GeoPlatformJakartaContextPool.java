 ...
 */
package org.geosdi.geoplatform.jakarta.pool;

import jakarta.xml.bind.*;
import org.apache.commons.pool2.impl.GenericObjectPool;
import org.geosdi.geoplatform.jakarta.GeoPlatformJakartaContext;
import org.geosdi.geoplatform.jakarta.pool.factory.GPJakartaMarshallerFactory;
import org.geosdi.geoplatform.jakarta.pool.factory.GPJakartaUnmarshallerFactory;
 ...
 */
public abstract class GeoPlatformJakartaContextPool extends GeoPlatformJakartaContext implements IJakartaContextPool {
     ...
     *                       </ol>
     */
    public GeoPlatformJakartaContextPool(String contextPath) throws JAXBException {
        this(contextPath, currentThread().getContextClassLoader());
    }
     ...
     *                       </ol>
     */
    public GeoPlatformJakartaContextPool(String contextPath, ClassLoader classLoader) throws JAXBException {
     ...
     *                       </ol>
     */
    public GeoPlatformJakartaContextPool(String contextPath, ClassLoader classLoader, Map<String, ?> properties) throws JAXBException {
        super(contextPath, classLoader, properties);
        this.marshallerPool = new GenericObjectPool<Marshaller>(new GPJakartaMarshallerFactory(jaxbContext), new GeoPlatformJakartaConfig());
        this.unmarshallerPool = new GenericObjectPool<Unmarshaller>(new GPJakartaUnmarshallerFactory(jaxbContext), new GeoPlatformJakartaConfig());
    }
     ...
     */
    public GeoPlatformJakartaContextPool(Class... classToBeBound) throws JAXBException {
     ...
     */
    public GeoPlatformJakartaContextPool(JAXBContext theJaxbContext) {
