 ...
 */
public class GPJakartaMarshallerFactory extends BasePooledObjectFactory<Marshaller> {
     ...
     */
    public GPJakartaMarshallerFactory(@Nonnull(when = NEVER) JAXBContext theJaxbContext) {
