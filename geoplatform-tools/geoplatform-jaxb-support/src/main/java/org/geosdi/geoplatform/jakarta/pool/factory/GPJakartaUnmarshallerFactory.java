 ...
 */
package org.geosdi.geoplatform.jakarta.pool.factory;
 ...
 */
public class GPJakartaUnmarshallerFactory extends BasePooledObjectFactory<Unmarshaller> {

    private static final Logger logger = LoggerFactory.getLogger(GPJakartaUnmarshallerFactory.class);
    //
     ...
     */
    public GPJakartaUnmarshallerFactory(@Nonnull(when = NEVER) JAXBContext theJaxbContext) {
