...
public abstract class GeoPlatformJAXBContext extends GPBaseJAXBContext {
     ...
     *                       </ol>
     */
    public GeoPlatformJAXBContext(String contextPath, ClassLoader classLoader) throws JAXBException {
     ...
     *                       </ol>
     */
    public GeoPlatformJAXBContext(String contextPath, ClassLoader classLoader, Map<String, ?> properties) throws JAXBException {
