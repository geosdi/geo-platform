 ...
 */
abstract class GPHibernateCriteriaDAO<T extends Object, ID extends Serializable> extends GPAbstractBaseDAO<T, ID> implements GPBaseHibernateDAO<T, ID> {
     ...
     */
    public GPHibernateCriteriaDAO(@Nonnull(when = NEVER) Class<T> thePersistentClass) {
