...
public class GPPersistenceConnector implements InitializingBean {
    ...
    public String[] getPackagesToScan() {
        return (this.packagesToScan != null ? this.packagesToScan : definePackagesToScan());
    }
    ...
    public void afterPropertiesSet() throws Exception {
        if ((this.url == null) || (this.url.isEmpty())) {
            throw new IllegalArgumentException("Parameter DB URL " + "can not be Null or an Empty String.");
        }

        if ((this.packageToScan == null) || (this.packageToScan.equals(""))) {
            throw new IllegalArgumentException("Parameter Package To Scan " + "can not be Null or an Empty String.");
        }
    }
}
