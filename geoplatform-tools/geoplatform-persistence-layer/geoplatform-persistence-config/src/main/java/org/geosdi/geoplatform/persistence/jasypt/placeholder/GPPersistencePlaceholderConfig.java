...
class GPPersistencePlaceholderConfig {
    ...
    /**
     * @param persistencePooledPBEStringEncryptor
     * @param gpConfigDataDir
     * @param persistenceFileProp
     * @return {@link PropertySourcesPlaceholderConfigurer}
     * @throws MalformedURLException
     */
    @Bean(name = "persistencePropertyConfigurer")
    public static PropertySourcesPlaceholderConfigurer persistencePropertyConfigurer(@Qualifier(value = "persistencePooledPBEStringEncryptor") PooledPBEStringEncryptor persistencePooledPBEStringEncryptor,
        ...
        persistenceGSPC.setNullValue("@null");
        persistenceGSPC.setLocations(persistenceResourcesLoader.loadResources(gpConfigDataDir, persistenceFileProp));
        persistenceGSPC.setIgnoreResourceNotFound(TRUE);
        persistenceGSPC.setIgnoreUnresolvablePlaceholders(TRUE);
        return persistenceGSPC;
    }
}