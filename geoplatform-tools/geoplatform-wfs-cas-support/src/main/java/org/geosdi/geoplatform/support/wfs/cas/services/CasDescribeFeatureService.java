...
public class CasDescribeFeatureService extends GPDescribeFeatureService {
    ...
    public LayerSchemaDTO describeFeatureType(String serverURL, String typeName, Map<String, String> headerParams)
            throws Exception {
        LayerSchemaDTO layerSchemaDTO = super.describeFeatureType(serverURL, typeName, headerParams);
        int paramIndex = serverURL.indexOf("?");
        layerSchemaDTO.setScope((paramIndex != -1) ? serverURL.substring(0,
                paramIndex) : serverURL);
