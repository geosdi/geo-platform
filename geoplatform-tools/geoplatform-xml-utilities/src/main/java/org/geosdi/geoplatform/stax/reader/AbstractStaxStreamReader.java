 ...
 */
public abstract class AbstractStaxStreamReader<T> extends BaseStaxStreamReader {

    /**
     * @param theXmlStreamBuilder
     */
    protected AbstractStaxStreamReader(@Nonnull(when = NEVER) GPXmlStreamReaderBuilder theXmlStreamBuilder) {
