 ...
 */
public interface GPXmlStreamReaderBuilder extends GPXmlEventReaderBuilder {
     ...
     */
    XMLStreamReader build(@Nonnull(when = NEVER) InputStream stream) throws XMLStreamException;
     ...
     * @throws XMLStreamException
     */
    XMLStreamReader build(@Nonnull(when = NEVER) Object o) throws XMLStreamException;
}