 ...
 */
public abstract class AbstractStaxStreamWriter<T extends Object> implements GeoPlatformStaxWriter {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractStaxStreamWriter.class);
    //
    ...
    public void acquireWriter(Object o) throws XMLStreamException, IOException {
        ...
        this.writer = (this.stream != null) ? xmlStreamBuilder.build(stream) : xmlStreamBuilder.build(o);
    }
     ...
     * @throws XMLStreamException
     */
    protected void writeElement(final String prefix, final String localName, final String nameSpace, final Object value) throws XMLStreamException {
        if (value != null) {
