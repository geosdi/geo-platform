 ...
 */
public class ResultHandler extends AbstractWriterBuildHandler {
    
    public ResultHandler() {
        super.setSuccessor(new WriterHandler());
    }
    ...
    public XMLStreamWriter buildXmlWriter(Object o,
        ...
        return o instanceof Result ? factory.createXMLStreamWriter((Result) o)
