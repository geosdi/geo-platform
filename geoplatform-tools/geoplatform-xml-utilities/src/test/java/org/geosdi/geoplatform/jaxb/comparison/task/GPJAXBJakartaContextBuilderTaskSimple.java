...
import org.geosdi.geoplatform.jaxb.jakarta.GPJAXBJakartaContextBuilder;
 ...
 */
public class GPJAXBJakartaContextBuilderTaskSimple implements Callable<Long> {

    private static final Logger logger = LoggerFactory.getLogger(GPJAXBJakartaContextBuilderTaskSimple.class);
    //
