...
import static org.geosdi.geoplatform.jaxb.jakarta.pool.GPJAXBJakartaContextBuilderPool.jaxbJakartaContextBuilderPool;
...
public class GPJAXBJakartaContextBuilderPoolTest {

    private static final Logger logger = LoggerFactory.getLogger(GPJAXBJakartaContextBuilderPoolTest.class);
    //
    private final static IGPJAXBContextBuilder GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL = jaxbJakartaContextBuilderPool();
    ...
    public void a_writeCarAsStringPoolTest() throws Exception {
        ...
        GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL.marshal(car, writer);
    ...
    public void b_writeCarAsFilePoolTest() throws Exception {
        ...
        GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL.marshal(car, new File(of(new File(".").getCanonicalPath(), "target", "CarPool")
                .collect(joining(separator, "", ".xml"))));
    }

    @Test
    public void c_readCarFromFilePoolTest() throws Exception {
        logger.info("###########################UNMARSHALL_CAR_FROM_FILE : {}\n", GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL
    ...
    public void e_writeAttributeStoreAsStringPoolTest() throws Exception {
        ...
        StringWriter writer = new StringWriter();
        GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL.marshal(attributeStore, writer);
    ...
    public void f_writeAttributeStoreAsFilePoolTest() throws Exception {
        ...
        GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL.marshal(attributeStore, new File(of(new File(".").getCanonicalPath(), "target", "AttributeStorePool")
                .collect(joining(separator, "", ".xml"))));
    }
    ...
    public void h_readAttributeStoreFromStringPoolTest() throws Exception {
        logger.info("@@@@@@@@@@@@@@@@@@@@@@@@@@UNMARSHALL_ATTRIBUTE_STORE_FROM_STRING : {}\n",
                GP_JAXB_JAKARTA_CONTEXT_BUILDER_POOL.unmarshal(new StringReader("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                        "<AttributeStore>\n" +
                        "    <attributes>\n" +
                        "        <attribute>\n" +
