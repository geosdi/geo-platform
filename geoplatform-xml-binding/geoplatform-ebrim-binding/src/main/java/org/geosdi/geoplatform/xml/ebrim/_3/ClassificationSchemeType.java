    ...
    implements Serializable, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            theIsInternal = (true?this.isIsInternal():false);
            strategy.appendField(locator, this, "isInternal", buffer, theIsInternal);
        }
        {
            String theNodeType;
            theNodeType = this.getNodeType();
            strategy.appendField(locator, this, "nodeType", buffer, theNodeType);
        }
        return buffer;
    }

    public void setClassificationNode(List<ClassificationNodeType> value) {
        this.classificationNode = null;
        List<ClassificationNodeType> draftl = this.getClassificationNode();
        draftl.addAll(value);
    }
