    ...
    implements Serializable, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "notificationInterval", buffer, theNotificationInterval);
        }
        return buffer;
    }

    public void setAction(List<JAXBElement<? extends ActionType>> value) {
        this.action = null;
        List<JAXBElement<? extends ActionType>> draftl = this.getAction();
        draftl.addAll(value);
    }
