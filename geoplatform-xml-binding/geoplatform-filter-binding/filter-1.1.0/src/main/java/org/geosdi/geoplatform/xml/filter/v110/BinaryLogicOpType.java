    ...
    implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            strategy.appendField(locator, this, "comparisonOpsOrSpatialOpsOrLogicOps", buffer, theComparisonOpsOrSpatialOpsOrLogicOps, this.isSetComparisonOpsOrSpatialOpsOrLogicOps());
        }
        return buffer;
    }
