...
/**
 * <p>Classe Java per Id_CapabilitiesType complex type.
 * 
...
public class IdCapabilitiesType implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Object> theEIDOrFID;
            theEIDOrFID = (this.isSetEIDOrFID()?this.getEIDOrFID():null);
            strategy.appendField(locator, this, "eidOrFID", buffer, theEIDOrFID, this.isSetEIDOrFID());
        }
        return buffer;
    }

    public void setEIDOrFID(List<Object> value) {
        this.eidOrFID = null;
        if (value!= null) {
            List<Object> draftl = this.getEIDOrFID();
            draftl.addAll(value);
        }
    }
