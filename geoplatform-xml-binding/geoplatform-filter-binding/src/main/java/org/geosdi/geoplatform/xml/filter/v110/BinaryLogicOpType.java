    ...
    implements Serializable, ToString
{
    ...
    protected List<JAXBElement<? extends Serializable>> comparisonOpsOrSpatialOpsOrLogicOps;
     ...
     * 
     */
    public List<JAXBElement<? extends Serializable>> getComparisonOpsOrSpatialOpsOrLogicOps() {
        if (comparisonOpsOrSpatialOpsOrLogicOps == null) {
            comparisonOpsOrSpatialOpsOrLogicOps = new ArrayList<JAXBElement<? extends Serializable>>();
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<JAXBElement<? extends Serializable>> theComparisonOpsOrSpatialOpsOrLogicOps;
            theComparisonOpsOrSpatialOpsOrLogicOps = (((this.comparisonOpsOrSpatialOpsOrLogicOps!= null)&&(!this.comparisonOpsOrSpatialOpsOrLogicOps.isEmpty()))?this.getComparisonOpsOrSpatialOpsOrLogicOps():null);
            strategy.appendField(locator, this, "comparisonOpsOrSpatialOpsOrLogicOps", buffer, theComparisonOpsOrSpatialOpsOrLogicOps);
        }
        return buffer;
    }

    public void setComparisonOpsOrSpatialOpsOrLogicOps(List<JAXBElement<? extends Serializable>> value) {
        this.comparisonOpsOrSpatialOpsOrLogicOps = null;
        List<JAXBElement<? extends Serializable>> draftl = this.getComparisonOpsOrSpatialOpsOrLogicOps();
        draftl.addAll(value);
    }
