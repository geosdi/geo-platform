    ...
    implements Serializable, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<JAXBElement<? extends AbstractIdType>> the_Id;
            the_Id = (((this.id!= null)&&(!this.id.isEmpty()))?this.get_Id():null);
            strategy.appendField(locator, this, "id", buffer, the_Id);
        }
        return buffer;
    }
    ...
    public void set_Id(List<JAXBElement<? extends AbstractIdType>> value) {
        this.id = null;
        List<JAXBElement<? extends AbstractIdType>> draftl = this.get_Id();
        draftl.addAll(value);
    }
