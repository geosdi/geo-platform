...
public class AbstractGriddedSurfaceType
     ...
     */
    public void setRow(List<AbstractGriddedSurfaceType.Row> row) {
        this.row = row;
    }
    ...
    public List<AbstractGriddedSurfaceType.Row> getRow() {
        if (row == null) {
            setRow(new ArrayList<AbstractGriddedSurfaceType.Row>());
        }
        return this.row;
    }
    ...
    public static class Row {
        ...
        public List<Object> getGeometricPositionGroup() {
            if (geometricPositionGroup == null) {
                setGeometricPositionGroup(new ArrayList<Object>());
            }
    ...
    @Override
    public String toString() {
        return "AbstractGriddedSurfaceType{ " + "row = " + row + 
