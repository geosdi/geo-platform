...
public abstract class AbstractReferenceSystemType
     ...
     */
    public void setSrsID(List<IdentifierType> srsID) {
        this.srsID = srsID;
    }
    ...
    public List<IdentifierType> getSrsID() {
        if (srsID == null) {
            setSrsID(new ArrayList<IdentifierType>());
        }
        return this.srsID;
    }
    ...
    public String toString() {
        return "AbstractReferenceSystemType{ "  + "srsID = " + srsID + 
                ", remarks = " + remarks + ", validArea = " 
