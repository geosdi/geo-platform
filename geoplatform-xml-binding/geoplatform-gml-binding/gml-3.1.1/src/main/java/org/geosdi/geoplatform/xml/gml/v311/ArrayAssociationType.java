...
public class ArrayAssociationType {
    ...
    private List<JAXBElement<?>> object;
     ...
     */
    public void setObject(List<JAXBElement<?>> object) {
        this.object = object;
    }
    ...
    public List<JAXBElement<?>> getObject() {
        if (object == null) {
            setObject(new ArrayList<JAXBElement<?>>());
        }
        return this.object;
    }
    ...
    public String toString() {
        return "ArrayAssociationType{ " + "object = " + object + '}';
    }
}
