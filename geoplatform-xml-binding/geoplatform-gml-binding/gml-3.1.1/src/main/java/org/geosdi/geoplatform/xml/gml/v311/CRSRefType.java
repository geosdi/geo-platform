...
public class CRSRefType {
    ...
    @XmlElementRef(name = "_CRS", namespace = "http://www.opengis.net/gml",
    ...
    /**
     * Gets the value of the _CRS property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the _CRS property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link GeographicCRSType }{@code >}
    ...
    public String toString() {
        return "CRSRefType{ " + "crs = " + crs + ", remoteSchema = " 
