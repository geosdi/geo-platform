...
public class CoordinateOperationRefType {
    ...
    @XmlElementRef(name = "_CoordinateOperation",
    ...
    public CoordinateOperationRefType() {
    }
    ...
    public String toString() {
        return "CoordinateOperationRefType{ " + "coordinateOperation = "
                + coordinateOperation + ", remoteSchema = " + remoteSchema
