...
public class DatumRefType {
    ...
    @XmlElementRef(name = "_Datum", namespace = "http://www.opengis.net/gml",
    ...
    /**
     * Gets the value of the _Datum property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the _Datum property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractDatumType }{@code >}
    ...
    public String toString() {
        return "DatumRefType{ " + "datum = " + datum + ", remoteSchema = "
