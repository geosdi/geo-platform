...
public class FeatureArrayPropertyType {
     ...
     */
    public void setFeature(List<JAXBElement<? extends AbstractFeatureType>> feature) {
    ...
    public List<JAXBElement<? extends AbstractFeatureType>> getFeature() {
        if (feature == null) {
            this.feature = new ArrayList<JAXBElement<? extends AbstractFeatureType>>();
        }
        return this.feature;
    }
    ...
    public String toString() {
        return "FeatureArrayPropertyType{" + "feature = " + feature + '}';
    }
}
