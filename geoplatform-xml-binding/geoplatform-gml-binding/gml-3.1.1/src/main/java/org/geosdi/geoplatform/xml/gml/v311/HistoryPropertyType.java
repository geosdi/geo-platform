...
public class HistoryPropertyType {
    ...
    @XmlElementRef(name = "_TimeSlice", namespace = "http://www.opengis.net/gml",
     ...
     */
    public void setTimeSlice(List<JAXBElement<? extends AbstractTimeSliceType>> timeSlice) {
    ...
    public List<JAXBElement<? extends AbstractTimeSliceType>> getTimeSlice() {
        if (timeSlice == null) {
            this.timeSlice = new ArrayList<JAXBElement<? extends AbstractTimeSliceType>>();
        }
    ...
    public String toString() {
        return "HistoryPropertyType{ " + "timeSlice = " + timeSlice + '}';
    }
}
