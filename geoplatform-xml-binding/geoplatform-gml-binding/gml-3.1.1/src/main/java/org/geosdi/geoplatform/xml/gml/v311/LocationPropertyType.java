...
public class LocationPropertyType {
    ...
    public String toString() {
        return "LocationPropertyType{ " + "geometry = " + geometry
                + ", locationKeyWord = " + locationKeyWord + ", locationString = "
                + locationString + ", _null = " + _null + ", remoteSchema = "
                + remoteSchema + ", type = " + type + ", href = " + href
                + ", role = " + role + ", arcrole = " + arcrole + ", title = "
                + title + ", show = " + show + ", actuate = s" + actuate + '}';
    }
}
