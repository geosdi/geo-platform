...
public class SurfacePatchArrayPropertyType {
    ...
    @XmlElementRef(name = "_SurfacePatch",
                   namespace = "http://www.opengis.net/gml",
                   type = JAXBElement.class)
    private List<JAXBElement<? extends AbstractSurfacePatchType>> surfacePatch;

    public SurfacePatchArrayPropertyType() {
    }

    /**
     * @param surfacePatch the surfacePatch to set
     */
    public void setSurfacePatch(List<JAXBElement<? extends AbstractSurfacePatchType>> surfacePatch) {
    ...
    public List<JAXBElement<? extends AbstractSurfacePatchType>> getSurfacePatch() {
        if (surfacePatch == null) {
            this.surfacePatch = new ArrayList<JAXBElement<? extends AbstractSurfacePatchType>>();
        }
    ...
    public String toString() {
        return "SurfacePatchArrayPropertyType{ " + "surfacePatch = " + surfacePatch + '}';
    }
}
