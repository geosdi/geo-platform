...
public class TimeClockType
    ...
    /**
     * @param dateBasis the dateBasis to set
     */
    ...
    public List<TimeCalendarPropertyType> getDateBasis() {
        if (dateBasis == null) {
            this.dateBasis = new ArrayList<TimeCalendarPropertyType>();
        }
    ...
    public String toString() {
        return "TimeClockType{ " + "referenceEvent = " + referenceEvent
                + ", referenceTime = " + referenceTime + ", utcReference = "
                + utcReference + ", dateBasis = " + dateBasis + '}';
    }
}
