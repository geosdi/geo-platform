...
public class TimeTopologyPrimitivePropertyType {
    ...
    @XmlElementRef(name = "_TimeTopologyPrimitive",
    ...
    public String toString() {
        return "TimeTopologyPrimitivePropertyType{ " + "timeTopologyPrimitive = "
                + timeTopologyPrimitive + ", remoteSchema = " + remoteSchema
                + ", type = " + type + ", href = " + href + ", role = "
                + role + ", arcrole = " + arcrole + ", title = " + title
