...
public class TopoPrimitiveMemberType {
    ...
    /**
     * Gets the value of the _TopoPrimitive property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public void set_TopoPrimitive(JAXBElement<? extends AbstractTopoPrimitiveType> value) {
    ...
    public String toString() {
        return "TopoPrimitiveMemberType{ " + "topoPrimitive = " + topoPrimitive
                + ", remoteSchema = " + remoteSchema + ", type = " + type
                + ", href = " + href + ", role = " + role + ", arcrole = "
