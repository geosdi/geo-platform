...
public class VectorType {
    ...
    public List<String> getAxisLabels() {
        if (axisLabels == null) {
            setAxisLabels(new ArrayList<String>());
        }
    ...
    public List<String> getUomLabels() {
        if (uomLabels == null) {
            setUomLabels(new ArrayList<String>());
        }
    ...
    public String toString() {
        return "VectorType{ " + "value = " + value + ", srsName = "
                + srsName + ", srsDimension = " + srsDimension
                + ", axisLabels = " + axisLabels + ", uomLabels = "
                + uomLabels + '}';
    }
}
