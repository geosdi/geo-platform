...
/**
 * <p>Classe Java per AbstractContinuousCoverageType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @Override
    public AbstractContinuousCoverageType withDescriptionReference(ReferenceType value) {
        setDescriptionReference(value);
        return this;
    }

    @Override
    public AbstractContinuousCoverageType withIdentifier(CodeWithAuthorityType value) {
        setIdentifier(value);
        return this;
    }

    @Override
    public AbstractContinuousCoverageType withName(CodeType... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractContinuousCoverageType withName(Collection<CodeType> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractContinuousCoverageType withName(List<CodeType> value) {
        setName(value);
        return this;
    }
