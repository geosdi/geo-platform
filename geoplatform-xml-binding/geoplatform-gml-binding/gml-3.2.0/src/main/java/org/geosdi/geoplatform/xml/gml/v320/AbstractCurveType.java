 ...
 * 
 * <p>Classe Java per AbstractCurveType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @Override
    public AbstractCurveType withAxisLabels(String... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractCurveType withAxisLabels(Collection<String> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractCurveType withUomLabels(String... values) {
        if (values!= null) {
            for (String value: values) {
    ...
    @Override
    public AbstractCurveType withUomLabels(Collection<String> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractCurveType withAxisLabels(List<String> value) {
        setAxisLabels(value);
        return this;
    }

    @Override
    public AbstractCurveType withUomLabels(List<String> value) {
        setUomLabels(value);
        return this;
    }

    @Override
    public AbstractCurveType withMetaDataProperty(MetaDataPropertyType... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractCurveType withMetaDataProperty(Collection<MetaDataPropertyType> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractCurveType withDescription(StringOrRefType value) {
    ...
    @Override
    public AbstractCurveType withMetaDataProperty(List<MetaDataPropertyType> value) {
        setMetaDataProperty(value);
        return this;
    }

    @Override
    public AbstractCurveType withName(List<CodeType> value) {
        setName(value);
        return this;
    }
