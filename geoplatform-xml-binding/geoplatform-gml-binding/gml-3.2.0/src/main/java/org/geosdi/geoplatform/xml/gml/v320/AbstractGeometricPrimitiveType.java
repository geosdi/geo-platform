 ...
 * 
 * <p>Classe Java per AbstractGeometricPrimitiveType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @Override
    public AbstractGeometricPrimitiveType withAxisLabels(String... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withAxisLabels(Collection<String> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withUomLabels(String... values) {
        if (values!= null) {
            for (String value: values) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withUomLabels(Collection<String> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withAxisLabels(List<String> value) {
        setAxisLabels(value);
        return this;
    }

    @Override
    public AbstractGeometricPrimitiveType withUomLabels(List<String> value) {
        setUomLabels(value);
        return this;
    }

    @Override
    public AbstractGeometricPrimitiveType withMetaDataProperty(MetaDataPropertyType... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withMetaDataProperty(Collection<MetaDataPropertyType> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withDescription(StringOrRefType value) {
    ...
    @Override
    public AbstractGeometricPrimitiveType withMetaDataProperty(List<MetaDataPropertyType> value) {
        setMetaDataProperty(value);
        return this;
    }

    @Override
    public AbstractGeometricPrimitiveType withName(List<CodeType> value) {
        setName(value);
        return this;
    }
