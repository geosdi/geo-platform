    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Category withNilReason(String... values) {
        if (values!= null) {
    ...
    public Category withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public Category withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
    ...
    @Override
    public Category withCodeSpace(String value) {
        setCodeSpace(value);
        return this;
    }
