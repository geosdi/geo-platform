...
public class Count implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Count withValue(BigInteger value) {
        setValue(value);
        return this;
    }

    public Count withNilReason(String... values) {
        if (values!= null) {
    ...
    public Count withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public Count withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
