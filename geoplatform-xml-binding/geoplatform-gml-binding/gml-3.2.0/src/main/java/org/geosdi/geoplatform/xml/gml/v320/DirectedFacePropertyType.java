...
/**
 * <p>Classe Java per DirectedFacePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public DirectedFacePropertyType withFace(FaceType value) {
        setFace(value);
        return this;
    }

    public DirectedFacePropertyType withOrientation(SignType value) {
        setOrientation(value);
        return this;
    }

    public DirectedFacePropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public DirectedFacePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DirectedFacePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DirectedFacePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public DirectedFacePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DirectedFacePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DirectedFacePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DirectedFacePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DirectedFacePropertyType withShow(String value) {
        setShow(value);
        return this;
    }

    public DirectedFacePropertyType withActuate(String value) {
        setActuate(value);
        return this;
    }

    public DirectedFacePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
