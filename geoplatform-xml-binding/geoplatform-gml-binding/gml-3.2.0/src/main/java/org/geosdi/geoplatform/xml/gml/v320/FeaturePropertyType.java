...
/**
 * <p>Classe Java per FeaturePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public FeaturePropertyType withAbstractFeature(JAXBElement<? extends AbstractFeatureType> value) {
        setAbstractFeature(value);
        return this;
    }

    public FeaturePropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public FeaturePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public FeaturePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public FeaturePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public FeaturePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public FeaturePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public FeaturePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public FeaturePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public FeaturePropertyType withShow(String value) {
        setShow(value);
        return this;
    }

    public FeaturePropertyType withActuate(String value) {
        setActuate(value);
        return this;
    }

    public FeaturePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
