 ...
 * 
 * <p>Classe Java per PointPropertyType complex type.
 * 
...
public class PointPropertyType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public PointPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public PointPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public PointPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public PointPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PointPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PointPropertyType withShow(String value) {
        setShow(value);
        return this;
    }

    public PointPropertyType withActuate(String value) {
        setActuate(value);
        return this;
    }

    public PointPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
