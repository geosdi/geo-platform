 ...
 * 
 * <p>Classe Java per PolygonPatchArrayPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @Override
    public PolygonPatchArrayPropertyType withAbstractSurfacePatch(JAXBElement<? extends AbstractSurfacePatchType> ... values) {
        if (values!= null) {
    ...
    @Override
    public PolygonPatchArrayPropertyType withAbstractSurfacePatch(Collection<JAXBElement<? extends AbstractSurfacePatchType>> values) {
        if (values!= null) {
    ...
    @Override
    public PolygonPatchArrayPropertyType withAbstractSurfacePatch(List<JAXBElement<? extends AbstractSurfacePatchType>> value) {
