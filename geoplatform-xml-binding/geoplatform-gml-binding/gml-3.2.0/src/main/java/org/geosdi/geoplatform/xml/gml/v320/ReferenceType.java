    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public ReferenceType withRemoteSchema(String value) {
    ...
    public ReferenceType withShow(String value) {
        setShow(value);
        return this;
    }

    public ReferenceType withActuate(String value) {
        setActuate(value);
        return this;
    }

    public ReferenceType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
