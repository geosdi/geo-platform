...
/**
 * <p>Classe Java per TargetPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public TargetPropertyType withAbstractFeature(JAXBElement<? extends AbstractFeatureType> value) {
        setAbstractFeature(value);
        return this;
    }

    public TargetPropertyType withAbstractGeometry(JAXBElement<? extends AbstractGeometryType> value) {
        setAbstractGeometry(value);
        return this;
    }

    public TargetPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public TargetPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public TargetPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public TargetPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public TargetPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public TargetPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TargetPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TargetPropertyType withShow(String value) {
        setShow(value);
        return this;
    }

    public TargetPropertyType withActuate(String value) {
        setActuate(value);
        return this;
    }

    public TargetPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public TargetPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
