 ...
 * 
 * <p>Classe Java per TrianglePatchArrayPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @Override
    public TrianglePatchArrayPropertyType withAbstractSurfacePatch(JAXBElement<? extends AbstractSurfacePatchType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TrianglePatchArrayPropertyType withAbstractSurfacePatch(Collection<JAXBElement<? extends AbstractSurfacePatchType>> values) {
        if (values!= null) {
    ...
    @Override
    public TrianglePatchArrayPropertyType withAbstractSurfacePatch(List<JAXBElement<? extends AbstractSurfacePatchType>> value) {
