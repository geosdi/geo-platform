    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "EngineeringDatum", namespace = "http://www.opengis.net/gml/3.2", type = EngineeringDatumUpperCase.class)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EngineeringDatumUpperCase theEngineeringDatum;
