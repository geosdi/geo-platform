    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "OperationParameter", namespace = "http://www.opengis.net/gml/3.2", type = OperationParameterUpperCase.class)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationParameterUpperCase theOperationParameter;
