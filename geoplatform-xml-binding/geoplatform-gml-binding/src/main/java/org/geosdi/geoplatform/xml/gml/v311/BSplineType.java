...
public class BSplineType
    ...
    public List<KnotPropertyType> getKnot() {
        if (knot == null) {
            setKnot(new ArrayList<KnotPropertyType>());
        }
        return this.knot;
    }
    ...
    public String toString() {
        return "BSplineType{ " + "posOrPointPropertyOrPointRep = "
                + posOrPointPropertyOrPointRep + ", posList = " + posList
                + ", coordinates = " + coordinates + ", degree = "
                + degree + ", knot = " + knot + ", interpolation = "
                + interpolation + ", isPolynomial = " + isPolynomial
                + ", knotType = " + knotType + '}';
    }
}
