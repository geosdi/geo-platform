...
public class CoordinateReferenceSystemRefType {
    ...
    @XmlElementRef(name = "_CoordinateReferenceSystem",
    ...
    public CoordinateReferenceSystemRefType() {
    }

    /**
     * Gets the value of the _CoordinateReferenceSystem property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the _CoordinateReferenceSystem property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link GeographicCRSType }{@code >}
