...
public class CurveArrayPropertyType {
    ...
    private List<JAXBElement<? extends AbstractCurveType>> curve;
     ...
     */
    public void setCurve(List<JAXBElement<? extends AbstractCurveType>> curve) {
        this.curve = curve;
    }
    ...
    public List<JAXBElement<? extends AbstractCurveType>> getCurve() {
        if (curve == null) {
            this.curve = new ArrayList<JAXBElement<? extends AbstractCurveType>>();
        }
        return this.curve;
    }
    ...
    public String toString() {
        return "CurveArrayPropertyType{ " + "curve = " + curve + '}';
    }
}
