...
public class CurveSegmentArrayPropertyType {
    ...
    private List<JAXBElement<? extends AbstractCurveSegmentType>> curveSegment;

    public CurveSegmentArrayPropertyType() {
    }

    /**
     * @param curveSegment the curveSegment to set
     */
    public void setCurveSegment(List<JAXBElement<? extends AbstractCurveSegmentType>> curveSegment) {
    ...
    public List<JAXBElement<? extends AbstractCurveSegmentType>> getCurveSegment() {
        if (curveSegment == null) {
            this.curveSegment = new ArrayList<JAXBElement<? extends AbstractCurveSegmentType>>();
        }
    ...
    public String toString() {
        return "CurveSegmentArrayPropertyType{ " + "curveSegment = "
                + curveSegment + '}';
    }
}
