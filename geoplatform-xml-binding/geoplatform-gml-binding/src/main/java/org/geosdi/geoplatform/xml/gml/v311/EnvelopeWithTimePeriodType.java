...
public class EnvelopeWithTimePeriodType
     ...
     */
    public void setTimePosition(List<TimePositionType> timePosition) {
    ...
    public List<TimePositionType> getTimePosition() {
        if (timePosition == null) {
            this.timePosition = new ArrayList<TimePositionType>();
        }
    ...
    public String toString() {
        return "EnvelopeWithTimePeriodType{ " + "timePosition = "
                + timePosition + ", frame = " + frame + '}';
    }
}
