...
public class GeneralConversionRefType {
    ...
    @XmlElementRef(name = "_GeneralConversion",
    ...
    public GeneralConversionRefType() {
    }
    ...
    public String toString() {
        return "GeneralConversionRefType{ " + "generalConversion = "
                + generalConversion + ", remoteSchema = " + remoteSchema
                + ", type = " + type + ", href = " + href + ", role = "
