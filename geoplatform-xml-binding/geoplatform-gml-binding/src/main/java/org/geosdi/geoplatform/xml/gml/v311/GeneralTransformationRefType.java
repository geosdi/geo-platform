...
public class GeneralTransformationRefType {
    ...
    @XmlElementRef(name = "_GeneralTransformation",
    ...
    public GeneralTransformationRefType() {
    }
    ...
    public String toString() {
        return "GeneralTransformationRefType{ " + "generalTransformation = "
                + generalTransformation + ", remoteSchema = " + remoteSchema
