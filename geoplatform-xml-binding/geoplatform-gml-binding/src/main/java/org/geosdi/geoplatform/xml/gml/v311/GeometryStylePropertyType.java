...
public class GeometryStylePropertyType {
    ...
    @XmlElementRef(name = "GeometryStyle",
                   namespace = "http://www.opengis.net/gml",
                   type = GeometryStyle_CT.class)
    protected GeometryStyle_CT geometryStyle;
     ...
     *     
     */
    public GeometryStyle_CT getGeometryStyle() {
     ...
     *     
     */
    public void setGeometryStyle(GeometryStyle_CT value) {
    ...
    public String toString() {
        return "GeometryStylePropertyType{ " + "geometryStyle = " + geometryStyle
                + ", about = " + about + ", remoteSchema = "
                + remoteSchema + ", type = " + type + ", href = "
                + href + ", role = " + role + ", arcrole = "
                + arcrole + ", title = " + title + ", show = "
                + show + ", actuate = " + actuate + '}';
    }
}
