...
public class MultiGeometryType extends AbstractGeometricAggregateType {
    ...
    /**
     * @param geometryMember the geometryMember to set
     */
    ...
    public List<GeometryPropertyType> getGeometryMember() {
        if (geometryMember == null) {
            this.geometryMember = new ArrayList<GeometryPropertyType>();
        }
    ...
    public String toString() {
        return "MultiGeometryType{ " + "geometryMember = " + geometryMember
