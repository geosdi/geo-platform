...
public class ReferenceSystemRefType {
    ...
    @XmlElementRef(name = "_ReferenceSystem",
    ...
    public ReferenceSystemRefType() {
    }

    /**
     * Gets the value of the _ReferenceSystem property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the _ReferenceSystem property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link GeographicCRSType }{@code >}
    ...
    public String toString() {
        return "ReferenceSystemRefType{ " + "referenceSystem = "
                + referenceSystem + ", remoteSchema = " + remoteSchema
