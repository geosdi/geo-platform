...
public class SingleOperationRefType {
    ...
    @XmlElementRef(name = "_SingleOperation",
    ...
    public String toString() {
        return "SingleOperationRefType{ " + "singleOperation = " + singleOperation
                + ", remoteSchema = " + remoteSchema + ", type = "
                + type + ", href = " + href + ", role = " + role
                + ", arcrole = " + arcrole + ", title = " + title
