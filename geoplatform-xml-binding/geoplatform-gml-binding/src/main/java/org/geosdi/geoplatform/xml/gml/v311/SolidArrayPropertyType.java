...
public class SolidArrayPropertyType {
    ...
    @XmlElementRef(name = "_Solid", namespace = "http://www.opengis.net/gml",
                   type = JAXBElement.class)
    private List<JAXBElement<? extends AbstractSolidType>> solid;
     ...
     */
    public void setSolid(List<JAXBElement<? extends AbstractSolidType>> solid) {
        this.solid = solid;
    }
    ...
    public List<JAXBElement<? extends AbstractSolidType>> getSolid() {
        if (solid == null) {
            this.solid = new ArrayList<JAXBElement<? extends AbstractSolidType>>();
        }
        return this.solid;
    }
    ...
    public String toString() {
        return "SolidArrayPropertyType{ " + "solid = " + solid + '}';
    }
}
