...
public class TimeGeometricPrimitivePropertyType {
    ...
    @XmlElementRef(name = "_TimeGeometricPrimitive",
    ...
    public TimeGeometricPrimitivePropertyType() {
    }

    /**
     * Gets the value of the _TimeGeometricPrimitive property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the _TimeGeometricPrimitive property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractTimeGeometricPrimitiveType }{@code >}
    ...
    public String toString() {
        return "TimeGeometricPrimitivePropertyType{ " + "timeGeometricPrimitive = "
                + timeGeometricPrimitive + ", remoteSchema = " + remoteSchema
