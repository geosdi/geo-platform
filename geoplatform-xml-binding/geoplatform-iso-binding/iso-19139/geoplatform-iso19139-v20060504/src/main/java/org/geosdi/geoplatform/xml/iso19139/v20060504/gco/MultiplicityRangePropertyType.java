    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MultiplicityRangeType theMultiplicityRange;
            theMultiplicityRange = this.getMultiplicityRange();
            strategy.appendField(locator, this, "multiplicityRange", buffer, theMultiplicityRange);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MultiplicityRangePropertyType.TYPE;
