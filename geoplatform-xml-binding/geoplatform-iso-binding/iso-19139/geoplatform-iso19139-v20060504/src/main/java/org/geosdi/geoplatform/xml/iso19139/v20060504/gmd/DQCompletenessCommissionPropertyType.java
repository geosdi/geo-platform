    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQCompletenessCommissionType theDQCompletenessCommission;
            theDQCompletenessCommission = this.getDQCompletenessCommission();
            strategy.appendField(locator, this, "dqCompletenessCommission", buffer, theDQCompletenessCommission);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQCompletenessCommissionPropertyType.TYPE;
