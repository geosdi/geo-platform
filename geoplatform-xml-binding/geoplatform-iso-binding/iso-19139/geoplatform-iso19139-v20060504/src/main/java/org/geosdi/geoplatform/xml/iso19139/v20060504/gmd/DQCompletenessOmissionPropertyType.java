    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQCompletenessOmissionType theDQCompletenessOmission;
            theDQCompletenessOmission = this.getDQCompletenessOmission();
            strategy.appendField(locator, this, "dqCompletenessOmission", buffer, theDQCompletenessOmission);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQCompletenessOmissionPropertyType.TYPE;
