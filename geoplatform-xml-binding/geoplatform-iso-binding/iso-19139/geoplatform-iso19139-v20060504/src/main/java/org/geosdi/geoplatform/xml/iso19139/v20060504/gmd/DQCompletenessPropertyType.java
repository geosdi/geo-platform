    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDQCompletenessType> theAbstractDQCompleteness;
            theAbstractDQCompleteness = this.getAbstractDQCompleteness();
            strategy.appendField(locator, this, "abstractDQCompleteness", buffer, theAbstractDQCompleteness);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQCompletenessPropertyType.TYPE;
