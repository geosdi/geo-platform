    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQConceptualConsistencyType theDQConceptualConsistency;
            theDQConceptualConsistency = this.getDQConceptualConsistency();
            strategy.appendField(locator, this, "dqConceptualConsistency", buffer, theDQConceptualConsistency);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQConceptualConsistencyPropertyType.TYPE;
