    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDQLogicalConsistencyType> theAbstractDQLogicalConsistency;
            theAbstractDQLogicalConsistency = this.getAbstractDQLogicalConsistency();
            strategy.appendField(locator, this, "abstractDQLogicalConsistency", buffer, theAbstractDQLogicalConsistency);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQLogicalConsistencyPropertyType.TYPE;
