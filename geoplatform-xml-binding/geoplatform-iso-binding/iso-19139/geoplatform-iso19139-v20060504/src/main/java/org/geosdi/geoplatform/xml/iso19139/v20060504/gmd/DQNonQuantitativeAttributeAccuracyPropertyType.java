    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQNonQuantitativeAttributeAccuracyType theDQNonQuantitativeAttributeAccuracy;
            theDQNonQuantitativeAttributeAccuracy = this.getDQNonQuantitativeAttributeAccuracy();
            strategy.appendField(locator, this, "dqNonQuantitativeAttributeAccuracy", buffer, theDQNonQuantitativeAttributeAccuracy);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQNonQuantitativeAttributeAccuracyPropertyType.TYPE;
