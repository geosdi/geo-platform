    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQQuantitativeAttributeAccuracyType theDQQuantitativeAttributeAccuracy;
            theDQQuantitativeAttributeAccuracy = this.getDQQuantitativeAttributeAccuracy();
            strategy.appendField(locator, this, "dqQuantitativeAttributeAccuracy", buffer, theDQQuantitativeAttributeAccuracy);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQQuantitativeAttributeAccuracyPropertyType.TYPE;
