    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQQuantitativeResultType theDQQuantitativeResult;
            theDQQuantitativeResult = this.getDQQuantitativeResult();
            strategy.appendField(locator, this, "dqQuantitativeResult", buffer, theDQQuantitativeResult);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQQuantitativeResultPropertyType.TYPE;
