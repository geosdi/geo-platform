    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQTemporalConsistencyType theDQTemporalConsistency;
            theDQTemporalConsistency = this.getDQTemporalConsistency();
            strategy.appendField(locator, this, "dqTemporalConsistency", buffer, theDQTemporalConsistency);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQTemporalConsistencyPropertyType.TYPE;
