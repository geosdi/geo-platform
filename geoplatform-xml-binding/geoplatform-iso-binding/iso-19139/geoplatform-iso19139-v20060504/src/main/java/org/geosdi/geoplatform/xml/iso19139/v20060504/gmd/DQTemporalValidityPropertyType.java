    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQTemporalValidityType theDQTemporalValidity;
            theDQTemporalValidity = this.getDQTemporalValidity();
            strategy.appendField(locator, this, "dqTemporalValidity", buffer, theDQTemporalValidity);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQTemporalValidityPropertyType.TYPE;
