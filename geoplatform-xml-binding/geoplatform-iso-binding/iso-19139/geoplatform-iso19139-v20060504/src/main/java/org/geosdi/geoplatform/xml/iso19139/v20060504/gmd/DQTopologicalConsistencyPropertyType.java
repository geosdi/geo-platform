    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQTopologicalConsistencyType theDQTopologicalConsistency;
            theDQTopologicalConsistency = this.getDQTopologicalConsistency();
            strategy.appendField(locator, this, "dqTopologicalConsistency", buffer, theDQTopologicalConsistency);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQTopologicalConsistencyPropertyType.TYPE;
