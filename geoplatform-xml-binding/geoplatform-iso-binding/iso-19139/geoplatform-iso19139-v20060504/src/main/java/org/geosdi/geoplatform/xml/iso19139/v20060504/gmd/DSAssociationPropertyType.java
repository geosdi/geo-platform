    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DSAssociationType theDSAssociation;
            theDSAssociation = this.getDSAssociation();
            strategy.appendField(locator, this, "dsAssociation", buffer, theDSAssociation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSAssociationPropertyType.TYPE;
