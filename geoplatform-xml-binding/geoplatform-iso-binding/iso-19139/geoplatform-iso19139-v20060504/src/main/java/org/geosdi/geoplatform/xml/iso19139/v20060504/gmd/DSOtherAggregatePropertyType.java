    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends DSOtherAggregateType> theDSOtherAggregate;
            theDSOtherAggregate = this.getDSOtherAggregate();
            strategy.appendField(locator, this, "dsOtherAggregate", buffer, theDSOtherAggregate);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSOtherAggregatePropertyType.TYPE;
