    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends DSSeriesType> theDSSeries;
            theDSSeries = this.getDSSeries();
            strategy.appendField(locator, this, "dsSeries", buffer, theDSSeries);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSSeriesPropertyType.TYPE;
