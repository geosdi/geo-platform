    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DSStereoMateType theDSStereoMate;
            theDSStereoMate = this.getDSStereoMate();
            strategy.appendField(locator, this, "dsStereoMate", buffer, theDSStereoMate);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSStereoMatePropertyType.TYPE;
