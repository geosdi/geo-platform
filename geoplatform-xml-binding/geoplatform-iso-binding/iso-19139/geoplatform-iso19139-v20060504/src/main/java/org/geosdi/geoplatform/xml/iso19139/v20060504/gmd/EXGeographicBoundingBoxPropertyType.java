    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EXGeographicBoundingBoxType theEXGeographicBoundingBox;
            theEXGeographicBoundingBox = this.getEXGeographicBoundingBox();
            strategy.appendField(locator, this, "exGeographicBoundingBox", buffer, theEXGeographicBoundingBox);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXGeographicBoundingBoxPropertyType.TYPE;
