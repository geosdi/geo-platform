    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EXGeographicDescriptionType theEXGeographicDescription;
            theEXGeographicDescription = this.getEXGeographicDescription();
            strategy.appendField(locator, this, "exGeographicDescription", buffer, theEXGeographicDescription);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXGeographicDescriptionPropertyType.TYPE;
