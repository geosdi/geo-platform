    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractEXGeographicExtentType> theAbstractEXGeographicExtent;
            theAbstractEXGeographicExtent = this.getAbstractEXGeographicExtent();
            strategy.appendField(locator, this, "abstractEXGeographicExtent", buffer, theAbstractEXGeographicExtent);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXGeographicExtentPropertyType.TYPE;
