    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EXVerticalExtentType theEXVerticalExtent;
            theEXVerticalExtent = this.getEXVerticalExtent();
            strategy.appendField(locator, this, "exVerticalExtent", buffer, theEXVerticalExtent);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXVerticalExtentPropertyType.TYPE;
