    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDAggregateInformationType theMDAggregateInformation;
            theMDAggregateInformation = this.getMDAggregateInformation();
            strategy.appendField(locator, this, "mdAggregateInformation", buffer, theMDAggregateInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDAggregateInformationPropertyType.TYPE;
