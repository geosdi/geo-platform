    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractMDContentInformationType> theAbstractMDContentInformation;
            theAbstractMDContentInformation = this.getAbstractMDContentInformation();
            strategy.appendField(locator, this, "abstractMDContentInformation", buffer, theAbstractMDContentInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDContentInformationPropertyType.TYPE;
