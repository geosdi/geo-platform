    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDDataIdentificationType theMDDataIdentification;
            theMDDataIdentification = this.getMDDataIdentification();
            strategy.appendField(locator, this, "mdDataIdentification", buffer, theMDDataIdentification);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDDataIdentificationPropertyType.TYPE;
