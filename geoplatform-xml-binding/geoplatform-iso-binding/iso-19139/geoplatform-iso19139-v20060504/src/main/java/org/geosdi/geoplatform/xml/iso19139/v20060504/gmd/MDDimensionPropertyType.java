    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDDimensionType theMDDimension;
            theMDDimension = this.getMDDimension();
            strategy.appendField(locator, this, "mdDimension", buffer, theMDDimension);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDDimensionPropertyType.TYPE;
