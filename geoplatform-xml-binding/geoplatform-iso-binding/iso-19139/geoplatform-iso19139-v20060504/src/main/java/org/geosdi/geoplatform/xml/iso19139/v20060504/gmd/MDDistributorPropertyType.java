    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDDistributorType theMDDistributor;
            theMDDistributor = this.getMDDistributor();
            strategy.appendField(locator, this, "mdDistributor", buffer, theMDDistributor);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDDistributorPropertyType.TYPE;
