    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDExtendedElementInformationType theMDExtendedElementInformation;
            theMDExtendedElementInformation = this.getMDExtendedElementInformation();
            strategy.appendField(locator, this, "mdExtendedElementInformation", buffer, theMDExtendedElementInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDExtendedElementInformationPropertyType.TYPE;
