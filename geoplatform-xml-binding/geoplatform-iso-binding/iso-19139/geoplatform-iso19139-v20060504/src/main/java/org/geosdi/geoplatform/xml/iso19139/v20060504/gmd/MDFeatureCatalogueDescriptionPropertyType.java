    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDFeatureCatalogueDescriptionType theMDFeatureCatalogueDescription;
            theMDFeatureCatalogueDescription = this.getMDFeatureCatalogueDescription();
            strategy.appendField(locator, this, "mdFeatureCatalogueDescription", buffer, theMDFeatureCatalogueDescription);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDFeatureCatalogueDescriptionPropertyType.TYPE;
