    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDGeometricObjectsType theMDGeometricObjects;
            theMDGeometricObjects = this.getMDGeometricObjects();
            strategy.appendField(locator, this, "mdGeometricObjects", buffer, theMDGeometricObjects);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDGeometricObjectsPropertyType.TYPE;
