    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends MDIdentifierType> theMDIdentifier;
            theMDIdentifier = this.getMDIdentifier();
            strategy.appendField(locator, this, "mdIdentifier", buffer, theMDIdentifier);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDIdentifierPropertyType.TYPE;
