    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDKeywordsType theMDKeywords;
            theMDKeywords = this.getMDKeywords();
            strategy.appendField(locator, this, "mdKeywords", buffer, theMDKeywords);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDKeywordsPropertyType.TYPE;
