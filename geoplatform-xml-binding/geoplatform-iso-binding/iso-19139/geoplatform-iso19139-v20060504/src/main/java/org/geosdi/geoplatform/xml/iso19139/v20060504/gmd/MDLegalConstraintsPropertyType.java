    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDLegalConstraintsType theMDLegalConstraints;
            theMDLegalConstraints = this.getMDLegalConstraints();
            strategy.appendField(locator, this, "mdLegalConstraints", buffer, theMDLegalConstraints);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDLegalConstraintsPropertyType.TYPE;
