    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theMDMaintenanceFrequencyCode;
            theMDMaintenanceFrequencyCode = this.getMDMaintenanceFrequencyCode();
            strategy.appendField(locator, this, "mdMaintenanceFrequencyCode", buffer, theMDMaintenanceFrequencyCode);
        }
        {
