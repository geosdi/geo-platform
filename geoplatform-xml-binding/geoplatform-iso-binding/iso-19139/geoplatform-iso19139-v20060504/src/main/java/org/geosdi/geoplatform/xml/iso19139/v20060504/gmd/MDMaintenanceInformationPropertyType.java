    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDMaintenanceInformationType theMDMaintenanceInformation;
            theMDMaintenanceInformation = this.getMDMaintenanceInformation();
            strategy.appendField(locator, this, "mdMaintenanceInformation", buffer, theMDMaintenanceInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDMaintenanceInformationPropertyType.TYPE;
