    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDMetadataExtensionInformationType theMDMetadataExtensionInformation;
            theMDMetadataExtensionInformation = this.getMDMetadataExtensionInformation();
            strategy.appendField(locator, this, "mdMetadataExtensionInformation", buffer, theMDMetadataExtensionInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDMetadataExtensionInformationPropertyType.TYPE;
