    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDMetadataType theMDMetadata;
            theMDMetadata = this.getMDMetadata();
            strategy.appendField(locator, this, "mdMetadata", buffer, theMDMetadata);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDMetadataPropertyType.TYPE;
