    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends MDRangeDimensionType> theMDRangeDimension;
            theMDRangeDimension = this.getMDRangeDimension();
            strategy.appendField(locator, this, "mdRangeDimension", buffer, theMDRangeDimension);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDRangeDimensionPropertyType.TYPE;
