    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDReferenceSystemType theMDReferenceSystem;
            theMDReferenceSystem = this.getMDReferenceSystem();
            strategy.appendField(locator, this, "mdReferenceSystem", buffer, theMDReferenceSystem);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDReferenceSystemPropertyType.TYPE;
