    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDSecurityConstraintsType theMDSecurityConstraints;
            theMDSecurityConstraints = this.getMDSecurityConstraints();
            strategy.appendField(locator, this, "mdSecurityConstraints", buffer, theMDSecurityConstraints);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDSecurityConstraintsPropertyType.TYPE;
