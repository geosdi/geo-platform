    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDVectorSpatialRepresentationType theMDVectorSpatialRepresentation;
            theMDVectorSpatialRepresentation = this.getMDVectorSpatialRepresentation();
            strategy.appendField(locator, this, "mdVectorSpatialRepresentation", buffer, theMDVectorSpatialRepresentation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDVectorSpatialRepresentationPropertyType.TYPE;
