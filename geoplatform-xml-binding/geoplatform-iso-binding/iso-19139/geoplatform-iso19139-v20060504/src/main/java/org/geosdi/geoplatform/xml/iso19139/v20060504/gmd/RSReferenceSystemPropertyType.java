    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            AbstractRSReferenceSystemType theAbstractRSReferenceSystem;
            theAbstractRSReferenceSystem = this.getAbstractRSReferenceSystem();
            strategy.appendField(locator, this, "abstractRSReferenceSystem", buffer, theAbstractRSReferenceSystem);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = RSReferenceSystemPropertyType.TYPE;
