    ...
    implements ToString
{
    ...
    public boolean isSetAbstractCTCatalogue() {
        return (this.abstractCTCatalogue!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCTCatalogueType> theAbstractCTCatalogue;
            theAbstractCTCatalogue = this.getAbstractCTCatalogue();
            strategy.appendField(locator, this, "abstractCTCatalogue", buffer, theAbstractCTCatalogue);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CTCataloguePropertyType.TYPE;
