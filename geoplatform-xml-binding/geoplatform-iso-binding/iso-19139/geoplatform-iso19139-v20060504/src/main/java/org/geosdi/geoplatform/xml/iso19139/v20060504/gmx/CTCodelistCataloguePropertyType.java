    ...
    implements ToString
{
    ...
    public boolean isSetCTCodelistCatalogue() {
        return (this.ctCodelistCatalogue!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CTCodelistCatalogueType theCTCodelistCatalogue;
            theCTCodelistCatalogue = this.getCTCodelistCatalogue();
            strategy.appendField(locator, this, "ctCodelistCatalogue", buffer, theCTCodelistCatalogue);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CTCodelistCataloguePropertyType.TYPE;
