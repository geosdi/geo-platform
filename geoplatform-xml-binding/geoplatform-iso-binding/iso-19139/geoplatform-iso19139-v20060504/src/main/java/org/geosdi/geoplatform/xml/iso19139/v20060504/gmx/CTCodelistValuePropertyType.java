    ...
    implements ToString
{
    ...
    public boolean isSetCodeDefinition() {
        return (this.codeDefinition!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends CodeDefinitionType> theCodeDefinition;
            theCodeDefinition = this.getCodeDefinition();
            strategy.appendField(locator, this, "codeDefinition", buffer, theCodeDefinition);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CTCodelistValuePropertyType.TYPE;
