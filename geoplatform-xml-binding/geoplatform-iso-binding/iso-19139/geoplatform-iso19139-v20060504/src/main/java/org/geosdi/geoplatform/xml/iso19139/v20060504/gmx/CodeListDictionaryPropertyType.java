    ...
    implements ToString
{
    ...
    public boolean isSetCodeListDictionary() {
        return (this.codeListDictionary!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends CodeListDictionaryType> theCodeListDictionary;
            theCodeListDictionary = this.getCodeListDictionary();
            strategy.appendField(locator, this, "codeListDictionary", buffer, theCodeListDictionary);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CodeListDictionaryPropertyType.TYPE;
