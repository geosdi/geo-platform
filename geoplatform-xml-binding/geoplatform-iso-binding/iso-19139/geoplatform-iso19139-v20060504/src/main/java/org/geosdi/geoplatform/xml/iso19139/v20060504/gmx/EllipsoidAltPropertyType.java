    ...
    implements ToString
{
    ...
    public boolean isSetEllipsoidAlt() {
        return (this.ellipsoidAlt!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EllipsoidAltType theEllipsoidAlt;
            theEllipsoidAlt = this.getEllipsoidAlt();
            strategy.appendField(locator, this, "ellipsoidAlt", buffer, theEllipsoidAlt);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EllipsoidAltPropertyType.TYPE;
