    ...
    implements ToString
{
    ...
    public boolean isSetMLAffineCS() {
        return (this.mlAffineCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLAffineCSType theMLAffineCS;
            theMLAffineCS = this.getMLAffineCS();
            strategy.appendField(locator, this, "mlAffineCS", buffer, theMLAffineCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLAffineCSPropertyType.TYPE;
