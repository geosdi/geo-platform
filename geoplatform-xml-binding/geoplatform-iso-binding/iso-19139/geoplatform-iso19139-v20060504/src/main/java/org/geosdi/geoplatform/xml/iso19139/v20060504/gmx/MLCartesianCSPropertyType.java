    ...
    implements ToString
{
    ...
    public boolean isSetMLCartesianCS() {
        return (this.mlCartesianCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLCartesianCSType theMLCartesianCS;
            theMLCartesianCS = this.getMLCartesianCS();
            strategy.appendField(locator, this, "mlCartesianCS", buffer, theMLCartesianCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLCartesianCSPropertyType.TYPE;
