    ...
    implements ToString
{
    ...
    public boolean isSetMLCompoundCRS() {
        return (this.mlCompoundCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLCompoundCRSType theMLCompoundCRS;
            theMLCompoundCRS = this.getMLCompoundCRS();
            strategy.appendField(locator, this, "mlCompoundCRS", buffer, theMLCompoundCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLCompoundCRSPropertyType.TYPE;
