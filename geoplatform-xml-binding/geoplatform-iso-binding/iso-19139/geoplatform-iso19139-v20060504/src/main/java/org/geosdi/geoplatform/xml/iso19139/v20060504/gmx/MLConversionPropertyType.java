    ...
    implements ToString
{
    ...
    public boolean isSetMLConversion() {
        return (this.mlConversion!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLConversionType theMLConversion;
            theMLConversion = this.getMLConversion();
            strategy.appendField(locator, this, "mlConversion", buffer, theMLConversion);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLConversionPropertyType.TYPE;
