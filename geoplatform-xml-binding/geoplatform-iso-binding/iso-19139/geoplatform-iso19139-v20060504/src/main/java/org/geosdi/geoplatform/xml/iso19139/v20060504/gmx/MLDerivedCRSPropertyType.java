    ...
    implements ToString
{
    ...
    public boolean isSetMLDerivedCRS() {
        return (this.mlDerivedCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLDerivedCRSType theMLDerivedCRS;
            theMLDerivedCRS = this.getMLDerivedCRS();
            strategy.appendField(locator, this, "mlDerivedCRS", buffer, theMLDerivedCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLDerivedCRSPropertyType.TYPE;
