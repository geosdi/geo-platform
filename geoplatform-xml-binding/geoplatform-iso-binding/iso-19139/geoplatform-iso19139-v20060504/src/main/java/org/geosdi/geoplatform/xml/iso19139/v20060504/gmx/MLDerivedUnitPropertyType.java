    ...
    implements ToString
{
    ...
    public boolean isSetMLDerivedUnit() {
        return (this.mlDerivedUnit!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLDerivedUnitType theMLDerivedUnit;
            theMLDerivedUnit = this.getMLDerivedUnit();
            strategy.appendField(locator, this, "mlDerivedUnit", buffer, theMLDerivedUnit);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLDerivedUnitPropertyType.TYPE;
