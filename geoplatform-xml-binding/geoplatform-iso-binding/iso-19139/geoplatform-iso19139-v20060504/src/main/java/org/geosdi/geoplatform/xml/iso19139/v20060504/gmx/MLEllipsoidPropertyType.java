    ...
    implements ToString
{
    ...
    public boolean isSetMLEllipsoid() {
        return (this.mlEllipsoid!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLEllipsoidType theMLEllipsoid;
            theMLEllipsoid = this.getMLEllipsoid();
            strategy.appendField(locator, this, "mlEllipsoid", buffer, theMLEllipsoid);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLEllipsoidPropertyType.TYPE;
