    ...
    implements ToString
{
    ...
    public boolean isSetMLEngineeringDatum() {
        return (this.mlEngineeringDatum!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLEngineeringDatumType theMLEngineeringDatum;
            theMLEngineeringDatum = this.getMLEngineeringDatum();
            strategy.appendField(locator, this, "mlEngineeringDatum", buffer, theMLEngineeringDatum);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLEngineeringDatumPropertyType.TYPE;
