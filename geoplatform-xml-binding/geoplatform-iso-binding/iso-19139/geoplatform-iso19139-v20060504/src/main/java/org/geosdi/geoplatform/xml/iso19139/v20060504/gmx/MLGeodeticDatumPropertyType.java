    ...
    implements ToString
{
    ...
    public boolean isSetMLGeodeticDatum() {
        return (this.mlGeodeticDatum!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLGeodeticDatumType theMLGeodeticDatum;
            theMLGeodeticDatum = this.getMLGeodeticDatum();
            strategy.appendField(locator, this, "mlGeodeticDatum", buffer, theMLGeodeticDatum);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLGeodeticDatumPropertyType.TYPE;
