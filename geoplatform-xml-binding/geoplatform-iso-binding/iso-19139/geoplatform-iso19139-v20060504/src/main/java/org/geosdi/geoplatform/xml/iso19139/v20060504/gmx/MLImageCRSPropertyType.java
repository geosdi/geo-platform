    ...
    implements ToString
{
    ...
    public boolean isSetMLImageCRS() {
        return (this.mlImageCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLImageCRSType theMLImageCRS;
            theMLImageCRS = this.getMLImageCRS();
            strategy.appendField(locator, this, "mlImageCRS", buffer, theMLImageCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLImageCRSPropertyType.TYPE;
