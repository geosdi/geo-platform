    ...
    implements ToString
{
    ...
    public boolean isSetMLOperationMethod() {
        return (this.mlOperationMethod!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLOperationMethodType theMLOperationMethod;
            theMLOperationMethod = this.getMLOperationMethod();
            strategy.appendField(locator, this, "mlOperationMethod", buffer, theMLOperationMethod);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLOperationMethodPropertyType.TYPE;
