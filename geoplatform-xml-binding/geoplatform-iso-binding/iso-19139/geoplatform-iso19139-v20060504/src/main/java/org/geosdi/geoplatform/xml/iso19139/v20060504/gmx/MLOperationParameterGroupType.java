    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<OperationParameterAltPropertyType> theAlternativeExpression;
    ...
    public void setAlternativeExpression(List<OperationParameterAltPropertyType> value) {
        this.alternativeExpression = null;
        List<OperationParameterAltPropertyType> draftl = this.getAlternativeExpression();
        draftl.addAll(value);
    }
