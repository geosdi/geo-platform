    ...
    implements ToString
{
    ...
    public boolean isSetMLSphericalCS() {
        return (this.mlSphericalCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLSphericalCSType theMLSphericalCS;
            theMLSphericalCS = this.getMLSphericalCS();
            strategy.appendField(locator, this, "mlSphericalCS", buffer, theMLSphericalCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLSphericalCSPropertyType.TYPE;
