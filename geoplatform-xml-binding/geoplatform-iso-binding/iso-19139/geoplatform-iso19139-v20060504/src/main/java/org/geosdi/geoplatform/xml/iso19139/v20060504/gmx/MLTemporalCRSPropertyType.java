    ...
    implements ToString
{
    ...
    public boolean isSetMLTemporalCRS() {
        return (this.mlTemporalCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLTemporalCRSType theMLTemporalCRS;
            theMLTemporalCRS = this.getMLTemporalCRS();
            strategy.appendField(locator, this, "mlTemporalCRS", buffer, theMLTemporalCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLTemporalCRSPropertyType.TYPE;
