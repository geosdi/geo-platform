    ...
    implements ToString
{
    ...
    public boolean isSetMLTimeCS() {
        return (this.mlTimeCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLTimeCSType theMLTimeCS;
            theMLTimeCS = this.getMLTimeCS();
            strategy.appendField(locator, this, "mlTimeCS", buffer, theMLTimeCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLTimeCSPropertyType.TYPE;
