    ...
    implements ToString
{
    ...
    public boolean isSetMLTransformation() {
        return (this.mlTransformation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLTransformationType theMLTransformation;
            theMLTransformation = this.getMLTransformation();
            strategy.appendField(locator, this, "mlTransformation", buffer, theMLTransformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLTransformationPropertyType.TYPE;
