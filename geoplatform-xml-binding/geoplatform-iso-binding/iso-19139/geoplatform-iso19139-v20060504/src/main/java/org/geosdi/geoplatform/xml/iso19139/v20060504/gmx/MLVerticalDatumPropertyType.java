    ...
    implements ToString
{
    ...
    public boolean isSetMLVerticalDatum() {
        return (this.mlVerticalDatum!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLVerticalDatumType theMLVerticalDatum;
            theMLVerticalDatum = this.getMLVerticalDatum();
            strategy.appendField(locator, this, "mlVerticalDatum", buffer, theMLVerticalDatum);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLVerticalDatumPropertyType.TYPE;
