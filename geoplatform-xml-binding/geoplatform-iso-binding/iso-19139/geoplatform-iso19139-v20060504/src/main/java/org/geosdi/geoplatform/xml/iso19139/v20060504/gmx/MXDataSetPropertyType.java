    ...
    implements ToString
{
    ...
    public boolean isSetMXDataSet() {
        return (this.mxDataSet!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MXDataSetType theMXDataSet;
            theMXDataSet = this.getMXDataSet();
            strategy.appendField(locator, this, "mxDataSet", buffer, theMXDataSet);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MXDataSetPropertyType.TYPE;
