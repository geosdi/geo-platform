    ...
    implements ToString
{
    ...
    public boolean isSetMimeFileType() {
        return (this.mimeFileType!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MimeFileTypeType theMimeFileType;
            theMimeFileType = this.getMimeFileType();
            strategy.appendField(locator, this, "mimeFileType", buffer, theMimeFileType);
        }
        {
