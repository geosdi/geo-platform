    ...
    implements ToString
{
    ...
    public boolean isSetOperationAlt() {
        return (this.operationAlt!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationAltType theOperationAlt;
            theOperationAlt = this.getOperationAlt();
            strategy.appendField(locator, this, "operationAlt", buffer, theOperationAlt);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = OperationAltPropertyType.TYPE;
