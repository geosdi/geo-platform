    ...
    implements ToString
{
    ...
    public boolean isSetOperationMethodAlt() {
        return (this.operationMethodAlt!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationMethodAltType theOperationMethodAlt;
            theOperationMethodAlt = this.getOperationMethodAlt();
            strategy.appendField(locator, this, "operationMethodAlt", buffer, theOperationMethodAlt);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = OperationMethodAltPropertyType.TYPE;
