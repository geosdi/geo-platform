 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}DCPList" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetDCPList() {
        return (this.dcpList!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theDCPList;
            theDCPList = this.getDCPList();
            strategy.appendField(locator, this, "dcpList", buffer, theDCPList);
        }
        {
