 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_CoupledResource" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVCoupledResource() {
        return (this.svCoupledResource!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVCoupledResourceType theSVCoupledResource;
            theSVCoupledResource = this.getSVCoupledResource();
            strategy.appendField(locator, this, "svCoupledResource", buffer, theSVCoupledResource);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVCoupledResourcePropertyType.TYPE;
