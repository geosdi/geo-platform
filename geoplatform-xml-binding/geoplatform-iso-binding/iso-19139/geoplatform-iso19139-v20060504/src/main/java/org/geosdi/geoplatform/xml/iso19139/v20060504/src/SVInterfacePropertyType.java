 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_Interface" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVInterface() {
        return (this.svInterface!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVInterfaceType theSVInterface;
            theSVInterface = this.getSVInterface();
            strategy.appendField(locator, this, "svInterface", buffer, theSVInterface);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVInterfacePropertyType.TYPE;
