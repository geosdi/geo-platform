 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_OperationChain" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVOperationChain() {
        return (this.svOperationChain!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVOperationChainType theSVOperationChain;
            theSVOperationChain = this.getSVOperationChain();
            strategy.appendField(locator, this, "svOperationChain", buffer, theSVOperationChain);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVOperationChainPropertyType.TYPE;
