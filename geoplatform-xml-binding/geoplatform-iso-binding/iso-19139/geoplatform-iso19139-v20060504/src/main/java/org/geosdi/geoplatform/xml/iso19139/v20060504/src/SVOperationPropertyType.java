 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_Operation" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVOperation() {
        return (this.svOperation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVOperationType theSVOperation;
            theSVOperation = this.getSVOperation();
            strategy.appendField(locator, this, "svOperation", buffer, theSVOperation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVOperationPropertyType.TYPE;
