 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_Parameter" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVParameter() {
        return (this.svParameter!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVParameterType theSVParameter;
            theSVParameter = this.getSVParameter();
            strategy.appendField(locator, this, "svParameter", buffer, theSVParameter);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVParameterPropertyType.TYPE;
