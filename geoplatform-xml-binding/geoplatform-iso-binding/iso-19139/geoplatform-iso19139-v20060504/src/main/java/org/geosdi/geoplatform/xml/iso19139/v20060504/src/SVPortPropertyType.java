 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_Port" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVPort() {
        return (this.svPort!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVPortType theSVPort;
            theSVPort = this.getSVPort();
            strategy.appendField(locator, this, "svPort", buffer, theSVPort);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVPortPropertyType.TYPE;
