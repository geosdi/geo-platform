 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.isotc211.org/2005/srv}SV_Service" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements ToString
{
    ...
    public boolean isSetSVService() {
        return (this.svService!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SVServiceType theSVService;
            theSVService = this.getSVService();
            strategy.appendField(locator, this, "svService", buffer, theSVService);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SVServicePropertyType.TYPE;
