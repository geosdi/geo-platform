    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CIContactType theCIContact;
            theCIContact = this.getCIContact();
            strategy.appendField(locator, this, "ciContact", buffer, theCIContact);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CIContactPropertyType.TYPE;
