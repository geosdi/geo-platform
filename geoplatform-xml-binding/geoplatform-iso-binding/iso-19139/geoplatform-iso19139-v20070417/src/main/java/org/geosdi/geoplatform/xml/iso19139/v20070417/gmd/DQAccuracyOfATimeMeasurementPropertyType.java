    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQAccuracyOfATimeMeasurementType theDQAccuracyOfATimeMeasurement;
            theDQAccuracyOfATimeMeasurement = this.getDQAccuracyOfATimeMeasurement();
            strategy.appendField(locator, this, "dqAccuracyOfATimeMeasurement", buffer, theDQAccuracyOfATimeMeasurement);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQAccuracyOfATimeMeasurementPropertyType.TYPE;
