    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQConformanceResultType theDQConformanceResult;
            theDQConformanceResult = this.getDQConformanceResult();
            strategy.appendField(locator, this, "dqConformanceResult", buffer, theDQConformanceResult);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQConformanceResultPropertyType.TYPE;
