    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQDataQualityType theDQDataQuality;
            theDQDataQuality = this.getDQDataQuality();
            strategy.appendField(locator, this, "dqDataQuality", buffer, theDQDataQuality);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQDataQualityPropertyType.TYPE;
