    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQDomainConsistencyType theDQDomainConsistency;
            theDQDomainConsistency = this.getDQDomainConsistency();
            strategy.appendField(locator, this, "dqDomainConsistency", buffer, theDQDomainConsistency);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQDomainConsistencyPropertyType.TYPE;
