    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDQElementType> theAbstractDQElement;
            theAbstractDQElement = this.getAbstractDQElement();
            strategy.appendField(locator, this, "abstractDQElement", buffer, theAbstractDQElement);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQElementPropertyType.TYPE;
