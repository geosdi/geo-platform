    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DQGriddedDataPositionalAccuracyType theDQGriddedDataPositionalAccuracy;
            theDQGriddedDataPositionalAccuracy = this.getDQGriddedDataPositionalAccuracy();
            strategy.appendField(locator, this, "dqGriddedDataPositionalAccuracy", buffer, theDQGriddedDataPositionalAccuracy);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQGriddedDataPositionalAccuracyPropertyType.TYPE;
