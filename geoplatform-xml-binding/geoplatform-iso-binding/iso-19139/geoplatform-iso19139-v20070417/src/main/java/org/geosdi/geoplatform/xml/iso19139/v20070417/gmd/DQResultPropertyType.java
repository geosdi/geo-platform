    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDQResultType> theAbstractDQResult;
            theAbstractDQResult = this.getAbstractDQResult();
            strategy.appendField(locator, this, "abstractDQResult", buffer, theAbstractDQResult);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQResultPropertyType.TYPE;
