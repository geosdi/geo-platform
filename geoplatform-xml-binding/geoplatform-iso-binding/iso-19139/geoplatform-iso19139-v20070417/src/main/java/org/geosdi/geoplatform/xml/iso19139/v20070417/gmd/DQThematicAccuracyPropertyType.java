    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDQThematicAccuracyType> theAbstractDQThematicAccuracy;
            theAbstractDQThematicAccuracy = this.getAbstractDQThematicAccuracy();
            strategy.appendField(locator, this, "abstractDQThematicAccuracy", buffer, theAbstractDQThematicAccuracy);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DQThematicAccuracyPropertyType.TYPE;
