    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DSInitiativeType theDSInitiative;
            theDSInitiative = this.getDSInitiative();
            strategy.appendField(locator, this, "dsInitiative", buffer, theDSInitiative);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSInitiativePropertyType.TYPE;
