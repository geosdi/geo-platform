    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DSPlatformType theDSPlatform;
            theDSPlatform = this.getDSPlatform();
            strategy.appendField(locator, this, "dsPlatform", buffer, theDSPlatform);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSPlatformPropertyType.TYPE;
