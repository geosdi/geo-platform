    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EXBoundingPolygonType theEXBoundingPolygon;
            theEXBoundingPolygon = this.getEXBoundingPolygon();
            strategy.appendField(locator, this, "exBoundingPolygon", buffer, theEXBoundingPolygon);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXBoundingPolygonPropertyType.TYPE;
