    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EXSpatialTemporalExtentType theEXSpatialTemporalExtent;
            theEXSpatialTemporalExtent = this.getEXSpatialTemporalExtent();
            strategy.appendField(locator, this, "exSpatialTemporalExtent", buffer, theEXSpatialTemporalExtent);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXSpatialTemporalExtentPropertyType.TYPE;
