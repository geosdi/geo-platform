    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends EXTemporalExtentType> theEXTemporalExtent;
            theEXTemporalExtent = this.getEXTemporalExtent();
            strategy.appendField(locator, this, "exTemporalExtent", buffer, theEXTemporalExtent);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = EXTemporalExtentPropertyType.TYPE;
