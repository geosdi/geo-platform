    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            LIProcessStepType theLIProcessStep;
            theLIProcessStep = this.getLIProcessStep();
            strategy.appendField(locator, this, "liProcessStep", buffer, theLIProcessStep);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = LIProcessStepPropertyType.TYPE;
