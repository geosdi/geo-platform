    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDApplicationSchemaInformationType theMDApplicationSchemaInformation;
            theMDApplicationSchemaInformation = this.getMDApplicationSchemaInformation();
            strategy.appendField(locator, this, "mdApplicationSchemaInformation", buffer, theMDApplicationSchemaInformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDApplicationSchemaInformationPropertyType.TYPE;
