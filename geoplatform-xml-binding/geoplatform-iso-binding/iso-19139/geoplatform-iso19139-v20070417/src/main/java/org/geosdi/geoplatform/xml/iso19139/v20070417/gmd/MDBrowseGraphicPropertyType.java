    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDBrowseGraphicType theMDBrowseGraphic;
            theMDBrowseGraphic = this.getMDBrowseGraphic();
            strategy.appendField(locator, this, "mdBrowseGraphic", buffer, theMDBrowseGraphic);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDBrowseGraphicPropertyType.TYPE;
