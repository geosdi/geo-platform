    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theMDCharacterSetCode;
            theMDCharacterSetCode = this.getMDCharacterSetCode();
            strategy.appendField(locator, this, "mdCharacterSetCode", buffer, theMDCharacterSetCode);
        }
        {
