    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theMDCoverageContentTypeCode;
            theMDCoverageContentTypeCode = this.getMDCoverageContentTypeCode();
            strategy.appendField(locator, this, "mdCoverageContentTypeCode", buffer, theMDCoverageContentTypeCode);
        }
        {
