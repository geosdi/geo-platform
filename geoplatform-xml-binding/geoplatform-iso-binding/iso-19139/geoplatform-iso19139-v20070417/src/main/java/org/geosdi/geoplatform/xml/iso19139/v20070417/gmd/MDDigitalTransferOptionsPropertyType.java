    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDDigitalTransferOptionsType theMDDigitalTransferOptions;
            theMDDigitalTransferOptions = this.getMDDigitalTransferOptions();
            strategy.appendField(locator, this, "mdDigitalTransferOptions", buffer, theMDDigitalTransferOptions);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDDigitalTransferOptionsPropertyType.TYPE;
