    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDGeorectifiedType theMDGeorectified;
            theMDGeorectified = this.getMDGeorectified();
            strategy.appendField(locator, this, "mdGeorectified", buffer, theMDGeorectified);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDGeorectifiedPropertyType.TYPE;
