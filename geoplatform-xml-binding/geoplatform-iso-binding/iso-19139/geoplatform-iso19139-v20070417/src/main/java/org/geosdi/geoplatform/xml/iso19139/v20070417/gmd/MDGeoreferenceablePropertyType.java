    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDGeoreferenceableType theMDGeoreferenceable;
            theMDGeoreferenceable = this.getMDGeoreferenceable();
            strategy.appendField(locator, this, "mdGeoreferenceable", buffer, theMDGeoreferenceable);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDGeoreferenceablePropertyType.TYPE;
