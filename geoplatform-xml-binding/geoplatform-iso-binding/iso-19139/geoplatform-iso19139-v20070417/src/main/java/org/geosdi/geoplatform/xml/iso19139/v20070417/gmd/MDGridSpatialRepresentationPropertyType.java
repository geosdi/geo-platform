    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends MDGridSpatialRepresentationType> theMDGridSpatialRepresentation;
            theMDGridSpatialRepresentation = this.getMDGridSpatialRepresentation();
            strategy.appendField(locator, this, "mdGridSpatialRepresentation", buffer, theMDGridSpatialRepresentation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDGridSpatialRepresentationPropertyType.TYPE;
