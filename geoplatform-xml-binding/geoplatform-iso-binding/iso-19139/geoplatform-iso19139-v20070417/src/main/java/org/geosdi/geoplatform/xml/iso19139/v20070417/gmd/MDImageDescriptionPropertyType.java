    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDImageDescriptionType theMDImageDescription;
            theMDImageDescription = this.getMDImageDescription();
            strategy.appendField(locator, this, "mdImageDescription", buffer, theMDImageDescription);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDImageDescriptionPropertyType.TYPE;
