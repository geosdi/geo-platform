    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDPortrayalCatalogueReferenceType theMDPortrayalCatalogueReference;
            theMDPortrayalCatalogueReference = this.getMDPortrayalCatalogueReference();
            strategy.appendField(locator, this, "mdPortrayalCatalogueReference", buffer, theMDPortrayalCatalogueReference);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDPortrayalCatalogueReferencePropertyType.TYPE;
