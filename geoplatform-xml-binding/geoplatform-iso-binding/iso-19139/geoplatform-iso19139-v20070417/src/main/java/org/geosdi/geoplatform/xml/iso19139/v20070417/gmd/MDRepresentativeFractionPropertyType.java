    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDRepresentativeFractionType theMDRepresentativeFraction;
            theMDRepresentativeFraction = this.getMDRepresentativeFraction();
            strategy.appendField(locator, this, "mdRepresentativeFraction", buffer, theMDRepresentativeFraction);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDRepresentativeFractionPropertyType.TYPE;
