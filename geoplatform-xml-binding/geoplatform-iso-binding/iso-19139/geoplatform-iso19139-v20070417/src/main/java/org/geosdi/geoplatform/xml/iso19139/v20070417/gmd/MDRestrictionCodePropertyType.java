    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theMDRestrictionCode;
            theMDRestrictionCode = this.getMDRestrictionCode();
            strategy.appendField(locator, this, "mdRestrictionCode", buffer, theMDRestrictionCode);
        }
        {
