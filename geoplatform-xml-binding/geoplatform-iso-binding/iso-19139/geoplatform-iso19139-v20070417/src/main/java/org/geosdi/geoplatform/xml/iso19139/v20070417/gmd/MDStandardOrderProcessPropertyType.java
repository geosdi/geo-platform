    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MDStandardOrderProcessType theMDStandardOrderProcess;
            theMDStandardOrderProcess = this.getMDStandardOrderProcess();
            strategy.appendField(locator, this, "mdStandardOrderProcess", buffer, theMDStandardOrderProcess);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MDStandardOrderProcessPropertyType.TYPE;
