    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CodeListValueType theMDTopologyLevelCode;
            theMDTopologyLevelCode = this.getMDTopologyLevelCode();
            strategy.appendField(locator, this, "mdTopologyLevelCode", buffer, theMDTopologyLevelCode);
        }
        {
