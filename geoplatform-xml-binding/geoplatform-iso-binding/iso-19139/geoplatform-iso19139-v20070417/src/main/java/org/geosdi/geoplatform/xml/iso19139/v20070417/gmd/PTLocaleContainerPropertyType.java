    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            PTLocaleContainerType thePTLocaleContainer;
            thePTLocaleContainer = this.getPTLocaleContainer();
            strategy.appendField(locator, this, "ptLocaleContainer", buffer, thePTLocaleContainer);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = PTLocaleContainerPropertyType.TYPE;
