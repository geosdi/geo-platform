    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            RSIdentifierType theRSIdentifier;
            theRSIdentifier = this.getRSIdentifier();
            strategy.appendField(locator, this, "rsIdentifier", buffer, theRSIdentifier);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = RSIdentifierPropertyType.TYPE;
