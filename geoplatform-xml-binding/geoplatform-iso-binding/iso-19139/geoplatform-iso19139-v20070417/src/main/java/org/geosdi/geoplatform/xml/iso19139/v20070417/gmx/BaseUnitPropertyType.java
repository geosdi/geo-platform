...
import org.geosdi.geoplatform.xml.gml.v321.BaseUnitType;
    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "BaseUnit", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends BaseUnitType> theBaseUnit;
            theBaseUnit = this.getBaseUnit();
            strategy.appendField(locator, this, "baseUnit", buffer, theBaseUnit);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = BaseUnitPropertyType.TYPE;
