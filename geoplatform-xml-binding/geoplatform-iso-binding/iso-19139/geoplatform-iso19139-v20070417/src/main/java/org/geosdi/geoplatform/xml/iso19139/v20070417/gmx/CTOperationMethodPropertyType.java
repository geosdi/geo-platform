...
import org.geosdi.geoplatform.xml.gml.v321.OperationMethodType;
    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "OperationMethod", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends OperationMethodType> theOperationMethod;
        ...
        {
            String theTYPE;
            theTYPE = CTOperationMethodPropertyType.TYPE;
