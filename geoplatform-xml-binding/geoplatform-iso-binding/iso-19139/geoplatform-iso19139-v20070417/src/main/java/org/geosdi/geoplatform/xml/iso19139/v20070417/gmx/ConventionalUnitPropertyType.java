    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "ConventionalUnit", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    public boolean isSetConventionalUnit() {
        return (this.conventionalUnit!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends ConventionalUnitType> theConventionalUnit;
            theConventionalUnit = this.getConventionalUnit();
            strategy.appendField(locator, this, "conventionalUnit", buffer, theConventionalUnit);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ConventionalUnitPropertyType.TYPE;
