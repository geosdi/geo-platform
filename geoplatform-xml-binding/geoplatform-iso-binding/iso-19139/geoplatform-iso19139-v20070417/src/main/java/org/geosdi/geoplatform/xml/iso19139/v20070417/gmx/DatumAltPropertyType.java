    ...
    implements ToString
{
    ...
    public boolean isSetDatumAlt() {
        return (this.datumAlt!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DatumAltType theDatumAlt;
            theDatumAlt = this.getDatumAlt();
            strategy.appendField(locator, this, "datumAlt", buffer, theDatumAlt);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DatumAltPropertyType.TYPE;
