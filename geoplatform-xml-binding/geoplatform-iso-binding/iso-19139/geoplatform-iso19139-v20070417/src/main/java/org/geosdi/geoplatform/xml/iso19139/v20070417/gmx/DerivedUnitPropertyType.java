    ...
    implements ToString
{
    ...
    @XmlElementRef(name = "DerivedUnit", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    public boolean isSetDerivedUnit() {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends DerivedUnitType> theDerivedUnit;
            theDerivedUnit = this.getDerivedUnit();
            strategy.appendField(locator, this, "derivedUnit", buffer, theDerivedUnit);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DerivedUnitPropertyType.TYPE;
