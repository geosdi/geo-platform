    ...
    implements ToString
{
    ...
    public boolean isSetMLBaseUnit() {
        return (this.mlBaseUnit!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLBaseUnitType theMLBaseUnit;
            theMLBaseUnit = this.getMLBaseUnit();
            strategy.appendField(locator, this, "mlBaseUnit", buffer, theMLBaseUnit);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLBaseUnitPropertyType.TYPE;
