    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<ClAlternativeExpressionPropertyType> theAlternativeExpression;
    ...
    public void setAlternativeExpression(List<ClAlternativeExpressionPropertyType> value) {
        this.alternativeExpression = null;
        List<ClAlternativeExpressionPropertyType> draftl = this.getAlternativeExpression();
        draftl.addAll(value);
    }
