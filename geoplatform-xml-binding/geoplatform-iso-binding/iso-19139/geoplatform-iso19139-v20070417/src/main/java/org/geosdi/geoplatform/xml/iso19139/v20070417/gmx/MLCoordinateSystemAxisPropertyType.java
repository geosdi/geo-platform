    ...
    implements ToString
{
    ...
    public boolean isSetMLCoordinateSystemAxis() {
        return (this.mlCoordinateSystemAxis!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLCoordinateSystemAxisType theMLCoordinateSystemAxis;
            theMLCoordinateSystemAxis = this.getMLCoordinateSystemAxis();
            strategy.appendField(locator, this, "mlCoordinateSystemAxis", buffer, theMLCoordinateSystemAxis);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLCoordinateSystemAxisPropertyType.TYPE;
