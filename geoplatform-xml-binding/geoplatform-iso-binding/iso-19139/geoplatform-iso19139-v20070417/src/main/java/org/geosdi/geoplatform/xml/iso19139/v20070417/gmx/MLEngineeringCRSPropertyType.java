    ...
    implements ToString
{
    ...
    public boolean isSetMLEngineeringCRS() {
        return (this.mlEngineeringCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLEngineeringCRSType theMLEngineeringCRS;
            theMLEngineeringCRS = this.getMLEngineeringCRS();
            strategy.appendField(locator, this, "mlEngineeringCRS", buffer, theMLEngineeringCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLEngineeringCRSPropertyType.TYPE;
