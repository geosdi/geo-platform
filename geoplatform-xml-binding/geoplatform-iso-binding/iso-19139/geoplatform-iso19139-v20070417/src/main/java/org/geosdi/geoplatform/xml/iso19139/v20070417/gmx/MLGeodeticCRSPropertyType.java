    ...
    implements ToString
{
    ...
    public boolean isSetMLGeodeticCRS() {
        return (this.mlGeodeticCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLGeodeticCRSType theMLGeodeticCRS;
            theMLGeodeticCRS = this.getMLGeodeticCRS();
            strategy.appendField(locator, this, "mlGeodeticCRS", buffer, theMLGeodeticCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLGeodeticCRSPropertyType.TYPE;
