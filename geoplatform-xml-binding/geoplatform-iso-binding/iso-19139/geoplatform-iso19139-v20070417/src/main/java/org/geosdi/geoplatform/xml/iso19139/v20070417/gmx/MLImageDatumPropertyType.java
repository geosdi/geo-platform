    ...
    implements ToString
{
    ...
    public boolean isSetMLImageDatum() {
        return (this.mlImageDatum!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLImageDatumType theMLImageDatum;
            theMLImageDatum = this.getMLImageDatum();
            strategy.appendField(locator, this, "mlImageDatum", buffer, theMLImageDatum);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLImageDatumPropertyType.TYPE;
