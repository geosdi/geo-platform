    ...
    implements ToString
{
    ...
    public boolean isSetMLLinearCS() {
        return (this.mlLinearCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLLinearCSType theMLLinearCS;
            theMLLinearCS = this.getMLLinearCS();
            strategy.appendField(locator, this, "mlLinearCS", buffer, theMLLinearCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLLinearCSPropertyType.TYPE;
