    ...
    implements ToString
{
    ...
    public boolean isSetMLPolarCS() {
        return (this.mlPolarCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLPolarCSType theMLPolarCS;
            theMLPolarCS = this.getMLPolarCS();
            strategy.appendField(locator, this, "mlPolarCS", buffer, theMLPolarCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLPolarCSPropertyType.TYPE;
