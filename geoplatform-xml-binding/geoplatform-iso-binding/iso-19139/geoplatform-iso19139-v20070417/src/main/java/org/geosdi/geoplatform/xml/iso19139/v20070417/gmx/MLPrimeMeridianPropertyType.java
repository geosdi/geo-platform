    ...
    implements ToString
{
    ...
    public boolean isSetMLPrimeMeridian() {
        return (this.mlPrimeMeridian!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLPrimeMeridianType theMLPrimeMeridian;
            theMLPrimeMeridian = this.getMLPrimeMeridian();
            strategy.appendField(locator, this, "mlPrimeMeridian", buffer, theMLPrimeMeridian);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLPrimeMeridianPropertyType.TYPE;
