...
import org.geosdi.geoplatform.xml.gml.v321.PrimeMeridianType;
    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<PrimeMeridianAltPropertyType> theAlternativeExpression;
    ...
    public void setAlternativeExpression(List<PrimeMeridianAltPropertyType> value) {
        this.alternativeExpression = null;
        List<PrimeMeridianAltPropertyType> draftl = this.getAlternativeExpression();
        draftl.addAll(value);
    }
