    ...
    implements ToString
{
    ...
    public boolean isSetMLProjectedCRS() {
        return (this.mlProjectedCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLProjectedCRSType theMLProjectedCRS;
            theMLProjectedCRS = this.getMLProjectedCRS();
            strategy.appendField(locator, this, "mlProjectedCRS", buffer, theMLProjectedCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLProjectedCRSPropertyType.TYPE;
