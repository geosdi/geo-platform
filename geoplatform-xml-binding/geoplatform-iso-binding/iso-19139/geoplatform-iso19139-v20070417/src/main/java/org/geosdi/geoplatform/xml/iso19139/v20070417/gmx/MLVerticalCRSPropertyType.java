    ...
    implements ToString
{
    ...
    public boolean isSetMLVerticalCRS() {
        return (this.mlVerticalCRS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLVerticalCRSType theMLVerticalCRS;
            theMLVerticalCRS = this.getMLVerticalCRS();
            strategy.appendField(locator, this, "mlVerticalCRS", buffer, theMLVerticalCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLVerticalCRSPropertyType.TYPE;
