    ...
    implements ToString
{
    ...
    public boolean isSetMLVerticalCS() {
        return (this.mlVerticalCS!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MLVerticalCSType theMLVerticalCS;
            theMLVerticalCS = this.getMLVerticalCS();
            strategy.appendField(locator, this, "mlVerticalCS", buffer, theMLVerticalCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MLVerticalCSPropertyType.TYPE;
