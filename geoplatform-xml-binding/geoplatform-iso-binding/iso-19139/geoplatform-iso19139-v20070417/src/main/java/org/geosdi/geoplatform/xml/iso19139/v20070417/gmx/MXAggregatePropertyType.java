    ...
    implements ToString
{
    ...
    public boolean isSetMXAggregate() {
        return (this.mxAggregate!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MXAggregateType theMXAggregate;
            theMXAggregate = this.getMXAggregate();
            strategy.appendField(locator, this, "mxAggregate", buffer, theMXAggregate);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MXAggregatePropertyType.TYPE;
