    ...
    implements ToString
{
    ...
    public boolean isSetMXDataFile() {
        return (this.mxDataFile!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MXDataFileType theMXDataFile;
            theMXDataFile = this.getMXDataFile();
            strategy.appendField(locator, this, "mxDataFile", buffer, theMXDataFile);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MXDataFilePropertyType.TYPE;
