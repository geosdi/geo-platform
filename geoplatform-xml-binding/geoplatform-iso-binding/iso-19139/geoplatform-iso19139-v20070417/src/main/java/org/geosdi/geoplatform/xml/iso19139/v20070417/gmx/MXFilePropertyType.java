    ...
    implements ToString
{
    ...
    public boolean isSetAbstractMXFile() {
        return (this.abstractMXFile!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractMXFileType> theAbstractMXFile;
            theAbstractMXFile = this.getAbstractMXFile();
            strategy.appendField(locator, this, "abstractMXFile", buffer, theAbstractMXFile);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MXFilePropertyType.TYPE;
