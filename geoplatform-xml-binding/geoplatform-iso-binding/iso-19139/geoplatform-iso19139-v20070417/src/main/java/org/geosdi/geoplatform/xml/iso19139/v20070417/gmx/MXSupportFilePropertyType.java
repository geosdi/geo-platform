    ...
    implements ToString
{
    ...
    public boolean isSetMXSupportFile() {
        return (this.mxSupportFile!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MXSupportFileType theMXSupportFile;
            theMXSupportFile = this.getMXSupportFile();
            strategy.appendField(locator, this, "mxSupportFile", buffer, theMXSupportFile);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MXSupportFilePropertyType.TYPE;
