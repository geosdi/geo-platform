...
import org.geosdi.geoplatform.xml.iso19139v20070417.gmx.MXAggregateType;
    ...
    implements ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDSAggregateType> theAbstractDSAggregate;
            theAbstractDSAggregate = this.getAbstractDSAggregate();
            strategy.appendField(locator, this, "abstractDSAggregate", buffer, theAbstractDSAggregate);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DSAggregatePropertyType.TYPE;
