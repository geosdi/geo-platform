    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "serviceIdentification", buffer,
                    theServiceIdentification);
        }
        {
            ServiceProvider theServiceProvider;
            theServiceProvider = this.getServiceProvider();
            strategy.appendField(locator, this, "serviceProvider", buffer,
                    theServiceProvider);
        }
        {
            OperationsMetadata theOperationsMetadata;
            theOperationsMetadata = this.getOperationsMetadata();
            strategy.appendField(locator, this, "operationsMetadata", buffer,
                    theOperationsMetadata);
        }
        {
            String theVersion;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "updateSequence", buffer,
                    theUpdateSequence);
        }
        return buffer;
    }
