...
public class ContactType
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "onlineResource", buffer,
                    theOnlineResource);
        }
        {
            String theHoursOfService;
            theHoursOfService = this.getHoursOfService();
            strategy.appendField(locator, this, "hoursOfService", buffer,
                    theHoursOfService);
        }
        {
            String theContactInstructions;
            theContactInstructions = this.getContactInstructions();
            strategy.appendField(locator, this, "contactInstructions", buffer,
                    theContactInstructions);
        }
        return buffer;
    }
}
