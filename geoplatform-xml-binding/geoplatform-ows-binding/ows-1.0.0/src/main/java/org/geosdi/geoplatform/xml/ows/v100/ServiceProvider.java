    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "providerName", buffer,
                    theProviderName);
        }
        {
            OnlineResourceType theProviderSite;
            theProviderSite = this.getProviderSite();
            strategy.appendField(locator, this, "providerSite", buffer,
                    theProviderSite);
        }
        {
            ResponsiblePartySubsetType theServiceContact;
            theServiceContact = this.getServiceContact();
            strategy.appendField(locator, this, "serviceContact", buffer,
                    theServiceContact);
        }
        return buffer;
    }
