...
public class AcceptVersionsType implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "version", buffer, theVersion, ((this.version!= null)&&(!this.version.isEmpty())));
        }
        return buffer;
    }
