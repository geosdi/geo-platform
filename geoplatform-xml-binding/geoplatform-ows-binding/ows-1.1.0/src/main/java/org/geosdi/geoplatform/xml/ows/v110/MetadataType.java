...
public class MetadataType implements ToString2
{

    @XmlAnyElement
    protected Element abstractMetaData;
     ...
     *     
     */
    public Element getAbstractMetaData() {
     ...
     *     
     */
    public void setAbstractMetaData(Element value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            Element theAbstractMetaData;
            theAbstractMetaData = this.getAbstractMetaData();
            strategy.appendField(locator, this, "abstractMetaData", buffer, theAbstractMetaData, (this.abstractMetaData!= null));
        }
        {
            String theAbout;
            theAbout = this.getAbout();
            strategy.appendField(locator, this, "about", buffer, theAbout, (this.about!= null));
        }
        {
            String theType;
