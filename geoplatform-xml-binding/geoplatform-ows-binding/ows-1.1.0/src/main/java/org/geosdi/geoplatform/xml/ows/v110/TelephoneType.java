...
public class TelephoneType implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "voice", buffer, theVoice, ((this.voice!= null)&&(!this.voice.isEmpty())));
        }
        {
            List<String> theFacsimile;
            theFacsimile = (((this.facsimile!= null)&&(!this.facsimile.isEmpty()))?this.getFacsimile():null);
            strategy.appendField(locator, this, "facsimile", buffer, theFacsimile, ((this.facsimile!= null)&&(!this.facsimile.isEmpty())));
        }
        return buffer;
    }
