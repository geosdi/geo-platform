...
public class BoundingBoxType implements Serializable, ToString {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "dimensions", buffer,
                    theDimensions);
        }
        return buffer;
    }
