...
public class Rule implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            LegendGraphic theLegendGraphic;
            theLegendGraphic = this.getLegendGraphic();
            strategy.appendField(locator, this, "legendGraphic", buffer, theLegendGraphic, this.isSetLegendGraphic());
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "elseFilter", buffer, theElseFilter, this.isSetElseFilter());
        }
        {
            Double theMinScaleDenominator;
            theMinScaleDenominator = this.getMinScaleDenominator();
            strategy.appendField(locator, this, "minScaleDenominator", buffer, theMinScaleDenominator, this.isSetMinScaleDenominator());
        }
        {
            Double theMaxScaleDenominator;
            theMaxScaleDenominator = this.getMaxScaleDenominator();
            strategy.appendField(locator, this, "maxScaleDenominator", buffer, theMaxScaleDenominator, this.isSetMaxScaleDenominator());
        }
        {
            List<JAXBElement<? extends SymbolizerType>> theSymbolizer;
            theSymbolizer = (this.isSetSymbolizer()?this.getSymbolizer():null);
            strategy.appendField(locator, this, "symbolizer", buffer, theSymbolizer, this.isSetSymbolizer());
        }
        return buffer;
    }
