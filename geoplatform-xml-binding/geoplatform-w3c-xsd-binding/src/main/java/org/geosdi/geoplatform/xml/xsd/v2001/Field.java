 ...
 *             &lt;pattern value="(\.//)?((((child::)?((\i\c*:)?(\i\c*|\*)))|\.)/)*((((child::)?((\i\c*:)?(\i\c*|\*)))|\.)|((attribute::|
 *
 * @)((\i\c*:)?(\i\c*|\*))))(\|(\.//)?((((child::)?((\i\c*:)?(\i\c*|\*)))|\.)/)*((((child::)?((\i\c*:)?(\i\c*|\*)))|\.)|((attribute::|
 * @)((\i\c*:)?(\i\c*|\*)))))*"/> &lt;/restriction> &lt;/simpleType>
 * &lt;/attribute> &lt;anyAttribute processContents='lax' namespace='##other'/>
