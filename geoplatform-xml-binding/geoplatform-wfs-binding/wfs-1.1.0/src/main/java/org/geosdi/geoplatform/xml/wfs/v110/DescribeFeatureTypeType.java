 ...
 *
 * Feature instances within the WFS_110 interface must be specified using GML3. The
 * schema of feature instances specified within the WFS_110 interface must validate
