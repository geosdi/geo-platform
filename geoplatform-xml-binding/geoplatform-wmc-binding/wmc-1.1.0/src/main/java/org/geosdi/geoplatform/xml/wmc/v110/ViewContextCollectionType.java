...
@XmlType(name = "ViewContextCollectionType", propOrder = {"viewContextReference"})
public class ViewContextCollectionType implements ToString2 {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "viewContextReference", buffer, theViewContextReference,
                    this.isSetViewContextReference());
        }
        {
            String theVERSION;
