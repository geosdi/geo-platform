...
public class DescribeProcess extends RequestBaseType implements ToString2 {
    ...
    public void setIdentifier(List<CodeType> value) {
        this.identifier = null;
        if (value != null) {
            List<CodeType> draftl = this.getIdentifier();
            draftl.addAll(value);
        }
    }
