...
public class GPJacksonLayerSupportTest extends GPBaseJacksonSupportTest {
    ...
    public void insertLayerRequestDataMapperTest() throws Exception {
        InsertLayerRequest insertLayerRequest = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        INSERT_LAYER_REQUEST_DATA_JSON),
                InsertLayerRequest.class);
    ...
    public void rasterLayerDataMapperTest() throws Exception {
        GPRasterLayer rasterLayer = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        RASTER_LAYER_DATA_JSON),
                GPRasterLayer.class);
    ...
    public void vectorLayerDataMapperTest() throws Exception {
        GPVectorLayer vectorLayer = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        VECTOR_LAYER_DATA_JSON),
                GPVectorLayer.class);
    ...
    public void shortLayerDTODataMapperTest() throws Exception {
        ShortLayerDTO shortLayer = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        SHORT_LAYER_DTO_DATA_JSON),
                ShortLayerDTO.class);
    ...
    public void shortLayerDTOContainerDataMapperTest() throws Exception {
        ShortLayerDTOContainer shortLayerContainer = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        SHORT_LAYER_DTO_CONTAINER_DATA_JSON),
                ShortLayerDTOContainer.class);
    ...
    public void treeFolderElementsStoreDataMapperTest() throws Exception {
        TreeFolderElementsStore store = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        TREE_FOLDER_ELEMENTS_STORE_DATA_JSON),
                TreeFolderElementsStore.class);
    ...
    public void addLayerTreeModificationsDataMapperTest() throws Exception {
        WSAddLayerAndTreeModificationsRequest request = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        ADD_LAYER_TREE_MODIFICATION_REQUEST_DATA_JSON),
    ...
    public void deleteLayerTreeModificationsDataMapperTest() throws Exception {
        WSDeleteLayerAndTreeModificationsRequest request = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        DELETE_LAYER_TREE_MODIFICATION_REQUEST_DATA_JSON),
    ...
    public void ddLayerTreeModificationsDataMapperTest() throws Exception {
        WSDDLayerAndTreeModificationsRequest request = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        DD_LAYER_TREE_MODIFICATION_REQUEST_DATA_JSON),
    ...
    public void getBBoxDataMapperTest() throws Exception {
        GPBBox bbox = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        GET_BBOX_DATA_JSON),
                GPBBox.class);
    ...
    public void getLayerInfoDataMapperTest() throws Exception {
        GPLayerInfo layerInfo = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        GET_LAYER_INFO_DATA_JSON),
                GPLayerInfo.class);
    ...
    public void getLayersDataSourceDataMapperTest() throws Exception {
        GetDataSourceResponse response = jacksonSupport.getDefaultMapper().readValue(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(
                        GET_LAYERS_DATA_SOURCE_DATA_JSON),
