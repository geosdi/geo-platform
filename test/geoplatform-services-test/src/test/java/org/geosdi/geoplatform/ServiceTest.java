...
public abstract class ServiceTest extends TestCase{
	...
	protected static GeoPlatformService geoPlatformServiceClient;
	...
	public ServiceTest() {
		...
		synchronized (ServiceTest.class) {
			if (ctx == null) {
				...
				geoPlatformServiceClient = (GeoPlatformService) ctx.getBean("geoPlatformServiceClient");
			}
		}
	}
	...
	public void testCheckService() {
		assertNotNull(geoPlatformServiceClient);
	}
