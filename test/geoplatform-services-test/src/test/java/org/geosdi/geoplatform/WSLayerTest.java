...
public class WSLayerTest extends ServiceTest {
    ...
    // Vector Layer 3
    private final String nameVector3 = "vector_3";
    ...
    public void setUp() throws Exception {
        ...
        idRaster1 = createAndInsertRasterLayer("abstract_" + nameRaster1, rootFolderA, nameRaster1, 5,
                false, userTest.getId(), spatialReferenceSystem, "title" + nameRaster1, urlServer);
        ...
        idVector1 = createAndInsertVectorLayer("abstract_" + nameVector1, rootFolderA, nameVector1, 4,
                false, userTest.getId(), spatialReferenceSystem, "title_" + nameVector1, urlServer);
        ...
        idRaster2 = createAndInsertRasterLayer("abstract_" + nameRaster2, rootFolderB, nameRaster2, 2,
                false, userTest.getId(), spatialReferenceSystem, "title_" + nameRaster2, urlServer);
        ...
        idVector2 = createAndInsertVectorLayer("abstract_" + nameVector2, rootFolderB, nameVector2, 1,
                false, userTest.getId(), spatialReferenceSystem, "title_" + nameVector2, urlServer);
    ...
    public void testAddLayers() {
        try {
            ...
            Assert.assertEquals("name of newRasterLayer3", nameRaster3, newRasterLayer3.getName());
            ...
            Assert.assertEquals("name of newVectorLayer3", nameVector3, newVectorLayer3.getName());
            ...
            Assert.assertEquals("name of newRasterLayer1", nameRaster1, newRasterLayer1.getName());
            ...
            Assert.assertEquals("name of newRasterLayer1", nameRaster2, newRasterLayer2.getName());
            ...
            Assert.assertEquals("name of newVectorLayer1", nameVector2, newVectorLayer2.getName());
    ...
    public void testSaveAndDeleteLayerAndTreeModifications() {
        ...
        try {
            ...
            super.createLayer(layerToTest, "abstract_" + nameLayerToTest, rootFolderB, nameLayerToTest,
                    3, false, userTest.getId(), spatialReferenceSystem, "title_" + nameLayerToTest, urlServer);
    ...
    @Test
    public void testDragAndDropLayerToTopOnSameParent() {
        logger.trace("\n\t@@@ testDragAndDropLayerToTopOnSameParent @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        try {
    ...
    @Test
    public void testDragAndDropLayerToBottomOnSameParent() {
        logger.trace("\n\t@@@ testDragAndDropLayerToBottomOnSameParent @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        try {
    ...
    @Test
    public void testDragAndDropLayerToTopOnDifferentFolder() {
        logger.trace("\n\t@@@ testDragAndDropLayerToTopOnDifferentFolder @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        try {
    ...
    @Test
    public void testDragAndDropLayerToBottomOnDifferentFolder() {
        logger.trace("\n\t@@@ testDragAndDropLayerToBottomOnDifferentFolder @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        try {
            ...
            Assert.assertEquals("Parent of vector layer 1 after drag and drop operation", idRootFolderB, vector1.getFolder().getId());
            ...
            raster2 = geoPlatformService.getRasterLayer(idRaster2);
            Assert.assertEquals("Position of raster layer 2 after drag and drop operation", 3, raster2.getPosition());
            Assert.assertEquals("Parent of raster layer 2 after drag and drop operation", idRootFolderB, raster2.getFolder().getId());
    ...
    private List<Long> addLayer3() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        createLayer(rasterLayer3, "", rootFolderA, nameRaster3, 7,
                false, userTest.getId(), spatialReferenceSystem, "", newUrlServer);
        GPLayerInfo layerInfo = new GPLayerInfo();
        layerInfo.setKeywords(layerInfoKeywords);
        layerInfo.setQueryable(false);
        ...
        createLayer(vectorLayer3, "", rootFolderA, nameVector3, 6,
                false, userTest.getId(), spatialReferenceSystem, "", newUrlServer);
        //
