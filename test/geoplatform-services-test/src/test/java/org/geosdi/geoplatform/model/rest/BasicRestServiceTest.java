...
abstract class BasicRestServiceTest extends ServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        // Insert Project
        idProjectTest = this.createAndInsertProject("project_test_rs", false, 2, new Date(System.currentTimeMillis()));
        projectTest = gpWSClient.getProjectDetail(idProjectTest);
        // Insert the Account as the owner of Project
        this.idAccountProject = this.createAndInsertAccountProject(userTest, projectTest, ADMINISTRATION);
