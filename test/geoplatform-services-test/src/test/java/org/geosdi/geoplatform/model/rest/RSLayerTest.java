...
public class RSLayerTest extends BasicRestServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        idRaster1 = createAndInsertRasterLayer(rootFolderA, titleRaster1, "name_" + titleRaster1, "abstract_" + titleRaster1, 5, spatialReferenceSystem, urlServer);
        raster1 = gpWSClient.getRasterLayer(idRaster1).getRasterLayer();
        // "rootFolderA" ---> "vectorLayer1"
        idVector1 = createAndInsertVectorLayer(rootFolderA, titleVector1, "name_" + titleVector1, "abstract_" + titleVector1, 4, spatialReferenceSystem, urlServer);
        ...
        idRaster2 = createAndInsertRasterLayer(rootFolderB, titleRaster2, "name_" + titleRaster2, "abstract_" + titleRaster2, 2, spatialReferenceSystem, urlServer);
        raster2 = gpWSClient.getRasterLayer(idRaster2).getRasterLayer();
        // "rootFolderB" ---> "vectorLayer2"
        idVector2 = createAndInsertVectorLayer(rootFolderB, titleVector2, "name_" + titleVector2, "abstract_" + titleVector2, 1, spatialReferenceSystem, urlServer);
    ...
    public void a_testAddLayersRest() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        assertEquals("title of newRasterLayer3", titleRaster3, newRasterLayer3.getTitle());
        assertEquals("position of newRasterLayer3", 7, newRasterLayer3.getPosition());
        GPLayer newVectorLayer3 = gpWSClient.getVectorLayer(idList.get(1)).getVectorLayer();
        assertEquals("title of newVectorLayer3", titleVector3, newVectorLayer3.getTitle());
        assertEquals("position of newVectorLayer3", 6, newVectorLayer3.getPosition());
    }
    ...
    public void b_testGetLayerRest() throws ResourceNotFoundFault {
        ...
        assertEquals("assertEquals shortRasterLayer1.getName()", "name_" + titleRaster1, shortRasterLayer1.getName());
        assertEquals("assertEquals shortRasterLayer1.getPosition()", 5, shortRasterLayer1.getPosition().intValue());
        assertEquals("assertEquals shortRasterLayer1.getSrs()", spatialReferenceSystem, shortRasterLayer1.getSrs());
        assertEquals("assertEquals shortRasterLayer1.getUrlServer()", urlServer, shortRasterLayer1.getUrlServer());
        assertEquals("assertEquals shortRasterLayer1.getLayerType()", WMS, shortRasterLayer1.getLayerType());
        ShortLayerDTO shortVectorLayer1 = gpWSClient.getShortLayer(idVector1);
        assertNotNull("assertNotNull shortVectorLayer1", shortVectorLayer1);
        assertEquals("assertEquals shortVectorLayer1.getTitle()", titleVector1, shortVectorLayer1.getTitle());
        assertEquals("assertEquals shortVectorLayer1.getName()", "name_" + titleVector1, shortVectorLayer1.getName());
        assertEquals("assertEquals shortVectorLayer1.getPosition()", 4, shortVectorLayer1.getPosition().intValue());
        assertEquals("assertEquals shortVectorLayer1.getSrs()", spatialReferenceSystem, shortVectorLayer1.getSrs());
        assertEquals("assertEquals shortVectorLayer1.getUrlServer()", urlServer, shortVectorLayer1.getUrlServer());
        assertEquals("assertEquals shortVectorLayer1.getLayerType()", POLYGON, shortVectorLayer1.getLayerType());
    }
    ...
    public void d_testDeleteLayerRest() throws ResourceNotFoundFault {
        ...
        assertTrue("assertEquals totalLayers", totalLayers == 4); // SetUp() added 4 layers
        ...
        assertEquals("assertEquals folderList.getList().size()", folderList.size(), 2);
        ...
        logger.trace("\n*** childrenRootFolderA:\n{}\n***", childrenRootFolderA);
        assertNotNull("assertNotNull childrenRootFolderA", childrenRootFolderA);
        assertEquals("assertEquals childrenRootFolderA.size()", childrenRootFolderA.size(), 1);
        // Assert on layers of "rootFolderA"
        ShortLayerDTO shortVectorLayerRootFolderA = (ShortLayerDTO) childrenRootFolderA.iterator().next();
        assertEquals("assertEquals shortVectorLayerRootFolderA.getTitle()", shortVectorLayerRootFolderA.getTitle(), titleVector1);
        ...
        logger.trace("\n*** childrenRootFolderB:\n{}\n***", childrenRootFolderB);
        assertNotNull("assertNotNull childrenRootFolderB", childrenRootFolderB);
        assertEquals("assertEquals childrenRootFolderB.size()", childrenRootFolderB.size(), 2);
        ...
        assertEquals("assertEquals shortRasterLayerRootFolderB.getTitle()", shortRasterLayerRootFolderB.getTitle(), titleRaster2);
        ShortLayerDTO shortVectorLayerRootFolderB = (ShortLayerDTO) iterator.next();
        assertEquals("assertEquals shortVectorLayerRootFolderB.getTitle()", shortVectorLayerRootFolderB.getTitle(), titleVector2);
        // Assert total number of layers stored into DB after delete
        List<ShortLayerDTO> allLayersAfterDelete = gpWSClient.getLayers(idProjectTest).getLayers();
        assertEquals("assertEquals allLayersAfterDelete.getList().size()", allLayersAfterDelete.size(), totalLayers - 1);
    ...
    public void e_testSaveAndDeleteLayerAndTreeModifications() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        assertEquals("Initial totalElementsOfProject", 6, totalElementsOfProject);  // SetUp() added 2 folders + 4 layers
        String titleLayerToTest = "layerToTest";
        GPRasterLayer layerToTest = new GPRasterLayer();
        super.createLayer(layerToTest, rootFolderB, titleLayerToTest, "name_" + titleLayerToTest, "abstract_" + titleLayerToTest, 3, spatialReferenceSystem, urlServer);
        ...
        // Adding new layer to user's root folder B
        long idLayerToTest = gpWSClient.saveAddedLayerAndTreeModifications(new WSAddLayerAndTreeModificationsRequest(projectTest.getId(), rootFolderB.getId(), layerToTest, descendantsMapData));
        ...
        this.checkStateRest(new int[]{7, 6, 5, 4, 2, 1}, new int[]{2, 3}, "before removing");
        // Removing layer from user's root
        map.clear();
        map.put(idRootFolderB, 2);
        gpWSClient.saveDeletedLayerAndTreeModifications(new WSDeleteLayerAndTreeModificationsRequest(idLayerToTest, descendantsMapData));
        assertEquals("totalElementsOfProject after deleted", totalElementsOfProject, gpWSClient.getNumberOfElementsProject(idProjectTest).intValue());
    ...
    public void f_testDragAndDropLayerOnSameParentRest() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        boolean checkDD = gpWSClient.saveDragAndDropLayerAndTreeModifications(new WSDDLayerAndTreeModificationsRequest(idVector2, idRootFolderB, 2, descendantsMapData));
        assertTrue("Drag and Drop successful", checkDD);
        this.checkStateRest(new int[]{6, 5, 4, 3, 1, 2}, new int[]{2, 2}, "after DD I on same parent");
        // Move vector 2 after raster 2, in initial position (oldPosition > new Position)
        checkDD = gpWSClient.saveDragAndDropLayerAndTreeModifications(new WSDDLayerAndTreeModificationsRequest(idVector2, idRootFolderB, 1, descendantsMapData));
        assertTrue("Vector 2 doesn't moved to position 1", checkDD);
    ...
    public void g_testDragAndDropLayerOnDifferentFolderRest() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        boolean checkDD = gpWSClient.saveDragAndDropLayerAndTreeModifications(new WSDDLayerAndTreeModificationsRequest(idVector2, idRootFolderA, 4, descendantsMapData));
        assertTrue("Drag and Drop successful", checkDD);
        this.checkStateRest(new int[]{6, 5, 3, 2, 1, 4}, new int[]{3, 1}, "after DD I on different parent");
        assertEquals("Parent of vector layer 2 after DD I on different parent", idRootFolderA, vector2.getFolder().getId().longValue());
        map.clear();
    ...
    public void h_testTransactionOnAddLayerRest() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        try {
            ...
            super.createLayer(raster, rootFolderA, null, "", "", 5, spatialReferenceSystem, urlServer); // Title must be NOT NULL
            ...
            fail("Add layer must fail because title value is null");
        } catch (Exception e) {
    ...
    public void i_testTransactionOnRemoveAndAddLayerRest() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        try {
            ...
            try {
                raster1 = gpWSClient.getRasterLayer(idRaster1).getRasterLayer();
                fail("rasterLayer1 must not exist");
    ...
    public void l_testGetShortLayerRest() throws ResourceNotFoundFault {
        ...
        assertEquals("assertEquals layer.getName()", layer.getName(), vector2.getName());
        assertEquals("assertEquals layer.getSrs()", layer.getSrs(), spatialReferenceSystem);
        assertEquals("assertEquals layer.getUrlServer()", layer.getUrlServer(), urlServer);
    }
    ...
    public void m_testGetBBoxRest() throws ResourceNotFoundFault {
        ...
        assertEquals("assertEquals bbox.getMaxY()", 0, Double.compare(bbox.getMaxY(), 20.0));
        assertEquals("assertEquals bbox.getMinX()", 0, Double.compare(bbox.getMinX(), 10.0));
        assertEquals("assertEquals bbox.getMinY()", 0, Double.compare(bbox.getMinY(), 10.0));
    }
    ...
    public void n_testCorrectnessOnAddLayersRest() throws ResourceNotFoundFault {
        ...
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        ArrayList<GPLayer> arrayList = new ArrayList();
        try {
            List<Long> longList = gpWSClient.saveAddedLayersAndTreeModifications(new WSAddLayersAndTreeModificationsRequest(projectTest.getId(), rootFolderA.getId(), arrayList, descendantsMapData)).getElements();
            fail("Test must fail because list of layers is empty");
        } catch (Exception ex) {
    ...
    public void o_testGetLayerInfoRest() throws ResourceNotFoundFault {
        ...
        assertNotNull("assertNotNull keywords of layerInfo", keywords);
        assertEquals("assertEquals layerInfo.getKeywords()", layerInfoKeywords.size(), keywords.size());
        for (int i = 0; i < keywords.size(); i++) {
            String key = keywords.get(i);
            assertEquals("assert keyword: index = " + i, layerInfoKeywords.get(i), key);
        }
    }
    ...
    private void checkInitialStateRest(String info) throws ResourceNotFoundFault {
        ...
        assertEquals("Position of root folder A - " + info, 6, rootFolderA.getPosition());
        ...
        raster1 = gpWSClient.getRasterLayer(idRaster1).getRasterLayer();
        assertEquals("Position of raster layer 1 - " + info, 5, raster1.getPosition());
        assertEquals("Parent of raster layer 1 - " + info, idRootFolderA, raster1.getFolder().getId().longValue());
        vector1 = gpWSClient.getVectorLayer(idVector1).getVectorLayer();
        assertEquals("Position of vector layer 1 - " + info, 4, vector1.getPosition());
        assertEquals("Parent of vector layer 1 - " + info, idRootFolderA, vector1.getFolder().getId().longValue());
        rootFolderB = gpWSClient.getFolderDetail(idRootFolderB);
        assertEquals("Position of root folder B - " + info, 3, rootFolderB.getPosition());
        assertNull("Parent of root folder B - " + info, rootFolderB.getParent());
        assertEquals("Number of descendant of root folder B - " + info, 2, rootFolderB.getNumberOfDescendants());
        raster2 = gpWSClient.getRasterLayer(idRaster2).getRasterLayer();
        assertEquals("Position of raster layer 2 - " + info, 2, raster2.getPosition());
        assertEquals("Parent of raster layer 2 - " + info, idRootFolderB, raster2.getFolder().getId().longValue());
        vector2 = gpWSClient.getVectorLayer(idVector2).getVectorLayer();
        assertEquals("Position of vector layer 2 - " + info, 1, vector2.getPosition());
        assertEquals("Parent of vector layer 2 - " + info, idRootFolderB, vector2.getFolder().getId().longValue());
    }
     ...
     * @throws ResourceNotFoundFault
     */
    private ArrayList<Long> addLayer3Rest() throws IllegalParameterFault, ResourceNotFoundFault {
        // "rootFolderA" ---> "rasterLayer3"
        GPRasterLayer rasterLayer3 = new GPRasterLayer();
        super.createLayer(rasterLayer3, rootFolderA, titleRaster3, "", "", 7, spatialReferenceSystem, newUrlServer);
        GPLayerInfo layerInfo = new GPLayerInfo();
        layerInfo.setKeywords(layerInfoKeywords);
        layerInfo.setQueryable(false);
        ...
        super.createLayer(vectorLayer3, rootFolderA, titleVector3, "", "", 6, spatialReferenceSystem, newUrlServer);
        //
        ...
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        return (ArrayList<Long>) gpWSClient.saveAddedLayersAndTreeModifications(new WSAddLayersAndTreeModificationsRequest(projectTest.getId(), rootFolderA.getId(), arrayList, descendantsMapData)).getElements();
    }
    ...
    private void checkStateRest(int[] positions, int[] numberOfDescendants, String info) throws ResourceNotFoundFault {
        assertEquals("Array positions must have exactly 6 elements", 6, positions.length);
        ...
        raster1 = gpWSClient.getRasterLayer(idRaster1).getRasterLayer();
        assertEquals("Position of raster layer 1 - " + info, positions[1], raster1.getPosition());
        vector1 = gpWSClient.getVectorLayer(idVector1).getVectorLayer();
        assertEquals("Position of vector layer 1 - " + info, positions[2], vector1.getPosition());
        rootFolderB = gpWSClient.getFolderDetail(idRootFolderB);
        ...
        raster2 = gpWSClient.getRasterLayer(idRaster2).getRasterLayer();
        assertEquals("Position of raster layer 2 - " + info, positions[4], raster2.getPosition());
        vector2 = gpWSClient.getVectorLayer(idVector2).getVectorLayer();
        assertEquals("Position of vector layer 2 - " + info, positions[5], vector2.getPosition());
    }
    ...
    private void checkLayerDeletedRest(long idLayer) {
        try {
            ...
            fail("Layer with id \"" + idLayer + "\" was NOT deleted");
        } catch (Exception ex) {
