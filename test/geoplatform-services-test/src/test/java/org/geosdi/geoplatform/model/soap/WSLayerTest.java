...
public class WSLayerTest extends BaseSoapServiceTest {
     ...
     */
    private ArrayList<Long> addLayer3() throws IllegalParameterFault, ResourceNotFoundFault {
        ...
        vectorLayer3.setLayerType(POINT);
     ...
     * @throws ResourceNotFoundFault
     */
    private void checkState(int[] positions, int[] numberOfDescendants, String info) throws ResourceNotFoundFault {
