...
//        latterRecipient = gpWSClient.getUserDetail(latterRecipientID);
    ...
    public void testInsertMultiMessage() throws Exception {
        ...
        // Test first
        List<GPMessage> firstAllMessages = gpWSClient.getAllMessagesByRecipient(firstRecipientID);
        ...
        Assert.assertEquals(firstRecipientID, firstMessage.getRecipient().getId());

        // Test latter
        List<GPMessage> latterAllMessages = gpWSClient.getAllMessagesByRecipient(latterRecipientID);
        ...
        Assert.assertEquals(latterRecipientID, latterMessage.getRecipient().getId());
    }
    ...
    public void testRetrieveMessages() throws Exception {
        ...
        // Test all messages
        List<GPMessage> allMessages = gpWSClient.getAllMessagesByRecipient(firstRecipientID);
        ...
        List<GPMessage> unreadMessages = gpWSClient.getUnreadMessagesByRecipient(firstRecipientID);
    ...
    public void testMarkAsReadAllMessage() throws Exception {
        ...
        unreadMessages = gpWSClient.getUnreadMessagesByRecipient(firstRecipientID);
