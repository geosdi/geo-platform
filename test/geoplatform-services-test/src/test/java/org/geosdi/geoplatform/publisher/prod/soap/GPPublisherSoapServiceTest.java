...
@ContextConfiguration(locations = {"classpath:appContext-PublisherSoapProdTest.xml"})
@TestExecutionListeners(value = {GPPublisherSoapListenerServices.class})
@ActiveProfiles(profiles = {"dev"})
@FixMethodOrder(value = NAME_ASCENDING)
public class GPPublisherSoapServiceTest extends PublisherServiceTest {
